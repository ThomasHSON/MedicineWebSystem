...
async function get_all_med_cart_by_phar(phar) {
  ...
  let temp_data = await fetch(
    `${temp_doman}api/medCarList/get_medcar_by_phar`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_bed_list_by_cart(phar, med_cart) {
  try {
    ...
    let temp_data = await fetch(
      `${temp_doman}api/med_cart/get_bed_list_by_cart`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
async function get_patient_by_bedNum(phar, med_cart, bed_num) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/get_patient_by_bedNum`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_all_med_qty(phar, med_cart, table) {
  try {
    ...
    let temp_check_isArray =
      page_setting_params &&
      page_setting_params.total_qty_merge_same_bed &&
      page_setting_params.total_qty_merge_same_bed.value;
...
async function get_patient_with_NOdispense(data) {
  ...
  let temp_check_isArray =
    page_setting_params &&
    page_setting_params.undispensed_merge_same_bed &&
    page_setting_params.undispensed_merge_same_bed.value;
...
async function get_serversetting_by_department_type(phar) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/ServerSetting/get_serversetting_by_department_type`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function med_cart_handover(phar, med_cart) {
  let start_p = performance.now();
  let temp_doman = transform_api_ip_4433(api_ip);
  console.log(`${temp_doman}api/med_cart/pre_handover`);
  let temp_data = await fetch(`${temp_doman}api/med_cart/pre_handover`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
// 依藥局&護理站確認可否交車
async function med_cart_handover_go(phar, med_cart) {
  let start_p = performance.now();
  let temp_doman = transform_api_ip_4433(api_ip);
  console.log(`${temp_doman}api/med_cart/pre_handover`);
...
async function api_med_cart_double_check_by_GUID(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/double_check_by_GUID`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function api_med_cart_check_dispense_by_GUID(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/check_dispense_by_GUID`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function add_med_inventory_log(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_inventory/add_med_inventory_log`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function add_med_inventory_time_track(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_inventory/add_med_inventory`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_opid_by_time(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_inventory/get_opid_by_time`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_time_by_op_id(data) {
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_inventory/get_time_by_op_id`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_medChange_by_GUID(data) {
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/get_medChange_by_GUID`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_medChange_by_ST_EN(data) {
  ...
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/get_medChange_by_ST_EN`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function update_large_in_med_cpoe(data) {
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_cart/update_large_in_med_cpoe`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_logtime_by_opid(data) {
  let temp_doman = transform_api_ip_4433(api_ip);
  let temp_data = await fetch(
    `${temp_doman}api/med_inventory/get_logtime_by_opid`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function get_all_cart_discharge(data) {
  try {
    ...
    let temp_data = await fetch(
      `${temp_doman}api/med_cart/get_cart_discharge`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
async function get_cart_with_NOdispense(data) {
  try {
    ...
    let temp_data = await fetch(
      `${temp_doman}api/med_cart/get_cart_with_NOdispense`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
async function get_cart_with_NOcheck(data) {
  try {
    ...
    let temp_data = await fetch(
      `${temp_doman}api/med_cart/get_cart_with_NOcheck`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
async function get_patient_discharge(data) {
  try {
    ...
    let temp_data = await fetch(
      `${temp_doman}api/med_cart/get_patient_discharge`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
// 更新處方備註
async function update_cpoe_note_api(data) {
  try {
    let start_p = performance.now();
    let temp_doman = transform_api_ip_4433(api_ip);
...
// 更新nearMiss備註
async function update_nearMiss_option_api(data) {
  try {
    let start_p = performance.now();
    let temp_doman = transform_api_ip_4433(api_ip);

    let temp_data = await fetch(`${temp_doman}api/settingPage/update`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
