...
function get_popup_upload() {
  popup_upload_div = new Basic_popup_Div(
    "popup_upload_div",
    "popup_upload_div",
    "330px",
    "",
...
async function confirm_popup_upload() {
  try {
    ...
    if (confirmResult) {
      ...
      const API_inspection_excel_upload = await serch_APIServer(
        "DS01",
        "藥庫",
      ...
      await excel_upload(
        upload_input.files[0],
        IC_NAME_input_popup.value,
        get_logedName(),
        API_inspection_excel_upload,
      );
...
function get_underline_popup_upload() {
  ...
  My_Div.Init(
    underline_div,
    "underline_div_upload_div_popup_upload",
    "underline_div_upload_div_popup_upload",
    "100%",
    "60px",
    "",
  ...
  My_Div.Init(
    underline_uploadtype_div,
    "underline_uploadtype_div_popup_upload",
    "underline_uploadtype_div_popup_upload",
    "72%",
    "100%",
    "",
  ...
  const svg_confirm_SVG = Get_confirm_SVG(
    "40px",
    "100%",
    "60%",
    "100%",
