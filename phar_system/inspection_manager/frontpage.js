...
async function load() {
  ...
  const API_inspection_excel = serch_APIServer(
    ServerName,
    ServerType,
    "API_inspection_excel",
  );
  const API_inspection_excel_upload = serch_APIServer(
    ServerName,
    ServerType,
    "API_inspection_excel_upload",
  );
  const API_inspection_excel_download = serch_APIServer(
    ServerName,
    ServerType,
    "API_inspection_excel_download",
  );
  ...
  console.log(
    "API_inspection_excel_upload",
    API_inspection_excel_upload[0]?.server,
  );
  console.log(
    "API_inspection_excel_download",
    API_inspection_excel_download[0]?.server,
  );
  if (API_inspection_excel.length > 0)
    inspection_excel_url = API_inspection_excel[0].server;
...
function get_header() {
  ...
  const header_contorls_findsvg = Get_find_in_page_SVG(
    "100%",
    "100%",
    "70%",
    "100%",
  ...
  const header_contorls_addsvg = Get_add_SVG(
    "100%",
    "100%",
    "70%",
    "100%",
  ...
  const header_contorls_uploadsvg = Get_upload_SVG(
    "100%",
    "100%",
    "90%",
    "100%",
