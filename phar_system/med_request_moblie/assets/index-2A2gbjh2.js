 ...
 */ (function (e) {
  ...
  function r(x) {
    ...
    if (T !== z) {
      x[0] = T;
      e: for (var W = 0, Z = x.length, rr = Z >>> 1; W < rr; ) {
        var gt = 2 * (W + 1) - 1,
          kl = x[gt],
          wt = gt + 1,
          lr = x[wt];
        if (0 > l(kl, T))
          wt < Z && 0 > l(lr, kl)
            ? ((x[W] = lr), (x[wt] = T), (W = wt))
            : ((x[W] = kl), (x[gt] = T), (W = gt));
        else if (wt < Z && 0 > l(lr, T)) (x[W] = lr), (x[wt] = T), (W = wt);
        else break e;
      }
    }
    return z;
  ...
  function v(x) {
    if (((k = !1), d(x), !w))
      if (n(s) !== null) (w = !0), Dt(E);
      else {
        var z = n(c);
        z !== null && nr(v, z.startTime - x);
      }
  }
  function E(x, z) {
    (w = !1), k && ((k = !1), f(S), (S = -1)), (g = !0);
    var T = p;
    try {
      for (
        d(z), m = n(s);
        m !== null && (!(m.expirationTime > z) || (x && !Y()));
      ...
      if (m !== null) var rr = !0;
        ...
        var gt = n(c);
        gt !== null && nr(v, gt.startTime - z), (rr = !1);
      }
      return rr;
    } finally {
      (m = null), (p = T), (g = !1);
      ...
      return (
        ...
        T > W
          ? ((x.sortIndex = T),
            ...
            n(s) === null &&
              x === n(c) &&
              (k ? (f(S), (S = -1)) : (k = !0), nr(v, T - W)))
          : ((x.sortIndex = Z), t(s, x), w || g || ((w = !0), Dt(E))),
        x
      );
    }),
...
function vs() {
  if (Zt) {
    var e = Zt,
      t = Jt;
    if (((Jt = Zt = null), Wi(e), t)) for (e = 0; e < t.length; e++) Wi(t[e]);
  }
}
function ys(e, t) {
  return e(t);
...
function Fc(e, t, n, r, l, o, i, u, s) {
  (_n = !1), (Dr = null), Dc.apply(Ic, arguments);
}
...
function Cr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = bn(n)), t !== null && bo(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function Un(e) {
  ...
  for (; 0 < tt.length && ((n = tt[0]), n.blockedOn === null); )
    Rs(n), n.blockedOn === null && tt.shift();
}
...
function ei(e, t, n, r) {
  if ($r) {
    var l = fo(e, t, n, r);
    if (l === null) Il(e, t, r, Ar, n), Yi(e, r);
    else if (qc(l, e, t, n, r)) r.stopPropagation();
    else if ((Yi(e, r), t & 4 && -1 < Jc.indexOf(e))) {
      for (; l !== null; ) {
        var o = bn(l);
        if (
          (o !== null && zs(o),
          (o = fo(e, t, n, r)),
          o === null && Il(e, t, r, Ar, n),
          o === l)
        )
          break;
        l = o;
...
var Ar = null;
function fo(e, t, n, r) {
  if (((Ar = null), (e = Zo(r)), (e = xt(e)), e !== null))
...
var cn = {
  ...
  Zi = Se(il),
  rf = B({}, il, { dataTransfer: 0 }),
  lf = Se(rf),
  of = B({}, qn, { relatedTarget: 0 }),
  Ll = Se(of),
  uf = B({}, cn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  sf = Se(uf),
  af = B({}, cn, {
...
var vf = B({}, qn, {
  ...
  kf = Se(wf),
  Sf = B({}, cn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xf = Se(Sf),
  Ef = B({}, il, {
    deltaX: function (e) {
...
var Nf = Ke && "TextEvent" in window && !Nn,
  Ds = Ke && (!li || (Nn && 8 < Nn && 11 >= Nn)),
  bi = " ",
  eu = !1;
function Is(e, t) {
  switch (e) {
...
function zf(e, t) {
  if ($t)
    return e === "compositionend" || (!li && Is(e, t))
      ? ((e = Ms()), (_r = ti = rt = null), ($t = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function As(e) {
  if (e.propertyName === "value" && ul($n)) {
    var t = [];
    Us(t, $n, e, Zo(e)), ws(Tf, t);
  }
}
function Rf(e, t, n) {
  e === "focusin"
    ? (ru(), (Pn = t), ($n = n), Pn.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function Of(e) {
...
var Ws = sl("animationend"),
  Qs = sl("animationiteration"),
  Ks = sl("animationstart"),
  Ys = sl("transitionend"),
  Xs = new Map(),
  uu =
...
ht(Qs, "onAnimationIteration");
ht(Ks, "onAnimationStart");
ht("dblclick", "onDoubleClick");
ht("focusin", "onFocus");
ht("focusout", "onBlur");
ht(Ys, "onTransitionEnd");
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Dn(a, f)), v != null && k.push(Bn(a, v, d)))),
            D)
          )
            break;
          a = a.return;
      ...
      S &&
        (Ds &&
          ...
          ($t || S !== "onCompositionStart"
            ? S === "onCompositionEnd" && $t && (N = Ms())
            : ((rt = h),
              (ti = "value" in rt ? rt.value : rt.textContent),
              ($t = !0))),
        (_ = Vr(c, S)),
        0 < _.length &&
          ((S = new Ji(S, e, null, n, h)),
          m.push({ event: S, listeners: _ }),
          N ? (S.data = N) : ((N = Fs(n)), N !== null && (S.data = N)))),
        (N = Nf ? Pf(e, n) : zf(e, n)) &&
...
function yt() {
  if (!Ul && Be !== null) {
    ...
    try {
      ...
      throw (Be !== null && (Be = Be.slice(e + 1)), Es(Jo, yt), l);
    } finally {
      (O = t), (Ul = !1);
    }
  }
...
function bs(e, t, n) {
  (xe[Ee++] = He), (xe[Ee++] = We), (xe[Ee++] = zt), (zt = e);
  var r = He;
  e = We;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function ii(e) {
  e.return !== null && (kt(e, 1), bs(e, 1, 0));
}
function ui(e) {
  for (; e === Qr; )
    (Qr = Wt[--Qt]), (Wt[Qt] = null), (Kr = Wt[--Qt]), (Wt[Qt] = null);
  for (; e === zt; )
    (zt = xe[--Ee]),
      (xe[Ee] = null),
      (We = xe[--Ee]),
...
function na(e) {
  ...
  function w(f, a, d, v) {
    for (
      var E = null, _ = null, N = a, S = (a = 0), M = null;
      N !== null && S < d.length;
      S++
    ) {
      N.index > S ? ((M = N), (N = null)) : (M = N.sibling);
      var L = p(f, N, d[S], v);
      if (L === null) {
        N === null && (N = M);
        break;
    ...
    if (S === d.length) return n(f, N), $ && kt(f, S), E;
    if (N === null) {
      for (; S < d.length; S++)
        (N = m(f, d[S], v)),
          N !== null &&
            ((a = o(N, a, S)), _ === null ? (E = N) : (_.sibling = N), (_ = N));
      return $ && kt(f, S), E;
    }
    for (N = r(f, N); S < d.length; S++)
      (M = g(N, f, S, d[S], v)),
        M !== null &&
          (e && M.alternate !== null && N.delete(M.key === null ? S : M.key),
          (a = o(M, a, S)),
  ...
  function k(f, a, d, v) {
    ...
    for (
      var _ = (E = null), N = a, S = (a = 0), M = null, L = d.next();
      N !== null && !L.done;
      S++, L = d.next()
    ) {
      N.index > S ? ((M = N), (N = null)) : (M = N.sibling);
      var Y = p(f, N, L.value, v);
      if (Y === null) {
        N === null && (N = M);
        break;
      }
      e && N && Y.alternate === null && t(f, N),
        (a = o(Y, a, S)),
        _ === null ? (E = Y) : (_.sibling = Y),
        (_ = Y),
        (N = M);
    }
    if (L.done) return n(f, N), $ && kt(f, S), E;
    if (N === null) {
      for (; !L.done; S++, L = d.next())
        (L = m(f, L.value, v)),
          L !== null &&
            ((a = o(L, a, S)), _ === null ? (E = L) : (_.sibling = L), (_ = L));
      return $ && kt(f, S), E;
    }
    for (N = r(f, N); !L.done; S++, L = d.next())
      (L = g(N, f, S, L.value, v)),
        L !== null &&
...
function gi(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (zr.current = e === null || e.memoizedState === null ? td : nd),
    (e = n(r, l)),
    Ln)
  ) {
    o = 0;
...
function ga(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), fl(4, 4, ya.bind(null, t, e), n)
  );
}
function Si() {}
function wa(e, t) {
...
function Sa(e, t, n) {
  return Lt & 21
    ? (Me(n, t) || ((n = Ns()), (V.lanes |= n), (Tt |= n), (e.baseState = !0)),
      t)
...
function ed(e, t, n) {
  ...
  if (Ea(e)) Ca(t, l);
    ...
    (n = la(e, t, l, r)),
      n !== null && ((l = se()), Oe(n, e, r, l), _a(n, t, r));
  }
}
function Ea(e) {
  var t = e.alternate;
  ...
  td = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Lr(4194308, 4, ya.bind(null, t, e), n)
      );
    },
    ...
    useTransition: function () {
      var e = ku(!1),
        t = e[0];
      return (e = qf.bind(null, e[1])), (Ie().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Xn(9, ca.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function _o(e, t, n, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = Ne(o))
    : ((o = me(t) ? Pt : ie.current), (l.context = nn(e, o))),
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, t, l))
      : ($ && n && ii(t), (t.flags |= 1), ue(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, t, l))
      : ($ && r && ii(t), (t.flags |= 1), ue(e, t, n, l), t.child)
  );
}
function Lu(e, t, n, r, l) {
  ...
  if ((bt(t, l), t.stateNode === null))
    Tr(e, t), Na(t, n, r), _o(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
...
function id(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Hl(Error(y(422)))), gr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (((u = (i & e.childLanes) !== 0), de || u)) {
    ...
    return zi(), (r = Hl(Error(y(421)))), gr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((ui(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (vr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), je !== null && ($o(je), (je = null)))),
        jo(e, t),
        re(t),
        null
      );
    ...
    case 6:
      if (e && t.stateNode != null) Fa(e, t, e.memoizedProps, r);
        ...
        if (((n = Ct(Qn.current)), Ct($e.current), vr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Fe] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || A.current & 1 ? G === 0 && (G = 3) : zi())),
          t.updateQueue !== null && (t.flags |= 4),
          re(t),
          null);
    case 4:
      return (
        on(), jo(e, t), e === null && Vn(t.stateNode.containerInfo), re(t), null
      );
    case 10:
...
function fd(e, t) {
  ...
  for (vo = { focusedElem: e, selectionRange: n }, $r = !1, C = t; C !== null; )
...
function Ua(e) {
  ...
  t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[Hn], delete t[wo], delete t[Yf], delete t[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((oe = (c = oe) || h), ze(t, e), (oe = c)) : ze(t, e),
        De(e),
        r & 8192)
      ) {
        if (
...
function Oe(e, t, n, r) {
  ...
  Jn(e, n, r),
    (!(R & 2) || e !== q) &&
      (e === q && (!(R & 2) && (ml |= n), G === 4 && nt(e, ee)),
      he(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((sn = Q() + 500), cl && yt()));
}
function he(e, t) {
...
function Ha(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = nl(e, r);
    ...
    R |= 2;
    var o = Qa();
    (q !== e || ee !== t) && ((Ve = null), (sn = Q() + 500), _t(e, t));
    do
      try {
        vd();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Gn), _t(e, 0), nt(e, r), he(e, Q()), n);
    if (t === 6) nt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (nt(e, r), (r & 130023424) === r && ((t = _i + 500 - Q()), 10 < t))
          ) {
            if (Ur(e, 0) !== 0) break;
            ...
            e.timeoutHandle = go(St.bind(null, e, fe, Ve), t);
            break;
          }
          St(e, fe, Ve);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = go(St.bind(null, e, fe, Ve), r);
            break;
          }
          St(e, fe, Ve);
          break;
...
function Uu(e) {
  ...
  if (n === 1) throw ((n = Gn), _t(e, 0), nt(e, t), he(e, Q()), n);
...
function zi() {
  (G === 0 || G === 3 || G === 2) && (G = 4),
    q === null || (!(Tt & 268435455) && !(ml & 268435455)) || nt(q, ee);
}
function nl(e, t) {
  var n = R;
  R |= 2;
  ...
  while (!0);
  if ((ci(), (R = n), (br.current = r), K !== null)) throw Error(y(261));
...
function St(e, t, n) {
  var r = O,
    l = _e.transition;
  try {
    (_e.transition = null), (O = 1), yd(e, t, n, r);
  } finally {
    (_e.transition = l), (O = r);
  }
  return null;
  ...
  if (lt !== null) {
    ...
    try {
      if (((_e.transition = null), (O = 16 > e ? 16 : e), lt === null))
        ...
        if (((e = lt), (lt = null), (tl = 0), R & 6)) throw Error(y(331));
        var l = R;
...
Ga = function (e, t, n) {
  ...
  else (de = !1), $ && t.flags & 1048576 && bs(t, Kr, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      Tr(e, t), (e = t.pendingProps);
      var l = nn(t, ie.current);
      bt(t, n), (l = gi(null, t, r, e, l, n));
      var o = wi();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            _o(t, r, e, n),
            (t = zo(null, t, r, !0, o, n)))
          : ((t.tag = 0), $ && o && ii(t), ue(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = un(Error(y(423)), t)), (t = Tu(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = un(Error(y(424)), t)), (t = Tu(e, t, r, n, l));
            break e;
          } else
            for (
...
function Or(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Li(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Xl:
        return (
          (e = Ce(12, n, t, l | 2)), (e.elementType = Xl), (e.lanes = o), e
        );
      case Gl:
...
yl.prototype.render = Ri.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(y(409));
  vl(e, t, null, null);
};
yl.prototype.unmount = Ri.prototype.unmount = function () {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (qo(t, n | 1), he(t, Q()), !(R & 6) && ((sn = Q() + 500), yt()));
      }
      break;
    case 13:
      jt(function () {
...
ys = Ni;
gs = jt;
var Pd = { usingClientEntryPoint: !1, Events: [bn, Bt, al, hs, vs, Ni] },
  wn = {
  ...
  zd = {
    ...
    findFiberByHostInstance: wn.findFiberByHostInstance || _d,
    ...
    const n = le.forwardRef(
      (
        ...
        le.createElement(
          ...
          [
            ...t.map(([m, p]) => le.createElement(m, p)),
            ...(Array.isArray(s) ? s : [s]),
          ]
        )
    );
    ...
    (async () => {
      try {
        ...
        let L = M.get("code"),
          Y = M.get("serverName");
        !L || !Y
          ? (console.log("📋 [URL參數] 未找到URL參數，使用預設值"),
            (L = "YOBIK"),
            (Y = "A8"))
          : console.log("📋 [URL參數] 從URL讀取參數:", {
              code: L,
              serverName: Y,
            }),
          g(Y);
        const Je = await (await fetch("../config.txt")).text(),
          Mt = JSON.parse(Je);
        console.log("✅ [API] 設定檔載入成功:", Mt), f(Mt.domain);
        const tr = `${Mt.domain}/api/MED_page/serch_by_BarCode`,
          Dt = { Value: L };
        console.log("🚀 [API請求] 開始呼叫藥品查詢API"),
          console.log("📍 URL:", tr),
        ...
        if (
          (console.log("📥 [API回應] 完整回應資料:", x),
          x.Code === 200 && x.Data && x.Data.length > 0)
        ) {
          const z = x.Data[0];
          console.log("✅ [藥品資料] 成功取得藥品:", {
            藥碼: z.CODE,
            藥名: z.NAME || "",
          }),
            m(z.CODE),
          ...
          console.warn("⚠️ [藥品資料] 未找到藥品資料"),
            m("找不到藥品"),
            c("找不到藥品");
      } catch (M) {
        console.error("❌ [錯誤] API呼叫失敗:", M),
          m("載入失敗"),
          c("載入失敗");
      } finally {
        k(!1);
...
數量：${S.數量}`;
      if (!confirm(M)) {
        console.log("❌ [送出] 使用者取消申領");
        return;
      }
      console.log("📋 [送出] 使用者確認申領資訊:", S);
      try {
        const L = crypto.randomUUID();
        console.log("🔑 [GUID] 自動生成 temp_GUID:", L);
        const Y = `${D}/api/Message`,
          Ae = {
            Data: [
              {
                temp_GUID: L,
                actionType: l ? "緊急申領" : "一般申領",
                code: h,
                name: s,
                requestedQuantity: n,
                requestingUnit: p,
        ...
        console.log("🚀 [API請求] 開始發送申領資料"),
          console.log("📍 URL:", Y),
          console.log("📤 Method: POST"),
          console.log("📦 Request Payload:", Ae);
        const Je = await fetch(Y, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(Ae),
        });
      } catch (L) {
        console.error("❌ [錯誤] 發送申領資料失敗:", L),
          alert("申領資料送出失敗，請檢查網路連線後再試。");
      }
    };
  return P.jsxs("div", {
    ...
    children: [
        ...
        children: w
          ? P.jsxs("div", {
              ...
              children: [
                P.jsx("div", {
                  className:
                    "inline-block animate-spin rounded-full h-12 w-12 border-4 border-blue-500 border-t-transparent",
                }),
                P.jsx("p", {
          ...
          : P.jsxs("form", {
              ...
              children: [
                P.jsxs("div", {
                  children: [
                    ...
                    P.jsx("input", {
                      ...
                      disabled: !0,
                      className:
                        "w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg text-gray-600",
                    }),
                  ],
                }),
                P.jsxs("div", {
                ...
                P.jsxs("div", {
                  children: [
                    ...
                    P.jsxs("button", {
                      ...
                      onClick: () => t(!0),
                      className:
                        "w-full px-4 py-3 bg-white border-2 border-blue-500 rounded-lg text-left text-gray-800 font-medium flex items-center justify-between hover:bg-blue-50 transition-colors",
                      children: [
                        P.jsx("span", { children: n }),
                        P.jsx(Rd, { className: "w-5 h-5 text-blue-500" }),
                      ],
                    }),
                  ],
                }),
                P.jsx("button", {
                  ...
                  onClick: N,
                  className:
                    "w-full py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 active:bg-blue-800 transition-colors shadow-md",
                  children: "送出",
                }),
              ],
            }),
      ...
      e &&
        P.jsx("div", {
          ...
          children: P.jsxs("div", {
            className:
              "bg-white w-full rounded-t-3xl shadow-2xl animate-slide-up",
            children: [
              P.jsxs("div", {
                className:
                ...
                children: [
                  ...
                  P.jsx("button", {
                    ...
                    children: P.jsx(Od, { className: "w-6 h-6 text-gray-600" }),
                  }),
                ],
              }),
              P.jsxs("div", {
                ...
                children: [
                  P.jsxs("div", {
                    className: "bg-gray-100 rounded-lg px-6 py-6 mb-6",
                    children: [
                      P.jsx("p", {
                      ...
                      P.jsx("p", {
                        className:
                          "text-4xl font-bold text-gray-800 text-right",
                        children: i,
                      }),
                    ],
                  }),
                  P.jsx("div", {
                    ...
                    children: ["7", "8", "9", "4", "5", "6", "1", "2", "3"].map(
                      (S) =>
                        P.jsx(
                          "button",
                          {
                            ...
                            onClick: () => a(S),
                            className:
                              "bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-2xl font-semibold text-gray-800 py-5 rounded-xl transition-colors",
                            children: S,
                          },
                          S
                        )
                  ...
                  P.jsxs("div", {
                    ...
                    children: [
                      P.jsx("button", {
                        ...
                        onClick: d,
                        className:
                          "bg-red-100 hover:bg-red-200 active:bg-red-300 text-lg font-semibold text-red-700 py-5 rounded-xl transition-colors",
                        children: "清除",
                      }),
                      P.jsx("button", {
                        type: "button",
                      ...
                      P.jsx("button", {
                        ...
                        onClick: v,
                        className:
                          "bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-lg font-semibold text-gray-800 py-5 rounded-xl transition-colors",
                        children: "←",
                      }),
                    ],
                  }),
                  P.jsxs("div", {
                    ...
                    children: [
                      P.jsx("button", {
                        ...
                        onClick: _,
                        className:
                          "bg-gray-200 hover:bg-gray-300 active:bg-gray-400 text-lg font-semibold text-gray-700 py-4 rounded-xl transition-colors",
                        children: "取消",
                      }),
                      P.jsx("button", {
                        type: "button",
                        onClick: E,
                        className:
                          "bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-lg font-semibold text-white py-4 rounded-xl transition-colors shadow-md",
                        children: "確認",
                      }),
                    ],
                  }),
...
tc(document.getElementById("root")).render(
  P.jsx(le.StrictMode, { children: P.jsx(Md, {}) })
);
