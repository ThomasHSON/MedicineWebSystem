...
async function popup_login_init() {
  popup_login_div = new Basic_popup_Div(
    "popup_login_div_popup_login",
    "popup_login_div_popup_login",
    "330px",
    "",
  );
...
function popup_login_content_init() {
  ...
  My_Div.Init(
    popup_login_content_user_input,
    "popup_login_content_user_input",
    "popup_login_content_user_input",
    "90%",
    "40px",
...
function popup_login_underline_init() {
  ...
  My_Div.Init(
    popup_login_content_submit_button,
    "link_btn",
    "popup_login_content_submit_button",
    "95%",
    "60px",
