...
function popup_creatSelect_content_init() {
  ...
  popup_creatSelect_creat["Data"] = popup_creatSelect_creat["Data"].sort(
    (a, b) => {
      const timeA = new Date(a.CT_TIME.replace(/\//g, "-"));
      const timeB = new Date(b.CT_TIME.replace(/\//g, "-"));
  ...
  if (review_data.length > 0) {
    ...
    review_data = review_data.sort((a, b) => {
      const timeA = new Date(a.CT_TIME.replace(/\//g, "-"));
      const timeB = new Date(b.CT_TIME.replace(/\//g, "-"));
  ...
  My_Div.Init(
    quick_CN_controls,
    "popup_creatSelect_quick_CN_controls",
    "popup_creatSelect_quick_CN_controls",
    "100%",
    "",
    "",
  ...
  My_Div.Init(
    high_priced_button,
    `creatSelect_button_high_priced`,
    `creatSelect_button_high_priced`,
    "95%",
    "60px",
  );
