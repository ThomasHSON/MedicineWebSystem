 ...
 */ (function (e) {
      ...
      e: for (var W = 0, X = E.length, bn = X >>> 1; W < bn; ) {
        ...
        if (0 > l(wl, L))
          yt < X && 0 > l(er, wl)
            ? ((E[W] = er), (E[yt] = L), (W = yt))
            : ((E[W] = wl), (E[vt] = L), (W = vt));
        else if (yt < X && 0 > l(er, L)) ((E[W] = er), (E[yt] = L), (W = yt));
        else break e;
      }
    }
    return T;
  ...
  function k(E, T) {
    ...
    try {
      for (
        d(T), p = n(s);
        p !== null && (!(p.expirationTime > T) || (E && !Pe()));
      ) {
        var W = p.callback;
        if (typeof W == "function") {
          ((p.callback = null), (m = p.priorityLevel));
          var X = W(p.expirationTime <= T);
          ((T = e.unstable_now()),
      ...
      if (p !== null) var bn = !0;
        ...
        var vt = n(f);
        (vt !== null && gl(v, vt.startTime - T), (bn = !1));
      }
      return bn;
    } finally {
      ((p = null), (m = L), (g = !1));
      ...
      return (
        ...
        L > W
          ? ((E.sortIndex = L),
            ...
            n(s) === null &&
              E === n(f) &&
              (S ? (c(P), (P = -1)) : (S = !0), gl(v, L - W)))
          : ((E.sortIndex = X), t(s, E), w || g || ((w = !0), yl(k))),
        E
      );
    }),
...
function gs() {
  if (Kt) {
    var e = Kt,
      t = Gt;
    if (((Gt = Kt = null), Qi(e), t)) for (e = 0; e < t.length; e++) Qi(t[e]);
  }
}
function ws(e, t) {
  return e(t);
...
function Ac(e, t, n, r, l, o, i, u, s) {
  ((En = !1), (Dr = null), Uc.apply($c, arguments));
}
...
function tf(e, t, n, r, l) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (o = l.pointerId),
        On.set(o, dn(On.get(o) || null, e, t, n, r, l)),
        !0
      );
  }
  return !1;
...
function bo(e, t, n, r) {
  if (Ir) {
    var l = co(e, t, n, r);
    if (l === null) (Ol(e, t, r, Mr, n), Yi(e, r));
    else if (tf(l, e, t, n, r)) r.stopPropagation();
    else if ((Yi(e, r), t & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jn(l);
        if (
          (o !== null && Ls(o),
          (o = co(e, t, n, r)),
          o === null && Ol(e, t, r, Mr, n),
          o === l)
        )
          break;
        l = o;
...
var Mr = null;
function co(e, t, n, r) {
  if (((Mr = null), (e = Xo(r)), (e = St(e)), e !== null))
...
function lu() {
  _n && (_n.detachEvent("onpropertychange", Bs), (Mn = _n = null));
}
function Bs(e) {
  if (e.propertyName === "value" && ll(Mn)) {
    var t = [];
    (As(t, Mn, e, Xo(e)), ks(Rf, t));
  }
}
function Of(e, t, n) {
  e === "focusin"
    ? (lu(), (_n = t), (Mn = n), _n.attachEvent("onpropertychange", Bs))
    : e === "focusout" && lu();
}
function If(e) {
...
function Un(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!Kl.call(t, l) || !Fe(e[l], t[l])) return !1;
  }
  return !0;
}
function ou(e) {
...
function $n(e) {
  if (!e[cr]) {
    ...
    t === null || t[cr] || ((t[cr] = !0), Fl("selectionchange", !1, t));
  }
}
function qs(e, t, n, r) {
  switch (Os(t)) {
        ...
        for (var a = f, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              c !== null && ((v = Rn(a, c)), v != null && S.push(An(a, v, d)))),
            z)
          )
            break;
          a = a.return;
      ...
      (P &&
        (Ms &&
          ...
          (Ot || P !== "onCompositionStart"
            ? P === "onCompositionEnd" && Ot && (_ = Is())
            : ((tt = h),
              (ei = "value" in tt ? tt.value : tt.textContent),
              (Ot = !0))),
        (C = Ur(f, P)),
        0 < C.length &&
          ((P = new qi(P, e, null, n, h)),
...
function ht() {
  if (!Ml && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), _s(Zo, ht), l);
    } finally {
      ((F = t), (Ml = !1));
    }
  }
...
function ta(e, t, n) {
  ((ke[xe++] = Be), (ke[xe++] = He), (ke[xe++] = Nt), (Nt = e));
  var r = Be;
  e = He;
  var l = 32 - De(r) - 1;
  ((r &= ~(1 << l)), (n += 1));
...
function la(e) {
  ...
  function h(c, a, d, v, k) {
    return a === null || a.tag !== 7
      ? ((a = Ct(d, c.mode, v, k)), (a.return = c), a)
      : ((a = l(a, d)), (a.return = c), a);
  }
  function p(c, a, d) {
  ...
  function m(c, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (wn(d) || cn(d)) return k !== null ? null : h(c, a, d, v, null);
      pr(c, d);
    }
    return null;
  }
  function g(c, a, d, v, k) {
    ...
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        ...
        case Je:
          var C = v._init;
          return g(c, a, d, C(v._payload), k);
      }
      if (wn(v) || cn(v)) return ((c = c.get(d) || null), h(a, c, v, k, null));
      pr(a, v);
    }
    return null;
  }
  function w(c, a, d, v) {
    ...
    if (P === d.length) return (n(c, _), U && gt(c, P), k);
    if (_ === null) {
      for (; P < d.length; P++)
        ((_ = p(c, d[P], v)),
          _ !== null &&
  ...
  function S(c, a, d, v) {
    ...
    for (
      var C = (k = null), _ = a, P = (a = 0), H = null, D = d.next();
      _ !== null && !D.done;
      P++, D = d.next()
    ) {
      _.index > P ? ((H = _), (_ = null)) : (H = _.sibling);
      var Pe = m(c, _, D.value, v);
      if (Pe === null) {
        _ === null && (_ = H);
        break;
      }
    ...
    if (D.done) return (n(c, _), U && gt(c, P), k);
    if (_ === null) {
...
function Ea(e, t, n) {
  return Pt & 21
    ? (Fe(n, t) || ((n = zs()), (A.lanes |= n), (zt |= n), (e.baseState = !0)),
      t)
...
function Co(e, t, n, r) {
  ...
  (typeof o == "object" && o !== null
    ? (l.context = _e(o))
    : ((o = pe(t) ? _t : le.current), (l.context = qt(e, o))),
...
function Lu(e, t, n, r, l) {
  ...
  if ((Xt(t, l), t.stateNode === null))
    (Pr(e, t), za(t, n, r), Co(t, n, r, l), (r = !0));
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
...
function ad(e, t, n, r, l, o, i) {
  ...
  if (((u = (i & e.childLanes) !== 0), fe || u)) {
    ...
    return (Pi(), (r = Bl(Error(y(421)))), mr(e, t, i, r));
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function fd(e, t, n) {
  ...
  switch ((ii(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (dr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), je !== null && (Uo(je), (je = null)))),
        Lo(e, t),
        ne(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = xt($e.current)), dr(t))) {
          ...
          switch (((r[Me] = t), (r[Vn] = o), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 17:
      return (pe(t.type) && Ar(), ne(t), null);
    case 19:
      if ((M($), (o = t.memoizedState), o === null)) return (ne(t), null);
...
function md(e, t) {
  ...
  for (ho = { focusedElem: e, selectionRange: n }, Ir = !1, x = t; x !== null; )
...
function Aa(e) {
  ...
  (t !== null && ((e.alternate = null), Aa(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Me], delete t[Vn], delete t[go], delete t[Zf], delete t[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((re = (f = re) || h), ze(t, e), (re = f)) : ze(t, e),
        Oe(e),
        r & 8192)
      ) {
        if (
...
function Qa(e, t) {
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = so(e)), l !== 0 && ((r = l), (t = Mo(e, l)))), t === 1)
    )
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = yo(wt.bind(null, e, ce, Ae), t);
            break;
          }
          wt(e, ce, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yo(wt.bind(null, e, ce, Ae), r);
            break;
          }
          wt(e, ce, Ae);
          break;
...
function Tt(e) {
  ...
  try {
    ...
    ((F = r), (Ce.transition = n), (R = t), !(R & 6) && ht());
  }
}
function Ni() {
  ((he = Wt.current), M(Wt));
...
function br(e, t) {
  ...
  while (!0);
  if ((ai(), (R = n), (Zr.current = r), K !== null)) throw Error(y(261));
  return ((J = null), (b = 0), Y);
}
function gd() {
  for (; K !== null; ) Ya(K);
...
function Zt() {
  if (nt !== null) {
    var e = Ts(qr),
      ...
      n = F;
    try {
      if (((Ce.transition = null), (F = 16 > e ? 16 : e), nt === null))
        var r = !1;
      else {
...
Ja = function (e, t, n) {
  ...
  else ((fe = !1), U && t.flags & 1048576 && ta(t, Hr, t.index));
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Jo(t, n | 1), me(t, Q()), !(R & 6) && ((rn = Q() + 500), ht()));
      }
      break;
    case 13:
      (Tt(function () {
...
ws = _i;
Ss = Tt;
var Ld = { usingClientEntryPoint: !1, Events: [Jn, Ut, il, ys, gs, _i] },
  yn = {
    ...
    const n = ie.forwardRef(
      (
        ...
        ie.createElement(
          ...
          [
            ...t.map(([p, m]) => ie.createElement(p, m)),
            ...(Array.isArray(s) ? s : [s]),
          ],
        ),
    );
...
async function lc() {
  ...
  try {
    ...
    if (!e.ok) throw new Error(`Failed to load config: ${e.statusText}`);
    return ((gr = await e.json()), gr);
  } catch (e) {
    throw (console.error("Error loading config:", e), e);
  }
}
async function Wu(e) {
  return `${(await lc()).domain}${e}`;
}
async function Ud() {
  return (await lc()).homepage;
}
const $d = ({ language: e, onLanguageChange: t }) => {
    const [n, r] = ie.useState("");
    return (
      ie.useEffect(() => {
        Ud().then((l) => {
          r(`${l}/phar_system/frontpage`);
        });
      }, []),
      N.jsx("nav", {
        className: "bg-white border-b border-[#DFE6F1]",
        children: N.jsx("div", {
              ...
              N.jsxs("div", {
                ...
                children: [
                  N.jsx("a", {
                    href: n,
                    className:
                      "flex items-center gap-3 text-text-primary hover:text-primary transition-colors mr-4",
                    children: N.jsx(Id, { className: "w-7 h-7" }),
                  }),
                  N.jsx("span", {
                    className: "text-xl font-medium",
                    children: e === "cht" ? "頁面設定" : "Page Settings",
                  }),
                ],
              }),
              N.jsx("div", {
                ...
                children: N.jsxs("button", {
                  onClick: () => t(e === "cht" ? "en" : "cht"),
                  className:
                    "inline-flex items-center px-3 py-1.5 border border-[#DFE6F1] rounded text-sm font-medium text-[#333333] hover:bg-[#F4F7FC] transition-colors",
                  children: [
                    N.jsx(Od, { className: "h-4 w-4 mr-1.5 text-[#666666]" }),
                    e === "cht" ? "繁體中文" : "English",
                  ],
                }),
              }),
  ...
  Ad = ({ pages: e, selectedPage: t, language: n, onPageChange: r }) =>
    N.jsx("div", {
      ...
      children: N.jsx("select", {
        ...
        className:
          "block w-80 pl-3 pr-10 py-2 text-base border-2 border-[#DFE6F1] focus:outline-none focus:ring-2 focus:ring-[#4E6DB4] focus:border-[#4E6DB4] sm:text-sm rounded-md bg-white shadow-sm",
        children: e.map((l) =>
          N.jsx(
            "option",
            { value: l.name, children: n === "cht" ? l.cht : l.en },
            l.name,
          ),
        ),
      }),
  ...
  Vd = ({
    ...
    const o = (i) => {
      switch (i.value_type) {
          ...
          return N.jsxs("div", {
            ...
            children: [
              N.jsx("input", {
                ...
                onChange: (p) => n(i.GUID, p.target.checked ? "True" : "False"),
                className:
                  "h-4 w-4 text-[#4E6DB4] focus:ring-[#4E6DB4] border-[#DFE6F1] rounded",
              }),
              N.jsx("label", {
                htmlFor: i.GUID,
        ...
        case "checkbox_group":
          if (!Array.isArray(i.value)) return null;
          const u = parseInt(i.option_str || "0", 10),
            s = i.value.filter((p) => p.value === "True").length;
          return N.jsxs("div", {
            className: "space-y-2",
            children: [
              N.jsxs("label", {
                className: "block text-sm font-medium text-[#333333] mb-2",
                children: [i.cht, " ", u > 0 && `(最多選擇 ${u} 個)`],
              }),
              N.jsx("div", {
                className: "grid grid-cols-2 gap-4",
                children: i.value.map((p, m) =>
                  N.jsxs(
                    "div",
                    {
                      className: "flex items-center space-x-3",
                      children: [
                        N.jsx("input", {
                          ...
                          disabled: p.value !== "True" && s >= u,
                          onChange: (g) => {
                            const w = [...i.value];
                            ((w[m] = {
                              ...p,
                              value: g.target.checked ? "True" : "False",
                            }),
                              n(i.GUID, w));
                          },
                          className:
                            "h-4 w-4 text-[#4E6DB4] focus:ring-[#4E6DB4] border-[#DFE6F1] rounded disabled:opacity-50",
                        }),
                        N.jsx("label", {
                          htmlFor: `${i.GUID}-${m}`,
                          className: `text-sm ${p.value === "True" ? "text-[#333333]" : "text-[#666666]"}`,
                          children: p.cht,
                        }),
                      ],
                    },
                        ...
                        "div",
                        {
                          ...
                          children: [
                            N.jsx("input", {
                              ...
                              value: p,
                              checked: i.value === p,
                              onChange: (m) => n(i.GUID, m.target.value),
                              className:
                                "h-4 w-4 text-[#4E6DB4] focus:ring-[#4E6DB4] border-[#DFE6F1]",
                            }),
                            N.jsx("label", {
                              htmlFor: `${i.GUID}-${p}`,
                              className: "text-[#333333]",
                              style: {
                                fontSize: i.name.includes("font_size")
                                  ? `${p}px`
                                  : "",
                              },
                              children: i.name.includes("font_size")
                                ? `${p} pixels`
                                : p,
                            }),
                          ],
            ...
            children: [
              ...
              N.jsxs("div", {
                ...
                children: [
                  N.jsx("select", {
                    value: f,
                    onChange: (p) => n(i.GUID, `${p.target.value}:${h}`),
                    className:
                      "block w-24 pl-3 pr-10 py-2 text-base border-2 border-[#DFE6F1] focus:outline-none focus:ring-2 focus:ring-[#4E6DB4] focus:border-[#4E6DB4] sm:text-sm rounded-md",
                    children: Array.from({ length: 24 }, (p, m) =>
                      m.toString().padStart(2, "0"),
                    ).map((p) => N.jsx("option", { value: p, children: p }, p)),
                  }),
                  N.jsx("span", {
                    className: "text-xl self-center text-[#666666]",
                    children: ":",
                  }),
                  N.jsx("select", {
                    value: h,
                    onChange: (p) => n(i.GUID, `${f}:${p.target.value}`),
                    className:
                      "block w-24 pl-3 pr-10 py-2 text-base border-2 border-[#DFE6F1] focus:outline-none focus:ring-2 focus:ring-[#4E6DB4] focus:border-[#4E6DB4] sm:text-sm rounded-md",
                    children: Array.from({ length: 60 }, (p, m) =>
                      m.toString().padStart(2, "0"),
                    ).map((p) => N.jsx("option", { value: p, children: p }, p)),
                  }),
                ],
      ...
      children: [
        e.map((i) =>
          N.jsx(
            ...
            {
              className:
                "bg-white p-6 rounded-lg shadow-sm border border-[#DFE6F1]",
              children: o(i),
            },
            i.GUID,
          ),
        ...
        N.jsx("div", {
          ...
          children: N.jsxs("button", {
            onClick: r,
            disabled: !l,
            className: `inline-flex items-center px-6 py-3 rounded-full shadow-lg text-white text-lg font-medium transition-all transform hover:scale-105 ${l ? "btn-primary" : "bg-[#666666] cursor-not-allowed"}`,
            children: [
              N.jsx(Md, { className: "h-5 w-5 mr-2" }),
              t === "cht" ? "儲存變更" : "Save Changes",
            ],
          }),
        }),
      ],
  ...
  Bd = [
    { name: "none", cht: "請選擇頁面", en: "Select a Page" },
    { name: "medicine_cart", cht: "住院藥車", en: "Medicine Cart" },
    { name: "inventory", cht: "盤點功能", en: "Inventory" },
  ];
function Hd() {
  const [e, t] = ie.useState("cht"),
    [n, r] = ie.useState("none"),
    [l, o] = ie.useState([]),
    [i, u] = ie.useState([]),
    [s, f] = ie.useState({ type: null, message: "" }),
    [h, p] = ie.useState(null);
  ie.useEffect(() => {
    if (n === "none") {
      (o([]), u([]));
      return;
    ...
    (async () => {
      try {
        const z = await Wu("/api/settingPage/get_by_page_name"),
          a = await (
            await fetch(z, {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ ValueAry: [n] }),
            })
          ).json();
        a.Code === 200
          ? (console.log("頁面參數回傳", a.Data), o(a.Data), u(a.Data))
          : (p(`錯誤 : ${a.Result}`), setTimeout(() => p(null), 3e3));
      } catch (z) {
        (console.error("Error fetching page parameters:", z),
          p("錯誤 : 系統發生錯誤"),
  ...
  const m = (S, z) => {
      o((c) => c.map((a) => (a.GUID === S ? { ...a, value: z } : a)));
    },
    g = () =>
      l.some((S, z) => {
        const c = i[z];
        if (S.value_type === "checkbox_group") {
          const a = S.value
    ...
    w = async () => {
      const S = l.filter((z, c) => {
        const a = i[c];
        if (z.value_type === "checkbox_group") {
          const d = z.value
      ...
      for (const z of S)
        try {
          const c =
              z.value_type === "checkbox_group"
                ? z.value
                    .filter((k) => k.value === "True")
                    .map((k) => k.name)
                    .join(";")
                : z.value,
            a = await Wu("/api/settingPage/update"),
            v = await (
              await fetch(a, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ ValueAry: [z.GUID, c] }),
              })
            ).json();
          v.Code === 200
            ? (f({
                type: "success",
                message: e === "cht" ? "儲存成功" : "Save successful",
              }),
              u(l))
            : (p(`錯誤 : ${v.Result}`),
              f({
                ...
                message:
                  e === "cht"
                    ? `儲存失敗: ${v.Result}`
                    : `Save failed: ${v.Result}`,
              }));
        } catch (c) {
          (console.error("Error updating parameter:", c),
            p("錯誤 : 系統發生錯誤"),
            f({
              type: "error",
              message:
  ...
  return N.jsxs("div", {
    ...
    children: [
      N.jsx($d, { language: e, onLanguageChange: t }),
      N.jsx("main", {
        className: "flex-1 w-full mx-auto py-6",
        children: N.jsxs("div", {
          ...
          children: [
            ...
            s.type &&
              N.jsx("div", {
                className: `fixed bottom-24 right-8 px-6 py-3 rounded-lg shadow-lg text-white ${s.type === "success" ? "bg-[#4E6DB4]" : "bg-[#D9534F]"}`,
                children: s.message,
              }),
            h &&
              N.jsx("div", {
                className:
                  "fixed top-8 right-8 px-6 py-3 rounded-lg shadow-lg bg-[#FFE8E8] text-[#D9534F] transform transition-transform duration-300 ease-in-out",
      ...
      N.jsx("footer", {
        className: "w-full border-t border-[#DFE6F1] py-4",
        children: N.jsx("div", {
          className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
          children: N.jsx("p", {
...
rc(document.getElementById("root")).render(
  N.jsx(ie.StrictMode, { children: N.jsx(Hd, {}) }),
);
