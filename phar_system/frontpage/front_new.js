  ...
  if (arr == "error") {
    ...
    if (front_page_display_logic(object.html_name, arr)) {
      ...
      if (object.html_ctName == "權限設定") {
        ...
        //     const now = Date.now();
        //     const kutech_lockUntil =
        //       parseInt(localStorage.getItem("kutech_lockUntil")) || 0;
        ...
        //     // 檢查錯誤次數
        //     let kutech_attempts =
        //       parseInt(localStorage.getItem("kutech_attempts")) || 0;
...
function set_licence() {
  let licence_btn = document.querySelector(".licence_btn");
  licence_btn.addEventListener("click", (e) => {
    e.preventDefault();
