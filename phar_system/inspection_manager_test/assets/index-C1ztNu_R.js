...
var wf = (e, t, n) =>
  t in e
    ...
    : (e[t] = n);
var Fn = (e, t, n) => wf(e, typeof t != "symbol" ? t + "" : t, n);
(function () {
...
function qc(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Vc.call(t, r) && !Qc.hasOwnProperty(r) && (o[r] = t[r]);
...
function $s(e, t, n, r, o) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), ba(e)))
    ...
    for (e = c.call(e), a = 0; !(l = e.next()).done; )
      ((l = l.value), (c = r + qo(l, a++)), (i += $s(l, t, n, c, o)));
  else if (l === "object")
    throw (
      (t = String(e)),
      Error(
...
function Yc(e, t, n) {
  ...
  for (r in t) $f.call(t, r) && !Bf.hasOwnProperty(r) && (o[r] = t[r]);
  if (e && e.defaultProps)
 ...
 */ (function (e) {
      ...
      e: for (var H = 0, G = E.length, ie = G >>> 1; H < ie; ) {
        ...
        if (0 > o(Z, A))
          N < G && 0 > o($, Z)
            ? ((E[H] = $), (E[N] = A), (H = N))
            : ((E[H] = Z), (E[b] = A), (H = b));
        else if (N < G && 0 > o($, A)) ((E[H] = $), (E[N] = A), (H = N));
        else break e;
      }
    }
    return U;
  ...
  function o(E, U) {
    var A = E.sortIndex - U.sortIndex;
    return A !== 0 ? A : E.id - U.id;
  }
  ...
  function v(E) {
    if (((j = !1), p(E), !w))
      if (n(c) !== null) ((w = !0), L(_));
        ...
        var U = n(u);
        U !== null && q(v, U.startTime - E);
      }
  }
  function _(E, U) {
    ((w = !1), j && ((j = !1), d(M), (M = -1)), (x = !0));
    var A = m;
    try {
      for (
        p(U), g = n(c);
        g !== null && (!(g.expirationTime > U) || (E && !F()));
      ) {
        var H = g.callback;
        if (typeof H == "function") {
          ((g.callback = null), (m = g.priorityLevel));
          var G = H(g.expirationTime <= U);
          ((U = e.unstable_now()),
            typeof G == "function" ? (g.callback = G) : g === n(c) && r(c),
            p(U));
        } else r(c);
        g = n(c);
      }
  ...
  ((e.unstable_IdlePriority = 5),
    ...
    (e.unstable_runWithPriority = function (E, U) {
      switch (E) {
        case 1:
        case 2:
        case 3:
    ...
    (e.unstable_scheduleCallback = function (E, U, A) {
      ...
      return (
        ...
        A > H
          ? ((E.sortIndex = A),
            ...
            n(c) === null &&
              E === n(u) &&
              (j ? (d(M), (M = -1)) : (j = !0), q(v, A - H)))
          : ((E.sortIndex = G), t(c, E), w || x || ((w = !0), L(_))),
        E
      );
    }),
...
function ir(e, t) {
  for (qr[e] = t, e = 0; e < t.length; e++) eu.add(t[e]);
}
var Ft = !(
    typeof window > "u" ||
...
var Wt = Gf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Cl(e, t) {
  ...
  (t.hasOwnProperty("value")
    ? El(e, t.type, n)
    : t.hasOwnProperty("defaultValue") && El(e, t.type, an(t.defaultValue)),
    t.checked == null &&
...
function Ta(e) {
  if ((e = ys(e))) {
    ...
    var t = e.stateNode;
    t && ((t = To(t)), Ml(e.stateNode, e.type, t));
  }
}
function fu(e) {
...
function nh(e, t, n, r, o, l, i, a, c) {
  (($r = !1), (Zs = null), eh.apply(th, arguments));
}
function rh(e, t, n, r, o, l, i, a, c) {
  if ((nh.apply(this, arguments), $r)) {
    if ($r) {
      var u = Zs;
      (($r = !1), (Zs = null));
...
function yu(e) {
  return ((e = sh(e)), e !== null ? vu(e) : null);
}
function vu(e) {
...
var wu = dt.unstable_scheduleCallback,
  Ra = dt.unstable_cancelCallback,
  oh = dt.unstable_shouldYield,
  lh = dt.unstable_requestPaint,
  Ee = dt.unstable_now,
  ih = dt.unstable_getCurrentPriorityLevel,
  Ei = dt.unstable_ImmediatePriority,
  bu = dt.unstable_UserBlockingPriority,
  to = dt.unstable_NormalPriority,
  ah = dt.unstable_LowPriority,
  Nu = dt.unstable_IdlePriority,
  ko = null,
  Pt = null;
function ch(e) {
...
function xh(e, t, n, r, o) {
  switch (t) {
    ...
    case "pointerover":
      var l = o.pointerId;
      return (Xr.set(l, Dr(Xr.get(l) || null, e, t, n, r, o)), !0);
    case "gotpointercapture":
      return (
        (l = o.pointerId),
        Jr.set(l, Dr(Jr.get(l) || null, e, t, n, r, o)),
        !0
      );
  }
  return !1;
...
function Tr(e, t) {
  e.blockedOn === t &&
    ...
    Ul ||
      ((Ul = !0),
      dt.unstable_scheduleCallback(dt.unstable_NormalPriority, yh)));
}
function Zr(e) {
  function t(o) {
    return Tr(o, e);
  ...
  for (; 0 < Kt.length && ((n = Kt[0]), n.blockedOn === null); )
    (Du(n), n.blockedOn === null && Kt.shift());
}
...
function Ii(e, t, n, r) {
  if (ro) {
    var o = zl(e, t, n, r);
    if (o === null) (cl(e, t, r, so, n), Pa(e, r));
    else if (xh(o, e, t, n, r)) r.stopPropagation();
    else if ((Pa(e, r), t & 4 && -1 < gh.indexOf(e))) {
      for (; o !== null; ) {
        var l = ys(o);
        if (
          (l !== null && Su(l),
          (l = zl(e, t, n, r)),
          l === null && cl(e, t, r, so, n),
          l === o)
        )
          break;
        o = l;
...
var so = null;
function zl(e, t, n, r) {
  if (((so = null), (e = Ci(r)), (e = wn(e)), e !== null))
...
var yr = {
  ...
  Co = je({}, xs, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Ir &&
            (Ir && e.type === "mousemove"
              ? ((el = e.screenX - Ir.screenX), (tl = e.screenY - Ir.screenY))
              : (tl = el = 0),
            (Ir = e)),
          el);
    },
  ...
  Oa = ht(Co),
  Nh = je({}, Co, { dataTransfer: 0 }),
  _h = ht(Nh),
  jh = je({}, xs, { relatedTarget: 0 }),
  nl = ht(jh),
  Sh = je({}, yr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kh = ht(Sh),
  Ch = je({}, yr, {
...
var Mh = je({}, xs, {
  ...
  Uh = ht(Lh),
  zh = je({}, yr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  $h = ht(zh),
  Fh = je({}, Co, {
    deltaX: function (e) {
  ...
  Bh = ht(Fh),
  Hh = [9, 13, 27, 32],
  Ai = Ft && "CompositionEvent" in window,
  Fr = null;
Ft && "documentMode" in document && (Fr = document.documentMode);
var Gh = Ft && "TextEvent" in window && !Fr,
  Ru = Ft && (!Ai || (Fr && 8 < Fr && 11 >= Fr)),
  za = " ",
  $a = !1;
function Pu(e, t) {
  switch (e) {
...
function Wh(e, t) {
  switch (e) {
    case "compositionend":
      return Mu(t);
    case "keypress":
      return t.which !== 32 ? null : (($a = !0), za);
    case "textInput":
      return ((e = t.data), e === za && $a ? null : e);
    default:
      return null;
  }
}
function Vh(e, t) {
  if (Wn)
    return e === "compositionend" || (!Ai && Pu(e, t))
      ? ((e = Iu()), (Hs = Ri = Xt = null), (Wn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function Ha() {
  Br && (Br.detachEvent("onpropertychange", Lu), (es = Br = null));
}
function Lu(e) {
  if (e.propertyName === "value" && Eo(es)) {
    var t = [];
    (Au(t, es, e, Ci(e)), gu(qh, t));
  }
}
function Yh(e, t, n) {
  e === "focusin"
    ? (Ha(), (Br = t), (es = n), Br.attachEvent("onpropertychange", Lu))
    : e === "focusout" && Ha();
}
function Xh(e) {
...
function ts(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var o = n[r];
    if (!bl.call(t, o) || !Et(e[o], t[o])) return !1;
  }
  return !0;
}
function Ga(e) {
...
function Do(e) {
  ...
  var t = Qn[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in $u) return (ol[e] = t[n]);
  return e;
}
var Fu = Do("animationend"),
  Bu = Do("animationiteration"),
  Hu = Do("animationstart"),
  Gu = Do("transitionend"),
  Wu = new Map(),
  Qa =
...
for (var ll = 0; ll < Qa.length; ll++) {
  var il = Qa[ll],
    rm = il.toLowerCase(),
    sm = il[0].toUpperCase() + il.slice(1);
  un(rm, "on" + sm);
}
un(Fu, "onAnimationEnd");
un(Bu, "onAnimationIteration");
un(Hu, "onAnimationStart");
un("dblclick", "onDoubleClick");
un("focusin", "onFocus");
un("focusout", "onBlur");
un(Gu, "onTransitionEnd");
...
var Ur =
  ...
  om = new Set("cancel close invalid load scroll toggle".split(" ").concat(Ur));
function qa(e, t, n) {
  ...
  if (!e[Is]) {
    ((e[Is] = !0),
      eu.forEach(function (n) {
        n !== "selectionchange" && (om.has(n) || al(n, !1, e), al(n, !0, e));
      }));
    var t = e.nodeType === 9 ? e : e.ownerDocument;
    t === null || t[Is] || ((t[Is] = !0), al("selectionchange", !1, t));
  }
}
function Qu(e, t, n, r) {
  switch (Tu(t)) {
  ...
  gu(function () {
    ...
    e: {
      ...
      if (m !== void 0) {
        ...
        for (var f = u, p; f !== null; ) {
          ...
          if (
            (p.tag === 5 &&
              v !== null &&
              ((p = v),
              d !== null && ((v = Yr(f, d)), v != null && j.push(rs(f, v, p)))),
            S)
          )
            break;
          f = f.return;
        ...
        0 < j.length &&
          ((m = new x(m, w, null, n, h)), g.push({ event: m, listeners: j }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (S = x == null ? m : qn(x)),
            (p = w == null ? m : qn(w)),
            (m = new j(v, f + "leave", x, n, h)),
            (m.target = S),
            (m.relatedTarget = p),
            (v = null),
            wn(h) === u &&
              ((j = new j(d, f + "enter", w, n, h)),
              (j.target = p),
              (j.relatedTarget = S),
              (v = j)),
            (S = v),
            ...
            t: {
              for (j = x, d = w, f = 0, p = j; p; p = Bn(p)) f++;
              for (p = 0, v = d; v; v = Bn(v)) p++;
              for (; 0 < f - p; ) ((j = Bn(j)), f--);
              for (; 0 < p - f; ) ((d = Bn(d)), p--);
              for (; f--; ) {
      ...
      if (Ai)
        ...
        Wn
          ? Pu(e, n) && (M = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (M = "onCompositionStart");
      (M &&
        (Ru &&
          n.locale !== "ko" &&
          (Wn || M !== "onCompositionStart"
            ? M === "onCompositionEnd" && Wn && (I = Iu())
            : ((Xt = h),
              (Ri = "value" in Xt ? Xt.value : Xt.textContent),
              (Wn = !0))),
        (C = oo(u, M)),
        0 < C.length &&
          ((M = new La(M, e, null, n, h)),
          g.push({ event: M, listeners: C }),
          I ? (M.data = I) : ((I = Mu(n)), I !== null && (M.data = I)))),
        (I = Gh ? Wh(e, n) : Vh(e, n)) &&
...
var Wl = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  cm =
    typeof queueMicrotask == "function"
      ...
      : typeof Xa < "u"
        ? function (e) {
            return Xa.resolve(null).then(e).catch(um);
          }
        : Wl;
function um(e) {
  setTimeout(function () {
...
var vr = Math.random().toString(36).slice(2),
  ...
  Vl = "__reactEvents$" + vr,
  dm = "__reactListeners$" + vr,
  fm = "__reactHandles$" + vr;
function wn(e) {
  var t = e[Rt];
  if (t) return t;
...
function ye(e) {
  0 > Kn || ((e.current = Ql[Kn]), (Ql[Kn] = null), Kn--);
}
function pe(e, t) {
  (Kn++, (Ql[Kn] = e.current), (e.current = t));
}
var cn = {},
  Qe = dn(cn),
  tt = dn(!1),
...
function qu(e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var o in r) if (!(o in t)) throw Error(O(108, Yf(e) || "Unknown", o));
  return je({}, n, r);
}
function ao(e) {
  return (
...
function fn() {
  if (!dl && Lt !== null) {
    ...
    try {
      ...
      throw (Lt !== null && (Lt = Lt.slice(e + 1)), wu(Ei, fn), o);
    } finally {
      ((fe = t), (dl = !1));
    }
  }
...
var Yn = [],
  ...
  zt = "";
function xn(e, t) {
  ((Yn[Xn++] = uo), (Yn[Xn++] = co), (co = e), (uo = t));
}
function Yu(e, t, n) {
  ((mt[pt++] = Ut), (mt[pt++] = zt), (mt[pt++] = Dn), (Dn = e));
  var r = Ut;
  e = zt;
  var o = 32 - St(r) - 1;
  ((r &= ~(1 << o)), (n += 1));
  ...
  if (30 < l) {
    ...
    ((l = (r & ((1 << i) - 1)).toString(32)),
      (r >>= i),
      (o -= i),
      (Ut = (1 << (32 - St(t) + o)) | (n << o) | r),
      (zt = l + e));
  } else ((Ut = (1 << l) | (n << o) | r), (zt = e));
}
function Li(e) {
...
function Ui(e) {
  for (; e === co; )
    ((co = Yn[--Xn]), (Yn[Xn] = null), (uo = Yn[--Xn]), (Yn[Xn] = null));
  for (; e === Dn; )
    ((Dn = mt[--pt]),
      (mt[pt] = null),
      (zt = mt[--pt]),
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (ut = e), (lt = nn(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Dn !== null ? { id: Ut, overflow: zt } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function Ps(e) {
  ...
  if (
    ...
    if (ql(e)) throw (Ju(), Error(O(418)));
    for (; t; ) (Xu(e, t), (t = nn(t.nextSibling)));
  }
  if ((nc(e), e.tag === 13)) {
  ...
  } else lt = ut ? nn(e.stateNode.nextSibling) : null;
  return !0;
}
function Ju() {
...
var mm = Wt.ReactCurrentBatchConfig;
function Rr(e, t, n) {
  if (
...
function Zu(e) {
      ...
      : f !== null &&
          (f.elementType === _ ||
            (typeof _ == "object" &&
              ...
              _.$$typeof === Qt &&
              rc(_) === f.type))
        ? ((v = o(f, p.props)), (v.ref = Rr(d, f, p)), (v.return = d), v)
        : ((v = Xs(p.type, p.key, p.props, null, d.mode, v)),
          (v.ref = Rr(d, f, p)),
          (v.return = d),
          v);
  }
  function u(d, f, p, v) {
    return f === null ||
      ...
      ? ((f = vl(p, d.mode, v)), (f.return = d), f)
      : ((f = o(f, p.children || [])), (f.return = d), f);
  }
  function h(d, f, p, v, _) {
    return f === null || f.tag !== 7
      ? ((f = Sn(p, d.mode, v, _)), (f.return = d), f)
      : ((f = o(f, p)), (f.return = d), f);
  }
  function g(d, f, p) {
    if ((typeof f == "string" && f !== "") || typeof f == "number")
      return ((f = yl("" + f, d.mode, p)), (f.return = d), f);
    if (typeof f == "object" && f !== null) {
      switch (f.$$typeof) {
        case _s:
          return (
            (p = Xs(f.type, f.key, f.props, null, d.mode, p)),
            (p.ref = Rr(d, null, f)),
            (p.return = d),
            p
          );
        ...
        case Qt:
          var v = f._init;
          return g(d, v(f._payload), p);
      }
      if (Or(f) || Cr(f))
        return ((f = Sn(f, d.mode, p, null)), (f.return = d), f);
      Ms(d, f);
    }
    return null;
  }
  function m(d, f, p, v) {
    ...
    if ((typeof p == "string" && p !== "") || typeof p == "number")
      return _ !== null ? null : a(d, f, "" + p, v);
    if (typeof p == "object" && p !== null) {
      switch (p.$$typeof) {
        case _s:
          return p.key === _ ? c(d, f, p, v) : null;
        case Hn:
          return p.key === _ ? u(d, f, p, v) : null;
        case Qt:
          return ((_ = p._init), m(d, f, _(p._payload), v));
      }
      if (Or(p) || Cr(p)) return _ !== null ? null : h(d, f, p, v, null);
      Ms(d, p);
    }
    return null;
  }
  function x(d, f, p, v, _) {
    if ((typeof v == "string" && v !== "") || typeof v == "number")
      return ((d = d.get(p) || null), a(f, d, "" + v, _));
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        ...
        case Qt:
          var C = v._init;
          return x(d, f, p, C(v._payload), _);
      }
      if (Or(v) || Cr(v)) return ((d = d.get(p) || null), h(f, d, v, _, null));
      Ms(f, v);
    }
    return null;
  }
  function w(d, f, p, v) {
    for (
      var _ = null, C = null, I = f, M = (f = 0), Q = null;
      I !== null && M < p.length;
      M++
    ) {
      ...
      (e && I && D.alternate === null && t(d, I),
        (f = l(D, f, M)),
        C === null ? (_ = D) : (C.sibling = D),
        (C = D),
        (I = Q));
    }
    if (M === p.length) return (n(d, I), ve && xn(d, M), _);
    if (I === null) {
      for (; M < p.length; M++)
        ((I = g(d, p[M], v)),
          I !== null &&
            ((f = l(I, f, M)),
            C === null ? (_ = I) : (C.sibling = I),
            (C = I)));
      return (ve && xn(d, M), _);
    }
    for (I = r(d, I); M < p.length; M++)
      ((Q = x(I, d, M, p[M], v)),
        Q !== null &&
  ...
  function j(d, f, p, v) {
    ...
    for (
      var C = (_ = null), I = f, M = (f = 0), Q = null, D = p.next();
      I !== null && !D.done;
      M++, D = p.next()
    ) {
      I.index > M ? ((Q = I), (I = null)) : (Q = I.sibling);
      var F = m(d, I, D.value, v);
      if (F === null) {
        I === null && (I = Q);
        break;
      }
      (e && I && F.alternate === null && t(d, I),
        (f = l(F, f, M)),
        C === null ? (_ = F) : (C.sibling = F),
        (C = F),
        (I = Q));
    }
    if (D.done) return (n(d, I), ve && xn(d, M), _);
    if (I === null) {
      for (; !D.done; M++, D = p.next())
        ((D = g(d, D.value, v)),
          D !== null &&
            ((f = l(D, f, M)),
            C === null ? (_ = D) : (C.sibling = D),
      ...
      switch (p.$$typeof) {
        case _s:
          e: {
            ...
            p.type === Gn
              ? ((f = Sn(p.props.children, d.mode, v, p.key)),
                (f.return = d),
                (d = f))
              : ((v = Xs(p.type, p.key, p.props, null, d.mode, v)),
                (v.ref = Rr(d, f, p)),
        ...
        case Hn:
          e: {
            ...
            ((f = vl(p, d.mode, v)), (f.return = d), (d = f));
          }
          return i(d);
        case Qt:
          return ((C = p._init), S(d, f, C(p._payload), v));
      }
      if (Or(p)) return w(d, f, p, v);
      if (Cr(p)) return j(d, f, p, v);
      Ms(d, p);
    }
    return (typeof p == "string" && p !== "") || typeof p == "number"
      ? ((p = "" + p),
        f !== null && f.tag === 6
          ...
          : (n(d, f), (f = yl(p, d.mode, v)), (f.return = d), (d = f)),
        i(d))
      : n(d, f);
  }
  return S;
...
function yt(e) {
  ...
  if ($i !== e)
    if (((e = { context: e, memoizedValue: t, next: null }), Jn === null)) {
      ...
      ((Jn = e), (ho.dependencies = { lanes: 0, firstContext: e }));
    } else Jn = Jn.next = e;
  return t;
}
var bn = null;
...
function mo(e, t, n, r) {
  ...
  if (l !== null) {
    ...
    ((In |= i), (e.lanes = i), (e.memoizedState = g));
  }
}
function oc(e, t, n) {
...
function Wi(e, t) {
  switch ((pe(ls, t), pe(os, e), pe(Mt, vs), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var Vs = Wt.ReactCurrentDispatcher,
  hl = Wt.ReactCurrentBatchConfig,
  Tn = 0,
  _e = null,
  Me = null,
  Oe = null,
...
function Ki(e, t, n, r, o, l) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Vs.current = e === null || e.memoizedState === null ? vm : wm),
    (e = n(r, o)),
    Gr)
  ) {
    l = 0;
    do {
      if (((Gr = !1), (is = 0), 25 <= l)) throw Error(O(301));
      ((l += 1),
        (Oe = Me = null),
        (t.updateQueue = null),
        (Vs.current = bm),
...
function ml(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    o = e;
    do ((l = o.lane), (_e.lanes |= l), (In |= l), (o = o.next));
    while (o !== e);
...
function od(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Xi(ad.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || l || (Oe !== null && Oe.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      cs(9, id.bind(null, n, r, o, t), void 0, null),
      Le === null)
    )
      throw Error(O(349));
    Tn & 30 || ld(n, t, o);
...
function id(e, t, n, r) {
  ((t.value = n), (t.getSnapshot = r), cd(t) && ud(e));
}
function ad(e, t, n) {
  return n(function () {
    cd(t) && ud(e);
...
function lc(e) {
  ...
  return (
    ...
    (t.queue = e),
    (e = e.dispatch = ym.bind(null, _e, e)),
    [t.memoizedState, e]
  );
}
function cs(e, t, n, r) {
...
function yd(e, t, n) {
  return Tn & 21
    ? (Et(n, t) || ((n = _u()), (_e.lanes |= n), (In |= n), (e.baseState = !0)),
      t)
...
function ym(e, t, n) {
  ...
  if (wd(e)) bd(t, o);
    ...
    ((n = td(e, t, o, r)),
      n !== null && ((o = Ye()), kt(n, e, r, o), Nd(n, t, r)));
  }
}
function wd(e) {
  var t = e.alternate;
...
var xo = {
  ...
  vm = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        (n = n != null ? n.concat([e]) : null),
        Qs(4194308, 4, md.bind(null, t, e), n)
      );
    },
    ...
    useTransition: function () {
      var e = lc(!1),
        t = e[0];
      return ((e = gm.bind(null, e[1])), (It().memoizedState = e), [t, e]);
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (o.queue = l),
        ic(ad.bind(null, r, l, e), [e]),
        (r.flags |= 2048),
        cs(9, id.bind(null, r, l, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  wm = {
    ...
    useDeferredValue: function (e) {
      var t = vt();
      return yd(t, Me.memoizedState, e);
    },
    useTransition: function () {
      var e = ml(as)[0],
        t = vt().memoizedState;
  ...
  bm = {
    ...
    useDeferredValue: function (e) {
      var t = vt();
      return Me === null ? (t.memoizedState = e) : yd(t, Me.memoizedState, e);
    },
    useTransition: function () {
      var e = pl(as)[0],
        t = vt().memoizedState;
...
function _d(e, t, n) {
  ...
  return (
    typeof l == "object" && l !== null
      ? (l = yt(l))
      : ((o = nt(t) ? En : Qe.current),
        (r = t.contextTypes),
        (l = (r = r != null) ? ar(e, o) : cn)),
    (t = new t(n, l)),
...
function Jl(e, t, n, r) {
  ...
  (typeof l == "object" && l !== null
    ? (o.context = yt(l))
    : ((l = nt(t) ? En : Qe.current), (o.context = ar(e, l))),
...
var _m = Wt.ReactCurrentOwner,
  et = !1;
function Ke(e, t, n, r) {
  t.child = e === null ? ed(t, null, n, r) : ur(t, e.child, n, r);
}
  ...
  return (
    ...
    e !== null && !et
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        Gt(e, t, o))
      : (ve && n && Li(t), (t.flags |= 1), Ke(e, t, r, o), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !et
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        Gt(e, t, o))
      : (ve && r && Li(t), (t.flags |= 1), Ke(e, t, n, o), t.child)
  );
}
function pc(e, t, n, r, o) {
  ...
  if ((or(t, o), t.stateNode === null))
    (qs(e, t), _d(t, n, r), Jl(t, n, r, o), (r = !0));
  else if (e === null) {
    var i = t.stateNode,
      a = t.memoizedProps;
    i.props = a;
    ...
    a !== g || m !== w || tt.current || qt
      ? (typeof x == "function" && (Xl(t, n, x, r), (w = t.memoizedState)),
        (u = qt || ac(t, n, u, r, m, w, c) || !1)
          ? (h ||
...
function ti(e, t, n, r, o, l) {
  Ed(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return (o && ec(t, n, !1), Gt(e, t, l));
...
function gc(e, t, n, r, o) {
  return (cr(), zi(o), (t.flags |= 256), Ke(e, t, n, r), t.child);
}
    ...
    return (
      !(i & 1) && t.child !== o
        ? ((r = t.child),
          ...
          (r.pendingProps = c),
          (t.deletions = null))
        : ((r = ln(o, c)), (r.subtreeFlags = o.subtreeFlags & 14680064)),
      a !== null ? (l = ln(a, l)) : ((l = Sn(l, i, n, null)), (l.flags |= 2)),
      (l.return = t),
      (r.return = t),
      (r.sibling = l),
      (t.child = r),
...
function jm(e, t, n, r, o, l, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = gl(Error(O(422)))), As(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (((a = (i & e.childLanes) !== 0), et || a)) {
    if (((r = Le), r !== null)) {
      ...
      ((o = o & (r.suspendedLanes | i) ? 0 : o),
        o !== 0 &&
          o !== l.retryLane &&
          ((l.retryLane = o), Ht(e, o), kt(r, e, o, -1)));
    }
    return (oa(), (r = gl(Error(O(421)))), As(e, t, i, r));
  }
  return o.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function Sm(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      (pe(fo, r._currentValue), (r._currentValue = o));
      break;
    case 13:
  ...
  switch ((Ui(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (Ps(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), _t !== null && (fi(_t), (_t = null)))),
        si(e, t),
        Ge(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Nn(Mt.current)), Ps(t))) {
          ((r = t.stateNode), (n = t.type));
          var l = t.memoizedProps;
          switch (((r[Rt] = t), (r[ss] = l), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
            ...
            case "video":
            case "audio":
              for (o = 0; o < Ur.length; o++) xe(Ur[o], r);
              break;
            case "source":
              xe("error", r);
              break;
          ...
          e: {
            switch (((i = Rl(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (o = 0; o < Ur.length; o++) xe(Ur[o], e);
                o = r;
                break;
              case "source":
                (xe("error", e), (o = r));
              ...
              if (a.hasOwnProperty(l)) {
                ...
                l === "style"
                  ...
                  : l === "dangerouslySetInnerHTML"
                    ? ((c = c ? c.__html : void 0), c != null && cu(e, c))
                    : l === "children"
                      ? typeof c == "string"
                        ? (n !== "textarea" || c !== "") && Kr(e, c)
    ...
    case 6:
      if (e && t.stateNode != null) Md(e, t, e.memoizedProps, r);
        ...
        if (((n = Nn(ls.current)), Nn(Mt.current), Ps(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Rt] = t),
    ...
    case 13:
      if (
        ...
        if (ve && lt !== null && t.mode & 1 && !(t.flags & 128))
          (Ju(), cr(), (t.flags |= 98560), (l = !1));
        else if (((l = Ps(t)), r !== null && r.dehydrated !== null)) {
          if (e === null) {
            ...
            (cr(),
              ...
              (t.flags |= 4));
          (Ge(t), (l = !1));
        } else (_t !== null && (fi(_t), (_t = null)), (l = !0));
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || be.current & 1 ? Ae === 0 && (Ae = 3) : oa())),
    ...
    case 23:
      return (
        ...
        r && t.mode & 1
          ? st & 1073741824 && (Ge(t), t.subtreeFlags & 6 && (t.flags |= 8192))
          : Ge(t),
        null
      );
    case 24:
...
function Dm(e, t) {
      ...
      e: {
        ...
        if (r && r.rangeCount !== 0) {
          ...
          t: for (;;) {
            for (
              var x;
              g !== n || (o !== 0 && g.nodeType !== 3) || (a = i + o),
                g !== l || (r !== 0 && g.nodeType !== 3) || (c = i + r),
  ...
  for (Hl = { focusedElem: e, selectionRange: n }, ro = !1, V = t; V !== null; )
                ...
                if (w !== null) {
                  var j = w.memoizedProps,
                    ...
                    f = d.getSnapshotBeforeUpdate(
                      t.elementType === t.type ? j : bt(t.type, j),
                      S,
                    );
...
function Ad(e) {
  ...
  (t !== null && ((e.alternate = null), Ad(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Rt], delete t[ss], delete t[Vl], delete t[dm], delete t[fm])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
        ...
        e: for (; a !== null; ) {
          switch (a.tag) {
            case 5:
              ...
              break e;
            case 3:
              ((ze = a.stateNode.containerInfo), (Nt = !0));
              break e;
            case 4:
              ((ze = a.stateNode.containerInfo), (Nt = !0));
              break e;
...
function Ud(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      (wt(t, e), Tt(e), r & 512 && n !== null && Zn(n, n.return));
      break;
    case 5:
      if (
        (wt(t, e),
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((We = (u = We) || h), wt(t, e), (We = u)) : wt(t, e),
        Tt(e),
        r & 8192)
      ) {
        if (
            ...
            ((i = V),
              ...
              i.tag === 22 && i.memoizedState !== null
                ...
                : c !== null
                  ? ((c.return = i), (V = c))
                  : _c(o));
        for (; l !== null; ) ((V = l), zd(l), (l = l.sibling));
        ((V = o), (Os = a), (We = u));
      }
      bc(e);
    } else
      o.subtreeFlags & 8772 && l !== null ? ((l.return = o), (V = l)) : bc(e);
  }
}
function bc(e) {
  for (; V !== null; ) {
...
var Im = Math.ceil,
  ...
  ea = Wt.ReactCurrentOwner,
  xt = Wt.ReactCurrentBatchConfig,
  ue = 0,
  Le = null,
  Te = null,
  $e = 0,
...
function kt(e, t, n, r) {
  if (50 < Qr) throw ((Qr = 0), (ui = null), Error(O(185)));
  (gs(e, n, r),
    (!(ue & 2) || e !== Le) &&
      (e === Le && (!(ue & 2) && (Ao |= n), Ae === 4 && Yt(e, $e)),
      rt(e, r),
      n === 1 && ue === 0 && !(t.mode & 1) && ((hr = Ee() + 500), Io && fn())));
}
function rt(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ra(n), t === 1))
      (e.tag === 0 ? hm(jc.bind(null, e)) : Ku(jc.bind(null, e)),
        cm(function () {
          !(ue & 6) && fn();
        }),
        (n = null));
      ...
      n = Qd(n, $d.bind(null, e));
    }
    ((e.callbackPriority = t), (e.callbackNode = n));
  }
}
function $d(e, t) {
  if (((Ks = -1), (Ys = 0), ue & 6)) throw Error(O(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = bo(e, r);
    ...
    ue |= 2;
    var l = Bd();
    (Le !== e || $e !== t) && ((Ot = null), (hr = Ee() + 500), jn(e, t));
    do
      try {
        Mm();
        break;
    ...
    (Fi(),
      (yo.current = l),
      (ue = o),
      Te !== null ? (t = 0) : ((Le = null), ($e = 0), (t = Ae)));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((o = Ll(e)), o !== 0 && ((r = o), (t = di(e, o)))), t === 1)
    )
      throw ((n = us), jn(e, 0), Yt(e, r), rt(e, Ee()), n);
    if (t === 6) Yt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (Yt(e, r), (r & 130023424) === r && ((t = na + 500 - Ee()), 10 < t))
          ) {
            if (no(e, 0) !== 0) break;
            ...
            e.timeoutHandle = Wl(yn.bind(null, e, Ze, Ot), t);
            break;
          }
          yn(e, Ze, Ot);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Wl(yn.bind(null, e, Ze, Ot), r);
            break;
          }
          yn(e, Ze, Ot);
          break;
  ...
  return (rt(e, Ee()), e.callbackNode === n ? $d.bind(null, e) : null);
}
function di(e, t) {
  var n = Vr;
  return (
...
function jc(e) {
  ...
  if (n === 1) throw ((n = us), jn(e, 0), Yt(e, t), rt(e, Ee()), n);
...
function ra(e, t) {
  ...
  try {
    ...
    ((ue = n), ue === 0 && ((hr = Ee() + 500), Io && fn()));
  }
}
function Rn(e) {
  Jt !== null && Jt.tag === 0 && !(ue & 6) && lr();
  var t = ue;
  ue |= 1;
  var n = xt.transition,
    r = fe;
  try {
    ...
    ((fe = r), (xt.transition = n), (ue = t), !(ue & 6) && fn());
  }
}
function sa() {
  ((st = er.current), ye(er));
...
function jn(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), am(n)), Te !== null))
...
function oa() {
  ((Ae === 0 || Ae === 3 || Ae === 2) && (Ae = 4),
    Le === null || (!(In & 268435455) && !(Ao & 268435455)) || Yt(Le, $e));
}
function bo(e, t) {
  var n = ue;
  ue |= 2;
  var r = Bd();
  (Le !== e || $e !== t) && ((Ot = null), jn(e, t));
  do
    try {
      Pm();
      break;
  ...
  while (!0);
  if ((Fi(), (ue = n), (yo.current = r), Te !== null)) throw Error(O(261));
  return ((Le = null), ($e = 0), Ae);
}
function Pm() {
  for (; Te !== null; ) Hd(Te);
}
function Mm() {
  for (; Te !== null && !oh(); ) Hd(Te);
}
function Hd(e) {
  var t = Vd(e.alternate, e, st);
...
function yn(e, t, n) {
  var r = fe,
    o = xt.transition;
  try {
    ((xt.transition = null), (fe = 1), Am(e, t, n, r));
  } finally {
...
function Am(e, t, n, r) {
  ...
  if (vo) throw ((vo = !1), (e = ci), (ci = null), e);
  return (
    wo & 1 && e.tag !== 0 && lr(),
    (l = e.pendingLanes),
    l & 1 ? (e === ui ? Qr++ : ((Qr = 0), (ui = e))) : (Qr = 0),
    fn(),
    null
  );
}
function lr() {
  if (Jt !== null) {
    var e = ju(wo),
      ...
      n = fe;
    try {
      if (((xt.transition = null), (fe = 16 > e ? 16 : e), Jt === null))
        var r = !1;
      else {
        if (((e = Jt), (Jt = null), (wo = 0), ue & 6)) throw Error(O(331));
        var o = ue;
        ...
        for (V = f; V !== null; ) {
          i = V;
          var p = i.child;
          if (i.subtreeFlags & 2064 && p !== null) ((p.return = i), (V = p));
          else
            e: for (i = f; V !== null; ) {
              if (((a = V), a.flags & 2048))
                try {
        ...
        if (
          ((ue = o), fn(), Pt && typeof Pt.onPostCommitFiberRoot == "function")
        )
          try {
...
function Om(e, t, n) {
  ...
  (r !== null && r.delete(t),
    ...
    Le === e &&
      ($e & n) === n &&
      (Ae === 4 || (Ae === 3 && ($e & 130023424) === $e && 500 > Ee() - na)
        ? jn(e, 0)
        : (ta |= n)),
    rt(e, t));
}
function Wd(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = Ye();
  ((e = Ht(e, t)), e !== null && (gs(e, t, n), rt(e, n)));
}
function Lm(e) {
  var t = e.memoizedState,
    n = 0;
...
Vd = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || tt.current) et = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return ((et = !1), Sm(e, t, n));
      et = !!(e.flags & 131072);
    }
  else ((et = !1), ve && t.flags & 1048576 && Yu(t, uo, t.index));
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      (qs(e, t), (e = t.pendingProps));
      var o = ar(t, Qe.current);
      (or(t, n), (o = Ki(null, t, r, e, o, n)));
      var l = Yi();
      return (
        (t.flags |= 1),
        typeof o == "object" &&
        ...
        o.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Jl(t, r, e, n),
            (t = ti(null, t, r, !0, l, n)))
          : ((t.tag = 0), ve && l && Li(t), Ke(null, t, o, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((Dd(t), e === null)) throw Error(O(387));
        ((r = t.pendingProps),
          (l = t.memoizedState),
          (o = l.element),
          nd(e, t),
        ...
        if (((r = i.element), l.isDehydrated))
          if (
            ...
            for (
              lt = nn(t.stateNode.containerInfo.firstChild),
                ut = t,
                ve = !0,
                _t = null,
                n = ed(t, null, r, n),
...
function Xs(e, t, n, r, o, l) {
  ...
  if (((r = e), typeof e == "function")) la(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case _l:
        return ((e = gt(13, n, t, o)), (e.elementType = _l), (e.lanes = l), e);
      case jl:
        return ((e = gt(19, n, t, o)), (e.elementType = jl), (e.lanes = l), e);
      case ru:
        return Oo(n, o, l, t);
      default:
...
function Gm(e, t, n, r, o) {
  ...
  var c = ia(e, 0, !1, null, null, !1, !1, "", Cc);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Di(t, n | 1), rt(t, Ee()), !(ue & 6) && ((hr = Ee() + 500), fn()));
      }
      break;
    case 13:
      (Rn(function () {
...
mu = ra;
pu = Rn;
var Wm = { usingClientEntryPoint: !1, Events: [ys, qn, To, fu, hu, ra] },
  Mr = {
  ...
  Vm = {
    ...
    findFiberByHostInstance: Mr.findFiberByHostInstance || Hm,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Us.isDisabled && Us.supportsFiber)
    try {
      ((ko = Us.inject(Vm)), (Pt = Us));
    } catch {}
}
ft.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Wm;
ft.createPortal = function (e, t) {
  var n = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
  if (!ua(t)) throw Error(O(200));
  return Bm(e, t, null, n);
};
ft.createRoot = function (e, t) {
  if (!ua(e)) throw Error(O(299));
  var n = !1,
    r = "",
    o = Yd;
  return (
...
ft.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = Kd(t, null, e, 1, n ?? null, o, !1, l, i)),
    (e[Bt] = t.current),
    ns(e),
    r)
  )
...
var Qm = Xc.exports,
  Jd,
  Ec = Qm;
((Jd = Ec.createRoot), Ec.hydrateRoot);
/**
      ...
      (
        ...
        y.createElement(
          "svg",
          {
            ...
            className: ["lucide", `lucide-${Km(e)}`, a].join(" "),
            ...u,
          },
          [
            ...t.map(([g, m]) => y.createElement(g, m)),
            ...(Array.isArray(c) ? c : [c]),
          ],
        ),
    );
...
const Bo = async () => {
  ...
  fa = (e) => {
    ...
    return `${at.domain.endsWith("/") ? at.domain.slice(0, -1) : at.domain}/${t}`;
  },
  ip = (e) => {
    if (!at)
      throw new Error("Configuration not loaded. Call loadConfig() first.");
  ...
  cp = async (e) =>
    await Se("/api/session/login", { method: "POST", body: { Data: e } }),
  up = (e) => (
  ...
  pp = ({ onLogin: e }) => {
    const { t } = bs(),
      ...
      [c, u] = y.useState(!1),
      h = async (g) => {
        (g.preventDefault(), a(null), u(!0));
        try {
          const m = await cp({ ID: n, Password: o });
          m.Code === 200
            ? (up(m.Data), e())
            : m.Code === -1 || m.Code === -2
              ? a(m.Result)
          ...
          (console.error("Login error:", m),
            a(m instanceof Error ? m.message : t("error.api")));
        } finally {
          u(!1);
        }
      };
...
class _o {
  ...
  log(t, n) {
    if (t >= this._minLevel) {
      const r = `[${new Date().toISOString()}] ${k[t]}: ${n}`;
      switch (t) {
        case k.Critical:
        case k.Error:
          this.out.error(r);
...
class Dp extends Ho {
  ...
  async send(t) {
    if (t.abortSignal && t.abortSignal.aborted) throw new jt();
    ...
    if (t.timeout) {
      ...
      o = setTimeout(() => {
        (n.abort(),
          this._logger.log(k.Warning, "Timeout from HTTP request."),
          (r = new ma()));
      }, c);
    }
    ...
    try {
      ...
      throw (
        r || (this._logger.log(k.Warning, `Error from HTTP request. ${c}.`), c)
      );
    } finally {
    ...
    if (!l.ok) {
      ...
      throw new kn(c || l.statusText, l.status);
    }
              ...
              (l &&
                ...
                (o.onerror = () => {
                  (this._logger.log(
                    ...
                    r(new kn(o.statusText, o.status)));
                }),
                (o.ontimeout = () => {
                  (this._logger.log(k.Warning, "Timeout from HTTP request."),
                    r(new ma()));
...
class pa {
  ...
  constructor(t, n, r, o, l, i, a) {
    ((this._nextKeepAlive = 0),
      ...
      (this._statefulReconnectBufferSize = a ?? Up),
      (this._logger = n),
      (this._protocol = r),
      (this.connection = t),
  ...
  async _startWithStateTransitions() {
    ...
    try {
      (await this._startInternal(),
        ...
        this._logger.log(k.Debug, "HubConnection connected successfully."));
    } catch (t) {
      return (
        (this._connectionState = me.Disconnected),
        this._logger.log(
  ...
  async _startInternal() {
    ...
    try {
      ...
      if (
        (this._logger.log(k.Debug, "Sending handshake request."),
  ...
  _stopInternal(t) {
    ...
    return (
      ...
      this._logger.log(k.Debug, "Stopping HubConnection."),
  ...
  invoke(t, ...n) {
    ...
    return new Promise((a, c) => {
      this._callbacks[l.invocationId] = (h, g) => {
        if (g) {
          c(g);
          return;
        } else
  ...
  _processHandshakeResponse(t) {
    ...
    } else this._logger.log(k.Debug, "Server handshake complete.");
  ...
  async _reconnect(t) {
    ...
    if (
      ...
      t
        ...
        : this._logger.log(k.Information, "Connection reconnecting."),
...
const zp = [0, 2e3, 1e4, 3e4, null];
class Rc {
  constructor(t) {
    this._retryDelays = t !== void 0 ? [...t, null] : zp;
  }
...
class Cn {}
Cn.Authorization = "Authorization";
Cn.Cookie = "Cookie";
class $p extends Ho {
  constructor(t, n) {
  ...
  _setAuthorizationHeader(t) {
    (t.headers || (t.headers = {}),
      this._accessToken
        ? (t.headers[Cn.Authorization] = `Bearer ${this._accessToken}`)
        : this._accessTokenFactory &&
          t.headers[Cn.Authorization] &&
          delete t.headers[Cn.Authorization]);
  }
  getCookieString(t) {
...
class Pc {
  ...
  async connect(t, n) {
    if (
      ...
      (this._url = t),
      this._logger.log(k.Trace, "(LongPolling transport) Connecting."),
      n === Ve.Binary &&
    ...
    this._logger.log(k.Trace, `(LongPolling transport) polling: ${a}.`);
    ...
    (c.statusCode !== 200
      ? (this._logger.log(
        ...
        (this._closeError = new kn(c.statusText || "", c.statusCode)),
        (this._running = !1))
      : (this._running = !0),
    ...
    try {
      for (; this._running; )
        try {
          ...
          this._logger.log(k.Trace, `(LongPolling transport) polling: ${r}.`);
          ...
          o.statusCode === 204
            ...
            : o.statusCode !== 200
              ? (this._logger.log(
                ...
                (this._closeError = new kn(o.statusText || "", o.statusCode)),
                (this._running = !1))
              : o.content
                ? (this._logger.log(
                    k.Trace,
                    `(LongPolling transport) data received. ${ms(o.content, this._options.logMessageContent)}.`,
                  ),
      ...
      (this._logger.log(k.Trace, "(LongPolling transport) Polling complete."),
  ...
  async stop() {
    (this._logger.log(k.Trace, "(LongPolling transport) Stopping polling."),
      (this._running = !1),
    ...
    try {
      ...
      (this._logger.log(k.Trace, "(LongPolling transport) Stop finished."),
        this._raiseOnClose());
    }
  }
  _raiseOnClose() {
...
class Bp {
  ...
  async connect(t, n) {
    return (
      ...
      De.isRequired(n, "transferFormat"),
      De.isIn(n, Ve, "transferFormat"),
      this._logger.log(k.Trace, "(SSE transport) Connecting."),
      (this._url = t),
      this._accessToken &&
        (t +=
          (t.indexOf("?") < 0 ? "?" : "&") +
          ...
          ((i.onmessage = (a) => {
            if (this.onreceive)
              try {
                (this._logger.log(
                  k.Trace,
                  `(SSE transport) data received. ${ms(a.data, this._options.logMessageContent)}.`,
                ),
            ...
            (i.onopen = () => {
              (this._logger.log(k.Information, `SSE connected to ${this._url}`),
                (this._eventSource = i),
                (l = !0),
                r());
            }));
...
class Hp {
  ...
  async connect(t, n) {
    (De.isRequired(t, "url"),
      De.isRequired(n, "transferFormat"),
      De.isIn(n, Ve, "transferFormat"),
      this._logger.log(k.Trace, "(WebSockets transport) Connecting."));
    let r;
    return (
      ...
      new Promise((o, l) => {
        ...
        (i || (i = new this._webSocketConstructor(t)),
          ...
          (i.onopen = (u) => {
            (this._logger.log(k.Information, `WebSocket connected to ${t}.`),
              (this._webSocket = i),
              (c = !0),
              o());
          }),
          (i.onerror = (u) => {
            ...
            (typeof ErrorEvent < "u" && u instanceof ErrorEvent
              ...
              this._logger.log(k.Information, `(WebSockets transport) ${h}.`));
          }),
          (i.onmessage = (u) => {
            if (
              (this._logger.log(
                k.Trace,
                `(WebSockets transport) data received. ${ms(u.data, this._logMessageContent)}.`,
              ),
              this.onreceive)
            )
              try {
  ...
  send(t) {
    return this._webSocket &&
      ...
      ? (this._logger.log(
          k.Trace,
          `(WebSockets transport) sending data. ${ms(t, this._logMessageContent)}.`,
        ),
  ...
  _close(t) {
    (this._webSocket &&
      ...
      this._logger.log(k.Trace, "(WebSockets transport) socket closed."),
      this.onclose &&
...
class Gp {
  ...
  async _startInternal(t) {
    ...
    try {
      if (this._options.skipNegotiation)
        ...
        do {
          if (
            ...
            throw new jt("The connection was stopped during negotiation.");
      ...
      return (
        this._logger.log(k.Error, "Failed to start the connection: " + r),
        (this._connectionState = "Disconnected"),
        (this.transport = void 0),
        this._stopPromiseResolver(),
        Promise.reject(r)
  ...
  async _getNegotiationResponse(t) {
    ...
    this._logger.log(k.Debug, `Sending negotiation request: ${l}.`);
    try {
      ...
      if (h instanceof Error) (i.push(`${u.transport} failed:`), i.push(h));
        ...
        try {
          ...
          if (
            (this._logger.log(
              k.Error,
              `Failed to start the transport '${u.transport}': ${g}`,
            ),
            (c = void 0),
            i.push(new yp(`${u.transport} failed: ${g}`, Pe[u.transport])),
            this._connectionState !== "Connecting")
          ) {
            const m = "Failed to select transport before stop() was called.";
            return (this._logger.log(k.Debug, m), Promise.reject(new jt(m)));
          }
        }
      }
    }
  ...
  _resolveTransportOrError(t, n, r, o) {
    ...
    if (Wp(n, l))
      if (t.transferFormats.map((a) => Ve[a]).indexOf(r) >= 0) {
        ...
        this._logger.log(k.Debug, `Selecting transport '${Pe[l]}'.`);
        try {
          return (
  ...
  _stopConnection(t) {
    ...
    if (
      ...
      t
        ...
        : this._logger.log(k.Information, "Connection disconnected."),
      this._sendQueue &&
  ...
  _resolveUrl(t) {
    ...
    return (
      (n.href = t),
      this._logger.log(k.Information, `Normalizing '${t}' to '${n.href}'.`),
      n.href
    );
  }
...
class Yp {
  configureLogging(t) {
    if ((De.isRequired(t, "logging"), Xp(t))) this.logger = t;
      ...
      const n = Kp(t);
      this.logger = new _o(n);
    } else this.logger = new _o(t);
    return this;
  }
  withUrl(t, n) {
    return (
    ...
    try {
      ...
      (console.log("=== SignalR Connection ==="),
        ...
        (this.connection = new Yp()
          ...
          .configureLogging(k.Information)
          .build()),
...
const vn = new Jp(),
  ...
  tg = async (e, t) => {
    ...
    return (
      ...
      console.log("========================"),
      await Se("/api/inspection/content_get_by_addTime", {
        method: "POST",
        body: n,
      })
    );
  ...
  xa = async (e, t, n, r, o) => {
    ...
    (console.log("=== API Request Debug ==="),
      ...
      console.log("========================"));
    const i = await Se("/api/inspection/sub_content_add", {
      method: "POST",
      body: l,
    });
    return (await Go(i), i);
  ...
  ff = async (e, t) => {
    ...
    (console.log("=== Delete API Request Debug ==="),
      ...
      console.log("Request Data:", JSON.stringify(n, null, 2)),
      console.log("================================"));
    const r = await Se("/api/inspection/sub_contents_delete_by_GUID", {
      method: "POST",
      body: n,
    });
    return (await Go(r), r);
  ...
  jo = async (e) => {
    ...
    (console.log("=== Update API Request Debug ==="),
      ...
      console.log("================================"));
    const o = await Se("/api/inspection/sub_content_update", {
      method: "POST",
      body: r,
    });
    return (await Go(o), o);
  ...
  ng = async (e) => {
    const t = new Date(),
      n =
        ...
        ":" +
        String(t.getSeconds()).padStart(2, "0"),
      r = { Data: e.map((l) => ({ ...l, OP_TIME: n })) };
    (console.log("=== Batch Update API Request Debug ==="),
      console.log("URL:", "/api/inspection/sub_content_update"),
      console.log("Method:", "POST"),
      console.log("Items Count:", e.length),
      console.log("Request Data:", JSON.stringify(r, null, 2)),
      console.log("======================================"));
    const o = await Se("/api/inspection/sub_content_update", {
      method: "POST",
  ...
  rg = async (e, t, n, r) => {
    ...
    return (
      ...
      console.log("====================================="),
      await Se("/api/pcmpo/analyze_single", { method: "POST", body: o })
    );
  },
  sg = async (e) => {
    const t = { ValueAry: [e] };
    return (
      ...
      console.log("================================================"),
      await Se("/api/inspection/content_get_by_IC_SN", {
        method: "POST",
        body: t,
      })
    );
  ...
  og = async (e, t, n) => {
    ...
    return (
      ...
      console.log("Request Data:", JSON.stringify(r, null, 2)),
      console.log("==========================================="),
      await Se("/api/pcmpo/update", { method: "POST", body: r })
    );
  },
  hf = async (e) => {
    const t = { ValueAry: [e] };
    return (
      ...
      console.log("Request Data:", JSON.stringify(t, null, 2)),
      console.log("====================================="),
      await Se("/api/pcmpo/get_by_MasterGUID", { method: "POST", body: t })
    );
  },
  lg = async (e) => {
    const t = { ValueAry: [e] };
    return (
      ...
      console.log("Request Data:", JSON.stringify(t, null, 2)),
      console.log("====================================="),
      await Se("/api/pcmpo/get_by_GUID", { method: "POST", body: t })
    );
  },
  ig = async (e) => {
    const t = { Data: e };
    return (
      ...
      console.log("Request Data:", JSON.stringify(t, null, 2)),
      console.log("================================================"),
      await Se("/api/pcmpo/update", { method: "POST", body: t })
    );
  },
  Lc = async (e) => {
    const t = { Value: e };
    return (
      ...
      console.log("Request Data:", JSON.stringify(t, null, 2)),
      console.log("=========================================="),
      await Se("/api/MED_page/serch_by_BarCode", { method: "POST", body: t })
    );
  },
  Uc = async (e, t) => {
    const n = { ValueAry: [e, t] };
    return (
      ...
      console.log("=================================================="),
      await Se("/api/inspection/content_get_by_sub_content_addTime", {
        method: "POST",
        body: n,
      })
    );
  ...
  mf = async () => {
    ...
    return (
      ...
      console.log("=========================================="),
      await Se("/api/med_page/get_med_cloud", { method: "POST", body: e })
    );
  },
  cg = async (e, t, n, r, o, l, i) => {
    ...
    return (
      ...
      console.log("=================================================="),
      await Se("/api/inspection/content_add", { method: "POST", body: a })
    );
  },
  ug = async (e) => {
    const t = { Data: [{ GUID: e }] };
    return (
      ...
      console.log("Request Data:", JSON.stringify(t, null, 2)),
      console.log("=================================================="),
      await Se("/api/inspection/contents_delete_by_GUID", {
        method: "POST",
        body: t,
      })
    );
  ...
  hg = ({ data: e, loading: t, onRowClick: n }) => {
    const { t: r } = bs(),
      [o, l] = y.useState(null),
      [i, a] = y.useState("asc"),
      c = (m) => {
        o === m ? a(i === "asc" ? "desc" : "asc") : (l(m), a("asc"));
      },
      u = y.useMemo(
        () =>
          o
            ? [...e].sort((x, w) => {
                ...
                switch (o) {
                  ...
                  case "NAME":
                    ...
                    break;
                  case "BRD":
                    ((j = x.BRD || "未指定"), (S = w.BRD || "未指定"));
                    break;
                }
                const d = j.localeCompare(S, "zh-TW");
                return i === "asc" ? d : -d;
              })
            : e,
        [e, o, i],
      ...
      h = (m) => {
        ...
        try {
          const x = new Date(m),
            w = new Date();
          (x.setHours(0, 0, 0, 0), w.setHours(0, 0, 0, 0));
          const j = x.getTime() - w.getTime(),
            S = Math.ceil(j / (1e3 * 60 * 60 * 24)),
            d = x
          ...
          return S === 0
            ? `${d} (${r("delivery.today")})`
            : S < 0
              ? `${d} (${r("delivery.overdue")} ${Math.abs(S)} ${r("delivery.days")})`
              : `${d} (${r("delivery.remaining")} ${S} ${r("delivery.days")})`;
        } catch (x) {
          return (console.error("Error formatting arrival time:", x), m);
        }
      },
      g = (m) => {
    ...
    return t
      ...
      : e.length === 0
        ? s.jsxs("div", {
            className: "bg-white rounded-lg shadow-sm border p-8 text-center",
            children: [
              s.jsx(Pn, { className: "w-12 h-12 text-gray-400 mx-auto mb-4" }),
              s.jsx("p", {
                className: "text-gray-600",
                children: "查無驗收資料",
              }),
                  ...
                  s.jsx("thead", {
                    ...
                    children: s.jsxs("tr", {
                      children: [
                        s.jsx("th", {
                          className:
                            "px-6 py-3 text-left text-base font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors select-none",
                          onClick: () => c("CODE"),
                        ...
                        s.jsx("th", {
                          className:
                            "px-6 py-3 text-left text-base font-medium text-gray-500 uppercase tracking-wider",
                        ...
                        s.jsx("th", {
                          className:
                            "px-6 py-3 text-right text-base font-medium text-gray-500 uppercase tracking-wider",
                        }),
                      ],
                    }),
                  }),
                          ...
                          children: [
                            ...
                            s.jsx("td", {
                              ...
                              children: s.jsx("div", {
                                ...
                                children: m.items.map((w, j) =>
                                  s.jsxs(
                                    "div",
                                    {
                                      className: `flex items-center ${g(w.DELIVERY_TIME)}`,
                                      children: [
                                        s.jsx(ds, {
                                          className:
                              ...
                              children: s.jsxs("div", {
                                ...
                                children: [
                                  s.jsx("span", {
                                    ...
                                    children:
                                      m.totalReceivedQty.toLocaleString(),
                                  }),
                                  s.jsx("span", {
                                  ...
                                  s.jsx("span", {
                                    ...
                                    children: m.totalStartQty.toLocaleString(),
                                  }),
                                  s.jsx("span", {
  ...
  mg = ({ isOpen: e, onClose: t, inspectionItem: n, onSuccess: r }) => {
    ...
    const p = () => {
      ...
      _ = (D) => {
        h && (w !== null && m ? C() : j(parseFloat(h)), x(D), g(""));
      },
      C = () => {
        if (w !== null && m && h) {
      ...
      Q = async (D) => {
        ...
        (a(!0), u(null));
        try {
          const B = await xa(n.GUID, o.lot, o.endQty, o.val, R);
          B.Code === 200 ? (r(), p()) : u(B.Result || "新增失敗");
        } catch (B) {
  ...
  pg = ({ isOpen: e, onClose: t, onConfirm: n, subContentData: r }) => {
                    ...
                    children: [
                      ...
                      s.jsx("button", {
                        ...
                        children: o
                          ...
                          : s.jsxs(s.Fragment, {
                              children: [
                                s.jsx(Mn, { className: "w-4 h-4 mr-2" }),
                                "確認刪除",
                              ],
                            }),
                      }),
  ...
  gg = ({
      ...
      g = () =>
        o != null && o.Sub_content
          ? o.Sub_content.reduce(
              (S, d) =>
                d.GUID === (n == null ? void 0 : n.GUID)
                  ? S
                  : S + (parseInt(d.END_QTY) || 0),
              0,
            )
          : 0,
      m = () => {
        if (!o) return 0;
        const S = parseInt(o.START_QTY || "0"),
          d = g();
    ...
    y.useEffect(() => {
      if (n) {
        ...
        i({ lot: n.LOT || "", endQty: n.END_QTY || "", val: S });
      }
    }, [n]);
    const x = () => {
      ...
      j = async (S) => {
        ...
        try {
          const v = l.val ? `${l.val} 00:00:00` : "",
            _ = { ...n, LOT: l.lot, END_QTY: l.endQty, VAL: v, OP: p },
            C = await jo(_);
          (console.log("Response Data", C),
            C.Code === 200 ? (r(), w()) : h(C.Result || "更新失敗"));
        } catch (v) {
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "text",
                            value: l.lot,
                            onChange: (S) => i({ ...l, lot: S.target.value }),
                            className:
                              "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                            required: !0,
                            placeholder: "請輸入批號",
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "date",
                            value: l.val,
                            onChange: (S) => i({ ...l, val: S.target.value }),
                            className:
                              "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                            required: !0,
                          }),
  ...
  xg = ({ isOpen: e, onClose: t, result: n, onConfirmSubmit: r }) => {
    ...
    const c = (h) => {
      ...
      u = async () => {
        ...
        try {
          ...
          const g = { ValueAry: [n.batch_id, n.GUID] };
          console.log("Check Request Data:", JSON.stringify(g, null, 2));
          const m = await Se("/api/pcmpo/check", { method: "POST", body: g });
          if (
            (console.log("Check Response:", JSON.stringify(m, null, 2)),
            m.Code !== 200)
          ) {
            a(m.Result || "確認檢查失敗");
            return;
          ...
          const x = n.expirydate ? `${n.expirydate} 00:00:00` : "",
            w = await xa(n.Master_GUID, n.batch_num, n.qty, x, h);
          (console.log("Add Sub Content Response:", JSON.stringify(w, null, 2)),
            w.Code === 200
              ? (console.log("✅ 確認送出成功"), r && r(), t())
              : a(w.Result || "新增子明細失敗"));
        } catch (g) {
          (console.error("Confirm submit error:", g),
            console.log("❌ 確認送出失敗"),
            a(g instanceof Error ? g.message : "系統錯誤，請稍後再試"));
        } finally {
          l(!1);
        }
      };
        ...
        children: [
              ...
              s.jsxs("div", {
                children: [
                  ...
                  s.jsxs("div", {
                    ...
                    children: [
                      s.jsx(Ct, { className: "w-4 h-4 text-green-500 mr-1" }),
                      s.jsx("span", {
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          s.jsxs("h5", {
                            ...
                            children: [
                              s.jsx(Pn, { className: "w-4 h-4 mr-1" }),
                              "藥品資訊",
                            ],
                          }),
                          s.jsxs("div", {
                            ...
                            children: [
                              ...
                              s.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  s.jsx("span", {
                                    className: `font-medium ${n.check === "未確認" ? "text-yellow-600" : "text-green-600"}`,
                                    children: n.check,
                                  }),
                                ],
                              }),
          ...
          i &&
            s.jsxs("div", {
              ...
              children: [
                s.jsx(Ct, { className: "w-4 h-4 mr-2 flex-shrink-0" }),
                i,
              ],
            }),
          s.jsx("div", {
  ...
  yg = ({ isOpen: e, onClose: t, inspectionItem: n, onDataUpdate: r }) => {
    const [o, l] = y.useState(null),
      ...
      p = (C) => {
        var Q;
        const I = (Q = C.target.files) == null ? void 0 : Q[0];
        if (!I) return;
          ...
          ((Q.onload = (D) => {
            ...
            ((F.onload = () => {
              let W = F.width,
                L = F.height;
              W > L
                ? W > 1920 && ((L = Math.round((L * 1920) / W)), (W = 1920))
                : L > 1920 && ((W = Math.round((W * 1920) / L)), (L = 1920));
              const q = document.createElement("canvas");
              ((q.width = W), (q.height = L));
              const E = q.getContext("2d");
              if (!E) {
                M(new Error("無法建立 Canvas context"));
                return;
              }
              (E.drawImage(F, 0, 0, W, L),
                q.toBlob(
                  (U) => {
                    if (!U) {
                      M(new Error("圖片壓縮失敗"));
                    ...
                    ((A.onload = () => {
                      ...
                      (console.log("壓縮結果:", {
                        原始大小: `${(C.size / 1024 / 1024).toFixed(2)} MB`,
                        壓縮後大小: `${(U.size / 1024 / 1024).toFixed(2)} MB`,
                        壓縮比例: `${((1 - U.size / C.size) * 100).toFixed(1)}%`,
      ...
      _ = async () => {
        ...
        try {
          ...
          (console.error("Upload and analyze error:", M),
            ...
            g(M instanceof Error ? M.message : "系統錯誤，請稍後再試"));
        } finally {
          u(!1);
        }
      };
  ...
  vg = ({ isOpen: e, onClose: t, onConfirm: n, inspectionContent: r }) => {
    const [o, l] = y.useState(!1),
      [i, a] = y.useState(null),
      c = async () => {
        if (r) {
  ...
  wg = ({ isOpen: e, onClose: t, imageUrl: n, title: r }) =>
    e
      ? s.jsx("div", {
          className:
      ...
      : null,
  bg = ({ groupedData: e, isOpen: t, onClose: n, onDataUpdate: r }) => {
    const [o, l] = y.useState(!1),
      [i, a] = y.useState(null),
      [c, u] = y.useState(!1),
      [h, g] = y.useState(!1),
      ...
      [v, _] = y.useState(!1),
      [C, I] = y.useState(null),
      [M, Q] = y.useState({ isOpen: !1, imageUrl: "", title: "" }),
      [D, F] = y.useState(null),
      [P, R] = y.useState(new Set()),
      [B, W] = y.useState(null),
      L = af(),
      q = (z) => {
        (a(z), l(!0));
      ...
      N = async (z, K) => {
        F(z);
        try {
          (console.log("=== 查看驗收單圖片 ==="), console.log("Item GUID:", z));
          const se = await hf(z);
          if (
            ...
            if (
              ...
              (console.log(
                ...
                Q({ isOpen: !0, imageUrl: oe, title: `${K} - 驗收單圖片` }));
            } else
      ...
      $ = async (z, K) => {
        ...
        (R((se) => new Set([...se, z.GUID])), W(null));
        try {
          (console.log("=== Lock/Unlock Sub Content Debug ==="),
            console.log("Sub Content GUID:", z.GUID),
            console.log("Current State:", z.STATE),
            console.log("New State:", K));
          const se = { ...z, STATE: K };
          console.log("Update Data:", JSON.stringify(se, null, 2));
          const ae = await jo(se);
          (console.log("Lock/Unlock Response:", JSON.stringify(ae, null, 2)),
            ae.Code === 200
              ? (console.log(`✅ ${K === "已鎖定" ? "鎖定" : "解鎖"}成功`),
                r && r())
              : W(ae.Result || `${K === "已鎖定" ? "鎖定" : "解鎖"}失敗`));
        } catch (se) {
      ...
      : s.jsxs(s.Fragment, {
          children: [
                                              ...
                                              children: [
                                                ...
                                                s.jsxs("div", {
                                                  children: [
                                                    ...
                                                    s.jsx("span", {
                                                      className: "font-medium",
                                                      children: z.DELIVERY_TIME
                                                        ? z.DELIVERY_TIME.split(
                                                            " ",
                                                          )[0].replace(
                                                            /-/g,
                                                            "/",
                                                          ...
                                                          children: [
                                                            ...
                                                            s.jsx("div", {
                                                              ...
                                                              children: s.jsx(
                                                                "span",
                                                                {
                                                                  className: `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${K.STATE === "未鎖定" ? "bg-yellow-100 text-yellow-800" : "bg-green-100 text-green-800"}`,
                                                                  children:
                                                                    K.STATE,
                                                                },
                                                              ),
            ...
            s.jsx(gg, {
              ...
              subContentData: m,
              onSuccess: H,
              inspectionItem: e.items.find((z) => {
                var K;
                return (K = z.Sub_content) == null
                  ? void 0
                  : K.some((se) => se.GUID === (m == null ? void 0 : m.GUID));
              }),
            }),
            s.jsx(pg, {
              isOpen: c,
  ...
  Ng = ({
    ...
    const { t: i } = bs(),
      ...
      [g, m] = y.useState(e.split(" ")[0]),
      [x, w] = y.useState("00:00:00"),
      [j, S] = y.useState(t.split(" ")[0]),
      [d, f] = y.useState("23:59:59"),
      p = [
        ...
        s.jsxs("div", {
          ...
          children: [
            s.jsxs("div", {
              ...
              children: [
                s.jsx(Ym, { className: "w-5 h-5 text-gray-600" }),
                s.jsx("h3", {
            ...
            s.jsx(_n, {
              className: `w-5 h-5 text-gray-400 transition-transform duration-200 ${a ? "rotate-180" : ""}`,
            }),
          ],
        }),
        a &&
  ...
  _g = ({ isOpen: e, onClose: t, analysisResult: n, onSuccess: r }) => {
    ...
    const w = async () => {
        if (n != null && n.po_num) {
          ...
          try {
            ...
            const d = await sg(n.po_num);
            if (d.Code === 200 && d.Data) {
              (l(d.Data), console.log("找到驗收資料:", d.Data.length, "筆"));
              const f = d.Data.filter((p) => {
              ...
              (l(f), console.log("過濾後的驗收資料:", f.length, "筆"));
            } else (x(d.Result || "查無相關驗收資料"), l([]));
          } catch (d) {
            (console.error("搜尋驗收資料失敗:", d),
              x(d instanceof Error ? d.message : "搜尋失敗"),
              l([]));
          } finally {
            g(!1);
          }
      ...
      j = async () => {
        if (!(!i || !n)) {
          ...
          try {
            ...
            const d = await og(n.GUID, i, n);
            (console.log("配對 API 完整回應:", d),
              d.Code === 200
                ? (console.log("配對成功"), r(n.GUID))
                : x(d.Result || "配對失敗"));
          } catch (d) {
            (console.error("配對失敗:", d),
              x(d instanceof Error ? d.message : "配對失敗"));
          } finally {
            u(!1);
          }
        }
                            ...
                            : s.jsx("div", {
                                ...
                                children: o.map((d) =>
                                  s.jsxs(
                                    "div",
                                    {
                                      className: `border rounded-lg p-4 cursor-pointer transition-colors ${(i == null ? void 0 : i.GUID) === d.GUID ? "border-blue-500 bg-blue-50" : "border-gray-200 hover:border-gray-300"}`,
                                      onClick: () => a(d),
                                      children: [
                                        s.jsxs("div", {
                                          className:
  ...
  jg = ({ isOpen: e, onClose: t, imageUrl: n, title: r }) =>
    e
      ? s.jsx("div", {
          className:
            "fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[60]",
      ...
      : null,
  Sg = ({ isOpen: e, onClose: t, results: n, onDataUpdate: r }) => {
    const [o, l] = y.useState([]),
      [i, a] = y.useState(!1),
      [c, u] = y.useState(null),
      [h, g] = y.useState(null),
      [m, x] = y.useState({ isOpen: !1, result: null }),
      [w, j] = y.useState(new Set()),
      [S, d] = y.useState(null),
      [f, p] = y.useState({
        po_num: "",
        qty: "",
      ...
      [C, I] = y.useState(!1),
      [M, Q] = y.useState(null),
      [D, F] = y.useState(new Set());
    y.useEffect(() => {
      n && n.length > 0 && o.length === 0 && l(n);
    }, [n, o.length]);
    const P = async (b) => {
        try {
          (console.log("=== 開始取得最新資料 ==="), console.log("GUID:", b));
          const Z = await lg(b);
          if (
            (console.log("API Response:", Z),
            Z.Code === 200 && Z.Data && Z.Data.length > 0)
          ) {
            const N = Z.Data[0];
            (console.log("取得最新資料:", N),
              l(($) => {
                const z = $.findIndex((se) => se.GUID === b);
                if (z < 0)
                  return (console.warn("找不到對應的結果 GUID:", b), $);
                const K = [...$];
                return (
                  (K[z] = { ...$[z], ...N, base64: $[z].base64 }),
                  console.log("✅ 更新成功，索引:", z),
                  console.log("更新後資料:", K[z]),
                  K
                );
              }));
          } else
            (console.error("取得最新資料失敗:", Z.Result),
              u(Z.Result || "取得最新資料失敗"));
        } catch (Z) {
          (console.error("取得最新資料異常:", Z),
            u(Z instanceof Error ? Z.message : "取得最新資料失敗"));
        }
      },
      R = (b, Z) => {
        console.log("Image clicked:", { index: Z, hasBase64: !!b.base64 });
        const N = b.base64 || b.image || b.img || b.picture;
        if (!N) {
          console.warn("No image data found for result:", b);
          return;
        }
        const $ = N.startsWith("data:") ? N : `data:image/jpeg;base64,${N}`;
        (console.log("Setting zoom image:", {
          url: $.substring(0, 50) + "...",
          title: `出貨單分析結果 #${Z + 1}`,
        }),
          g({ url: $, title: `出貨單分析結果 #${Z + 1}` }));
      },
      B = (b) => {
        (console.log("開始配對流程:", b), x({ isOpen: !0, result: b }));
      },
      W = (b) => {
        (d(b.GUID),
          p({
            ...
            expirydate: b.expirydate ? b.expirydate.split(" ")[0] : "",
          }));
      },
      L = () => {
        (d(null), p({ po_num: "", qty: "", batch_num: "", expirydate: "" }));
      },
      q = async (b) => {
        (_(b.GUID), u(null));
        try {
          (console.log("=== 開始更新分析結果 ==="),
            ...
            console.log("更新資料:", f));
          const Z = f.expirydate ? `${f.expirydate} 00:00:00` : "",
            N = await ig({
              GUID: b.GUID,
              po_num: f.po_num,
              qty: f.qty,
              batch_num: f.batch_num,
              expirydate: Z,
            });
          (console.log("更新 API 回應:", N),
            N.Code === 200
              ? (console.log("✅ 更新成功"), await P(b.GUID), d(null))
              : u(N.Result || "更新失敗"));
        } catch (Z) {
          (console.error("更新失敗:", Z),
            u(Z instanceof Error ? Z.message : "更新失敗"));
        } finally {
          _(null);
        }
      },
      E = (b) =>
        w.has(b.GUID)
          ...
          : b.check === "此單號已驗收"
            ...
            : { canPair: !0, reason: "" },
      U = (b) => {
        (console.log("配對成功，準備取得最新資料，GUID:", b),
          P(b),
      ...
      A = (b) =>
        D.has(b.GUID)
          ? !1
          : !!(b.po_num && b.qty && b.batch_num && b.expirydate),
      H = async () => {
        const b = o.filter((N) => A(N) && !D.has(N.GUID));
        if (b.length === 0) {
          Q("沒有可送出的資料");
          return;
        }
        ...
        try {
          console.log(
            `本次送出的 GUID 共 ${b.length} 筆:`,
            b.map((oe) => oe.GUID),
          );
          const $ = { ValueAry: [null, b.map((oe) => oe.GUID).join(";")] },
            z = await Se("/api/pcmpo/check", { method: "POST", body: $ });
          if (z.Code !== 200) {
            Q(z.Result || "確認檢查失敗");
            return;
          }
          ...
          (se.length > 0 &&
            ...
            ae.length === 0
              ...
              : se.length > 0
                ? (Q(
                    `部分成功：${se.length} 筆成功，${ae.length} 筆失敗。失敗原因：${ae.join("; ")}`,
                  ),
                  r && r())
                : Q(`全部失敗：${ae.join("; ")}`));
        } catch (N) {
      ...
      G = async () => {
        const b = o.filter((Z) => !D.has(Z.GUID));
        if (b.length > 0)
          try {
            (console.log("=== 刪除未送出資料 ==="),
              console.log("未送出資料數量:", b.length),
              console.log(
                "未送出的 GUIDs:",
                b.map((z) => z.GUID),
              ));
            const N = { ValueAry: [b.map((z) => z.GUID).join(";")] };
            (console.log("=== Delete API Request Debug ==="),
              console.log("URL:", "/api/pcmpo/delete_by_GUID"),
              console.log("Method:", "POST"),
              console.log("Request Data:", JSON.stringify(N, null, 2)));
            const $ = await Se("/api/pcmpo/delete_by_GUID", {
              method: "POST",
              body: N,
            });
            (console.log("Delete API Response:", JSON.stringify($, null, 2)),
              $.Code === 200
                ? console.log("✅ 未送出資料刪除成功")
                : console.log("❌ 未送出資料刪除失敗:", $.Result));
          } catch (Z) {
            console.error("刪除未送出資料失敗:", Z);
          }
        (D.size > 0 && r && r(), t());
      };
                  ...
                  s.jsx("div", {
                    ...
                    children: o.map((b, Z) =>
                      s.jsxs(
                        "div",
                        {
                          className: `border rounded-lg p-4 ${D.has(b.GUID) ? "bg-blue-50 border-blue-200" : "bg-gray-50"}`,
                          children: [
                            s.jsx("div", {
                              className: "mb-2",
                              children: A(b)
                                              ...
                                              children: [
                                                ...
                                                (() => {
                                                  ...
                                                  return s.jsxs("button", {
                                                    onClick: () => B(b),
                                                    className: `px-2 py-1 text-xs rounded transition-colors flex items-center ${N.canPair ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-400 text-white cursor-not-allowed"}`,
                                                    disabled: !N.canPair,
                                                    title: N.canPair
                                                      ? ""
                                                      : N.reason,
                                ...
                                b.base64 &&
                                  s.jsx("div", {
                                    ...
                                    children: s.jsxs("div", {
                                      ...
                                      children: [
                                        s.jsx("img", {
                                          src: b.base64.startsWith("data:")
                                            ? b.base64
                                            : `data:image/jpeg;base64,${b.base64}`,
                                          alt: `出貨單 ${Z + 1}`,
                                          className:
                ...
                children: [
                  s.jsx("div", {
                    ...
                    children: s.jsxs("div", {
                      ...
                      children: [
                        "可送出: ",
                        o.filter((b) => A(b) && !D.has(b.GUID)).length,
                        " 筆 | 已送出: ",
                        D.size,
                        " 筆 | 未送出: ",
                        o.filter((b) => !D.has(b.GUID)).length,
                        " 筆",
                      ],
                    }),
                  }),
                  s.jsxs("div", {
                    ...
                    children: [
                      s.jsx("button", {
                        ...
                        disabled:
                          C ||
                          o.filter((b) => A(b) && !D.has(b.GUID)).length === 0,
                        className:
                          "px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center",
                        children: C
                          ? s.jsxs(s.Fragment, {
  ...
  kg = ({ message: e, type: t = "success", duration: n = 3e3, onClose: r }) => {
    const [o, l] = y.useState(!1),
      [i, a] = y.useState(!1);
    y.useEffect(() => {
      setTimeout(() => l(!0), 10);
    ...
    const c = () => {
      ...
      u = () => {
        switch (t) {
          case "success":
            return s.jsx(Ct, { className: "w-5 h-5 text-green-500" });
          case "error":
            return s.jsx(of, { className: "w-5 h-5 text-red-500" });
          case "warning":
            return s.jsx(it, { className: "w-5 h-5 text-yellow-500" });
          case "info":
            return s.jsx(Zm, { className: "w-5 h-5 text-blue-500" });
          default:
            return s.jsx(Ct, { className: "w-5 h-5 text-green-500" });
        }
      },
    ...
    return s.jsx("div", {
      className: `fixed top-4 right-4 z-[9999] transition-all duration-300 ease-out ${o && !i ? "translate-x-0 opacity-100" : i ? "-translate-x-full opacity-0" : "translate-x-full opacity-0"}`,
      children: s.jsxs("div", {
  ...
  Cg = ({ isOpen: e, onClose: t, onDataUpdate: n }) => {
    const [r, o] = y.useState([]),
      ...
      w = y.useRef(null),
      [j, S] = y.useState(!1),
      { toasts: d, showToast: f, removeToast: p } = gf(),
      v = () => {
        ...
        new Promise((B, W) => {
          ...
          ((L.onload = (q) => {
            ...
            ((E.onload = () => {
              ...
              ((b.width = G), (b.height = ie));
              const Z = b.getContext("2d");
              if (!Z) {
                W(new Error("無法建立 Canvas context"));
                return;
              }
              (Z.drawImage(E, 0, 0, G, ie),
                b.toBlob(
                  (N) => {
                    if (!N) {
                      W(new Error("圖片壓縮失敗"));
                    ...
                    (($.onload = () => {
                      const K = $.result.split(",")[1];
                      (console.log("壓縮結果:", {
                        原始大小: `${(R.size / 1024 / 1024).toFixed(2)} MB`,
                        壓縮後大小: `${(N.size / 1024 / 1024).toFixed(2)} MB`,
                        壓縮比例: `${((1 - N.size / R.size) * 100).toFixed(1)}%`,
              ...
              (E.onerror = W),
              (E.src = (U = q.target) == null ? void 0 : U.result));
          }),
            (L.onerror = W),
            L.readAsDataURL(R));
        }),
      Q = async (R) => {
        const B = ha(),
          W = ot();
        if (!B || !W) throw new Error("無法取得操作人資訊");
        try {
          o((H) =>
            H.map((G) => (G.id === R.id ? { ...G, status: "uploading" } : G)),
          );
          const {
              base64: L,
              originalSize: q,
          ...
          if (
            ...
            return (
              o((G) =>
                G.map((ie) =>
                  ie.id === R.id ? { ...ie, status: "uploaded", guid: H } : ie,
                ),
              ),
              H
            );
      ...
      D = async () => {
        const R = r.filter((B) => B.status === "pending" && B.previewUrl);
        if (R.length === 0) {
          c("請選擇有效的圖片檔案");
          return;
        }
          ...
          for (const L of B) {
            ...
            try {
              ...
              (console.log("=== Analyze Batch API Request Debug ==="),
                ...
                console.log("Method:", "POST"),
                console.log("Request Data:", JSON.stringify(U, null, 2)),
                console.log("準備發送 API 請求..."));
              const A = await Se("/api/pcmpo/analyze_batch", {
                method: "POST",
                body: U,
              });
              ...
              (console.error(`❌ 圖片 ${q.file.name} 分析異常:`, U),
                o((A) =>
                  A.map((H) =>
                    H.id === q.id
                      ? {
                          ...H,
                          status: "error",
                          error: U instanceof Error ? U.message : "分析失敗",
                        }
                      : H,
                  ),
                ),
                W.push({
                  GUID: E,
                  Result: U instanceof Error ? U.message : "分析異常",
                  check: "辨識失敗",
                  base64: q.previewUrl,
                  op_name: ot(),
                  create_time: new Date().toLocaleString("zh-TW"),
                  ...
                  code: "",
                  _isFailed: !0,
                  _failureReason: U instanceof Error ? U.message : "分析異常",
                }));
            }
          }
          (console.log("分析成功數量:", W.length),
            console.log("所有分析結果:", W),
            console.log("=== 批次處理完成 ==="),
            W.length > 0 ? (h(W), m(!0)) : c("沒有成功的分析結果"));
        } catch (B) {
      ...
      F = async (R) => {
        var L;
        const B = (L = R.target.files) == null ? void 0 : L[0];
        if (!B) return;
        if (!B.name.endsWith(".xlsx") && !B.name.endsWith(".xls")) {
          (f("請選擇 Excel 檔案 (.xlsx 或 .xls)", "error"),
        ...
        try {
          (console.log("=== 上傳出貨單 Excel ==="),
            ...
            console.log("操作人:", W));
          const q = await fg(B, W);
          (console.log("上傳回應:", q),
            q.Code === 200
              ? (f(q.Result || "Excel 上傳成功", "success"),
                n && n(),
                w.current && (w.current.value = ""),
                setTimeout(() => {
                  _();
                }, 500))
              : f(q.Result || "Excel 上傳失敗", "error"));
        } catch (q) {
        ...
        switch (R) {
          ...
          case "uploaded":
            return s.jsxs("span", {
              ...
              children: [s.jsx(Ct, { className: "w-4 h-4 mr-1" }), "已上傳"],
            });
          case "analyzing":
            return s.jsxs("span", {
              className: "text-blue-500 flex items-center",
          ...
          case "analyzed":
            return s.jsxs("span", {
              className: "text-green-500 flex items-center",
              children: [s.jsx(Ct, { className: "w-4 h-4 mr-1" }), "已完成"],
            });
          case "error":
            return s.jsxs("span", {
              className: "text-red-500 flex items-center",
              children: [s.jsx(it, { className: "w-4 h-4 mr-1" }), B || "錯誤"],
            });
          default:
            return null;
        }
                        ...
                        children:
                          ...
                          s.jsxs("span", {
                            children: [
                              ...
                              r.length,
                              " 張圖片 | 待處理: ",
                              r.filter((R) => R.status === "pending").length,
                              " | 已完成: ",
                              r.filter((R) => R.status === "analyzed").length,
                              " | 錯誤: ",
                              r.filter((R) => R.status === "error").length,
                            ],
                          }),
                      }),
                      s.jsxs("div", {
  ...
  zc = ({
    ...
    const [c, u] = Ce.useState(new Set()),
      [h, g] = Ce.useState(new Set()),
      [m, x] = Ce.useState(null),
      [w, j] = Ce.useState(!1),
      [S, d] = Ce.useState(!1),
      [f, p] = Ce.useState(""),
      [v, _] = Ce.useState("00:00:00"),
      [C, I] = Ce.useState(""),
      [M, Q] = Ce.useState("23:59:59"),
      [D, F] = Ce.useState(null),
      [P, R] = Ce.useState({ lot: "", endQty: "", val: "" }),
      [B, W] = Ce.useState(null),
      [L, q] = Ce.useState({
        isOpen: !1,
        subContent: null,
        inspectionItem: null,
      }),
      [E, U] = Ce.useState(null),
    ...
    Ce.useEffect(() => {
      if (l) {
        ...
        (p(X), I(X), _("00:00:00"), Q("23:59:59"));
      } else if (a) {
        const [T, X] = a,
          J = T.split(" "),
          te = X.split(" ");
        (p(J[0]), _(J[1] || "00:00:00"), I(te[0]), Q(te[1] || "23:59:59"));
      }
    }, [l, a]);
    const $ = af(),
      z = (T) => {
        ...
        try {
          ...
          const te = X.getTime() - J.getTime(),
            we = Math.ceil(te / (1e3 * 60 * 60 * 24)),
            ee = X.toLocaleDateString("zh-TW", {
              year: "numeric",
              month: "2-digit",
              day: "2-digit",
            }).replace(/\//g, "/");
          return we === 0
            ? `${ee} (${N("delivery.today")})`
            : we < 0
              ? `${ee} (${N("delivery.overdue")} ${Math.abs(we)} ${N("delivery.days")})`
              : `${ee} (${N("delivery.remaining")} ${we} ${N("delivery.days")})`;
        } catch (X) {
          return (console.error("Error formatting arrival time:", X), T);
        }
      },
      K = (T) => {
      ...
      ae = async (T, X) => {
        ...
        (g((J) => new Set([...J, T.GUID])), x(null));
        try {
          (console.log("=== Lock/Unlock Sub Content Debug ==="),
            console.log("Sub Content GUID:", T.GUID),
            console.log("Current State:", T.STATE),
            console.log("New State:", X));
          const J = { ...T, STATE: X };
          console.log("Update Data:", JSON.stringify(J, null, 2));
          const te = await jo(J);
          (console.log("Lock/Unlock Response:", JSON.stringify(te, null, 2)),
            te.Code === 200
              ? (console.log(`✅ ${X === "已鎖定" ? "鎖定" : "解鎖"}成功`),
                o && o())
              : x(te.Result || `${X === "已鎖定" ? "鎖定" : "解鎖"}失敗`));
        } catch (J) {
      ...
      oe = async () => {
        ...
        if (
          (n.forEach((te) => {
            te.Sub_content &&
              te.Sub_content.length > 0 &&
              T.push(...te.Sub_content);
          }),
          T.length === 0)
        ) {
          x("沒有可操作的子明細");
        ...
        try {
          (console.log(`=== 批次${J} Debug ===`),
            console.log("子明細數量:", T.length),
            console.log("目標狀態:", X));
          const te = T.map((ee) => ({ ...ee, STATE: X })),
            we = await ng(te);
          (console.log(`=== 批次${J}結果 ===`),
            console.log("Response:", we),
            we.Code === 200
              ? (console.log(`✅ 批次${J}完全成功`),
                console.log("成功數量:", T.length),
                o && o())
              : x(`批次${J}失敗：${we.Result}`));
        } catch (te) {
          (console.error(`批次${J}失敗:`, te),
            x(te instanceof Error ? te.message : `批次${J}失敗`));
        } finally {
          j(!1);
        }
      },
      Be = (T) => {
        ...
        if (T.VAL)
          try {
            const J = new Date(T.VAL),
              te = J.getFullYear(),
              we = String(J.getMonth() + 1).padStart(2, "0"),
              ee = String(J.getDate()).padStart(2, "0");
            X = `${te}-${we}-${ee}`;
          } catch {
            console.warn("Invalid date format:", T.VAL);
          }
        R({ lot: T.LOT || "", endQty: T.END_QTY || "", val: X });
      },
      wr = () => {
        (F(null), R({ lot: "", endQty: "", val: "" }));
      },
      br = async (T) => {
        (W(T.GUID), x(null));
        try {
          ...
          const J = P.val ? `${P.val} 00:00:00` : "",
            te = { ...T, LOT: P.lot, END_QTY: P.endQty, VAL: J, OP: X },
            we = await jo(te);
          we.Code === 200
          ...
          (console.error("更新失敗:", X),
            x(X instanceof Error ? X.message : "更新失敗"));
        } finally {
          W(null);
        }
      },
      Wo = (T, X) => {
        q({ isOpen: !0, subContent: T, inspectionItem: X });
      },
      Vo = async () => {
        const { subContent: T } = L;
        if (T) {
          (U(T.GUID), x(null));
          try {
            const X = await ff(T.GUID, T.Master_GUID);
            X.Code === 200
              ? (console.log("✅ 刪除成功"),
                o && o(),
            ...
            (console.error("刪除失敗:", X),
              x(X instanceof Error ? X.message : "刪除失敗"));
          } finally {
            U(null);
          }
        }
      ...
      hn = async (T, X) => {
        ie(T);
        try {
          (console.log("=== 查看驗收單圖片 ==="), console.log("Item GUID:", T));
          const J = await hf(T);
          if ((console.log("API Response:", J), J.Code === 200 && J.Data)) {
            const te = J.Data;
            if ((console.log("Image Data:", te), te.base64)) {
              const we = te.base64.startsWith("data:")
                ? te.base64
                : `data:image/jpeg;base64,${te.base64}`;
              H({ isOpen: !0, imageUrl: we, title: `${X} - 驗收單圖片` });
            } else alert("此驗收單沒有相關圖片");
          } else alert("查無此驗收單的圖片資料");
        } catch (J) {
          (console.error("查看圖片失敗:", J),
            alert("查看圖片失敗，請稍後再試"));
        } finally {
          ie(null);
        }
      ...
      Un = async () => {
        ...
        try {
          ...
          const T = await dg(n);
          console.log("下載回應 Blob:", T);
          const X = `驗收明細_${f || "all"}_${C || "all"}.xlsx`,
          ...
          (console.error("下載失敗:", T),
            x(T instanceof Error ? T.message : "下載失敗"));
        } finally {
          Z(!1);
        }
      },
      Nr = ({ isOpen: T, onClose: X, imageUrl: J, title: te }) =>
        T
          ? s.jsx("div", {
              className:
                "fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[60]",
                        ...
                        s.jsxs("h3", {
                          ...
                          children: [
                            ...
                            s.jsx("button", {
                              ...
                              title: "設定查詢日期範圍",
                              children: s.jsx(rp, { className: "w-5 h-5" }),
                            }),
                          ],
                        }),
                        s.jsxs("p", {
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        ...
                        s.jsx("button", {
                          ...
                          className: `inline-flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors ${$ ? "bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`,
                          title: $
                            ? "批次鎖定/解鎖所有子明細"
                            : "需要管理員權限",
                          children: w
                            ...
                            children: [
                              ...
                              s.jsx("tbody", {
                                ...
                                children: n.map((T) => {
                                  var we;
                                  const X =
                                      ((we = T.Sub_content) == null
                                        ? void 0
                                        : we.reduce(
                                            (ee, zn) =>
                                              ee + (parseInt(zn.END_QTY) || 0),
                                            0,
                                          )) || 0,
                                    J = c.has(T.GUID),
                                    te =
                                      T.Sub_content && T.Sub_content.length > 0;
                                  return s.jsxs(s.Fragment, {
                                    children: [
                                      s.jsxs(
                                        "tr",
                                        {
                                          className: `hover:bg-gray-50 ${te ? "cursor-pointer" : ""}`,
                                          onClick: () => te && se(T.GUID),
                                          children: [
                                            s.jsx("td", {
                                              className:
                                            ...
                                            s.jsx("td", {
                                              className:
                                                "px-6 py-4 whitespace-nowrap",
                                              children: s.jsxs("div", {
                                                className: `text-sm flex items-center ${K(T.DELIVERY_TIME)}`,
                                                children: [
                                                  s.jsx(ds, {
                                                    className:
                                                      "w-4 h-4 mr-1 text-gray-400",
                                                                ...
                                                                s.jsx("div", {
                                                                  ...
                                                                  children:
                                                                    s.jsx(
                                                                      "span",
                                                                      {
                                                                        className: `inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${ee.STATE === "未鎖定" ? "bg-yellow-100 text-yellow-800" : "bg-green-100 text-green-800"}`,
                                                                        children:
                                                                          ee.STATE,
                                                                      },
                                                                    ),
  ...
  Eg = ({ isOpen: e, onClose: t, onDataUpdate: n }) => {
    const [r, o] = y.useState(null),
      ...
      g = y.useRef(null),
      m = () => {
        (o(null), c(null), h(null), g.current && (g.current.value = ""));
      },
      x = () => {
        (m(), t());
      },
      w = (S) => {
        var v;
        const d = (v = S.target.files) == null ? void 0 : v[0];
        if (!d) return;
        if (
          ![
            ...
            ".xls",
            ".xlsx",
          ].some((_) => d.type === _ || d.name.toLowerCase().endsWith(_))
        ) {
      ...
      j = async () => {
        ...
        try {
          ...
          (console.error("Excel upload error:", f),
            console.log("❌ Exception occurred during upload"),
            c(f instanceof Error ? f.message : "系統錯誤，請稍後再試"));
        } finally {
          i(!1);
        }
      };
  ...
  Dg = ({ isOpen: e, onClose: t, onDataUpdate: n }) => {
    ...
    const C = () => {
      ...
      F = async (P) => {
        (P.preventDefault(), i(!0), h(null), m(null));
        try {
          const R = await cg(
            x.pon,
            x.icSn,
          ...
          (console.error("手動建單失敗:", R),
            h(R instanceof Error ? R.message : "系統錯誤，請稍後再試"));
        } finally {
          i(!1);
        }
      };
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "text",
                            value: x.pon,
                            onChange: (P) => w({ ...x, pon: P.target.value }),
                            className:
                              "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                            required: !0,
                            placeholder: "請輸入請購單號",
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "text",
                            value: x.icSn,
                            onChange: (P) => w({ ...x, icSn: P.target.value }),
                            className:
                              "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                            placeholder: "請輸入驗收單號",
                          }),
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "text",
                            value: x.brd,
                            onChange: (P) => w({ ...x, brd: P.target.value }),
                            className:
                              "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                            placeholder: "請輸入廠牌",
                          }),
  ...
  Tg = ({ isOpen: e, onClose: t, onBarcodeDetected: n }) => {
    const r = y.useRef(null),
      ...
      [a, c] = y.useState(null),
      [u, h] = y.useState(!1),
      [g, m] = y.useState(window.innerWidth < 768),
      [x, w] = y.useState(null);
    y.useEffect(() => {
    ...
    const j = async (S) => {
      ...
      const d = S.currentTarget.getBoundingClientRect(),
        f = (S.clientX - d.left) / d.width,
        p = (S.clientY - d.top) / d.height;
      (w({ x: S.clientX - d.left, y: S.clientY - d.top }),
        setTimeout(() => w(null), 1e3));
      try {
        const v = i.current.getVideoTracks()[0],
          _ = v.getCapabilities();
        if ("focusMode" in _) {
          const C = { advanced: [{ focusMode: "single-shot" }] };
          await v.applyConstraints(C);
        }
        if ("pointsOfInterest" in _) {
          const C = { advanced: [{ pointsOfInterest: [{ x: f, y: p }] }] };
          await v.applyConstraints(C);
        }
      } catch (v) {
    ...
    return (
      y.useEffect(() => {
        ...
        const f = () => {
            (d && clearInterval(d),
              S &&
                (S.getTracks().forEach((_) => _.stop()), (i.current = null)));
          },
          p = async () => {
            var Q, D, F;
            ...
            ((C.width = _.videoWidth),
              (C.height = _.videoHeight),
              I.drawImage(_, 0, 0, C.width, C.height));
            const M = await new Promise((P) => C.toBlob(P, "image/jpeg", 0.8));
            if (M)
              try {
                const P = new FormData();
                P.append("file", M);
                const R = ip("barcode"),
                  B = await fetch(R, { method: "POST", body: P });
                if (!B.ok) throw new Error("API request failed");
                const W = await B.json(),
                  L =
                    (F =
                      (D =
                        (Q = W == null ? void 0 : W.results) == null
                          ? void 0
                          : Q[0]) == null
                        ? void 0
                        : D.code) == null
            ...
            ? (async () => {
                try {
                  ((S = await navigator.mediaDevices.getUserMedia({
                    ...
                    (i.current = S),
                    r.current && (r.current.srcObject = S),
                    h(!0),
                    (d = setInterval(p, 600)));
                } catch {
                  c("無法開啟相機，請確認已授權使用相機");
  ...
  Ig = ({ isOpen: e, onClose: t, barcode: n, onSuccess: r }) => {
    const [o, l] = y.useState([]),
      [i, a] = y.useState(!0),
      [c, u] = y.useState(!1),
      [h, g] = y.useState(null),
    ...
    y.useEffect(() => {
      const N = ($) => {
        (B.current && !B.current.contains($.target) && I(!1),
          W.current && !W.current.contains($.target) && Q(!1),
          L.current && !L.current.contains($.target) && F(!1),
          q.current && !q.current.contains($.target) && R(!1));
      };
      return (
    ...
    const U = async () => {
        ...
        try {
          ...
          (console.error("載入藥檔失敗:", N), g("載入藥檔失敗"));
        } finally {
          a(!1);
        }
      },
        ...
        () =>
          !o.length || !m
            ...
            : o.filter((N) => {
                ...
                return ($ = N.NAME) == null
                  ? void 0
                  : $.toLowerCase().includes(m.toLowerCase());
              }),
        [o, m],
      ),
      H = y.useMemo(
        () =>
          !o.length || !w
            ...
            : o.filter((N) => {
                var $;
                return ($ = N.CHT_NAME) == null
                  ? void 0
                  : $.toLowerCase().includes(w.toLowerCase());
              }),
        [o, w],
      ),
      G = y.useMemo(
      ...
      Z = async (N) => {
        ...
        (u(!0), g(null));
        try {
          const $ = o.find((oe) => oe.CODE === S),
            z = ($ == null ? void 0 : $.BARCODE) || [],
            K = [...new Set([...z, n])];
          (console.log("原本的條碼:", z),
            console.log("新條碼:", n),
            console.log("合併後的條碼:", K));
          const se = {
            Data: [{ BARCODE: K, CODE: S, BARCODE2: JSON.stringify(K) }],
          };
          console.log("建立條碼請求:", se);
          const ae = await Se("/api/med_page/add_med_clouds", {
            method: "POST",
            body: se,
          });
          (console.log("建立條碼回應:", ae),
            ae.Code === 200 ? (r(), t()) : g(ae.Result || "新增條碼失敗"));
        } catch ($) {
          (console.error("新增條碼失敗:", $), g("新增條碼失敗"));
        } finally {
          u(!1);
        }
      };
                                ...
                                children: [
                                  A.slice(0, 50).map((N, $) =>
                                    s.jsxs(
                                      ...
                                      {
                                        onClick: () => b(N),
                                        className: `px-4 py-2 cursor-pointer hover:bg-blue-50 border-b border-gray-100 last:border-b-0 ${(v == null ? void 0 : v.CODE) === N.CODE ? "bg-blue-50" : ""}`,
                                        children: [
                                          s.jsx("div", {
                                            className:
                                              "text-sm font-medium text-gray-900",
  ...
  Rg = (e = {}) => {
    ...
    y.useEffect(() => {
      ...
      return (
        (() => {
          try {
            (n && vn.connect(), t && (a = vn.onMessage(t)));
          } catch (u) {
  ...
  Pg = () => {
    ...
    const Ue = async (Y, re) => {
        (g(!0), x(null));
        try {
          const [ge, Re] = Y && re ? [Y, re] : Un,
            he = await tg(ge, Re);
          if ((console.log("Response Data:", he), he.Code === 200)) {
            a(he.Data);
            const Dt = Oc(he.Data, se);
            if ((u(Dt), w)) {
              const qe = Oc(he.Data, !0).find(
                (kr) => kr.CODE === w.CODE && kr.SKDIACODE === w.SKDIACODE,
              );
              qe && j(qe);
            }
          } else (x(he.Result || "查詢失敗"), a([]), u([]));
        } catch (ge) {
          (console.error("Failed to load inspections:", ge),
            x(ge instanceof Error ? ge.message : "系統錯誤，請稍後再試"),
            a([]),
            u([]));
        } finally {
          g(!1);
      ...
      mn = async () => {
        try {
          const re = new Date().toLocaleDateString("zh-TW", {
            ...
            [ge, Re, he] = re.split("/"),
            Dt = `${ge}-${Re.padStart(2, "0")}-${he.padStart(2, "0")} 00:00:00`,
            $n = `${ge}-${Re.padStart(2, "0")}-${he.padStart(2, "0")} 23:59:59`,
            qe = await Uc(Dt, $n);
          qe.Code === 200
            ? (R(qe.Data.length), F(qe.Data), W(qe.Data))
      ...
      Sr = async (Y, re) => {
        try {
          ...
          (console.error("Custom date range query error:", ge), W([]));
        }
      },
      T = async (Y) => {
        if (!Array.isArray(c) || c.length === 0) {
          (console.warn("驗收資料尚未載入完成，暫不執行條碼搜尋"),
            H([]),
            ie(!1));
          return;
        }
        ...
        try {
          ...
          if (
            ...
            const ge = re.Data.map((he) => (he == null ? void 0 : he.CODE))
              .filter(Boolean)
              ...
              const Dt =
                  typeof he.CODE == "string"
                    ? he.CODE.split(",")
                        ...
                        .filter(Boolean)
                    : [],
                $n = Array.isArray(he.items)
                  ? he.items
                      .map((At) => (At == null ? void 0 : At.CODE))
                      .filter(Boolean)
                  : [],
                qe = [...Dt].map((At) => String(At).toLowerCase()),
                kr = qe.some((At) => ge.includes(At));
              return (
          ...
          const re = c.filter((ge) =>
            ge.items.some((Re) => {
              ...
              return (
                ...
                ((Dt = Re.PON) == null
                  ? void 0
                  : Dt.toLowerCase().includes(Y.toLowerCase()))
              );
            }),
          );
          (console.log("篩選後的驗收資料:", re.length, "筆"),
    ...
    (y.useEffect(() => {
      ...
      y.useEffect(() => {
        hn.current &&
          c.length > 0 &&
          (console.log("驗收資料已載入完成，執行待處理的條碼搜尋:", hn.current),
          T(hn.current),
          (hn.current = null));
      }, [c]),
      y.useEffect(() => {
          ...
          Lc(L).then((Y) => {
            if (Y.Code === 200 && Y.Data && Y.Data.length > 0) {
              const re = Y.Data.map((Re) => Re.CODE).filter(Boolean),
                ge = c.filter((Re) => re.includes(Re.CODE));
              H(ge);
            } else H([]);
          });
        else if (z && b.trim() && c.length > 0) {
          const Y = c.filter((re) => {
            var ge, Re, he;
            return (
              re.CODE.includes(b) ||
              ((ge = re.NAME_CH) == null ? void 0 : ge.includes(b)) ||
              ((Re = re.NAME_E) == null ? void 0 : Re.includes(b)) ||
              ((he = re.KSKLOT) == null
                ? void 0
                : he.some((Dt) => {
                    var $n;
                    return ($n = Dt.KS_num) == null ? void 0 : $n.includes(b);
                  }))
            );
          });
          H(Y);
    ...
    return s.jsxs("div", {
      ...
      children: [
        s.jsx("main", {
          ...
          children: s.jsxs("div", {
            ...
            children: [
                    ...
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsxs("button", {
                          ...
                          children: [
                            s.jsx(Jm, { className: "w-4 h-4 mr-2" }),
                            e(`language.${t}`),
                          ],
                        }),
                        s.jsxs("button", {
              ...
              s.jsx(hg, { data: A, loading: h, onRowClick: j }),
            ],
          }),
        }),
        s.jsx("footer", {
        ...
        s.jsx(Tg, { isOpen: oe, onClose: () => Be(!1), onBarcodeDetected: ee }),
        s.jsx(Ig, {
          isOpen: wr,
          onClose: () => br(!1),
          barcode: Wo,
...
function Mg() {
  ...
  return !e || o
    ...
    : s.jsx(mp, { children: n ? s.jsx(Pg, {}) : s.jsx(pp, { onLogin: i }) });
}
Jd(document.getElementById("root")).render(
  s.jsx(y.StrictMode, { children: s.jsx(Mg, {}) }),
);
//# sourceMappingURL=index-D0pdyWBc.js.map
