...
O.StrictMode = id;
O.Suspense = dd;
O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = yd;
O.act = qo;
 ...
 */ (function (e) {
      ...
      e: for (var F = 0, j = I.length, A = j >>> 1; F < A; ) {
        ...
        if (0 > l(De, k))
          yt < j && 0 > l(Pn, De)
            ? ((I[F] = Pn), (I[yt] = k), (F = yt))
            : ((I[F] = De), (I[J] = k), (F = J));
        else if (yt < j && 0 > l(Pn, k)) (I[F] = Pn), (I[yt] = k), (F = yt);
        else break e;
      }
    }
    return R;
  ...
  function w(I) {
    if (((x = !1), p(I), !v))
      if (r(u) !== null) (v = !0), st(D);
      else {
        var R = r(c);
        R !== null && At(w, R.startTime - I);
      }
  }
  function D(I, R) {
      ...
      return (
        ...
        k > F
          ? ((I.sortIndex = k),
            ...
            r(u) === null &&
              I === r(c) &&
              (x ? (h(C), (C = -1)) : (x = !0), At(w, k - F)))
          : ((I.sortIndex = j), t(u, I), v || y || ((v = !0), st(D))),
        I
      );
    }),
...
var xt = Cd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
var yc = Ie.unstable_scheduleCallback,
  Oa = Ie.unstable_cancelCallback,
  Ud = Ie.unstable_shouldYield,
  Bd = Ie.unstable_requestPaint,
  ne = Ie.unstable_now,
  Hd = Ie.unstable_getCurrentPriorityLevel,
  Ui = Ie.unstable_ImmediatePriority,
  vc = Ie.unstable_UserBlockingPriority,
  fs = Ie.unstable_NormalPriority,
  Vd = Ie.unstable_LowPriority,
  wc = Ie.unstable_IdlePriority,
  Ms = null,
  tt = null;
function Qd(e) {
...
var qe = Math.clz32 ? Math.clz32 : Gd,
  Wd = Math.log,
  qd = Math.LN2;
function Gd(e) {
...
function Ar(e, t) {
  e.blockedOn === t &&
    ...
    Ql ||
      ((Ql = !0),
      Ie.unstable_scheduleCallback(Ie.unstable_NormalPriority, ef)));
}
function dn(e) {
  function t(l) {
    return Ar(l, e);
  ...
  for (; 0 < Nt.length && ((r = Nt[0]), r.blockedOn === null); )
    Dc(r), r.blockedOn === null && Nt.shift();
}
...
var Mr = {
  ...
  Ua = Le(Ls),
  sf = Z({}, Ls, { dataTransfer: 0 }),
  lf = Le(sf),
  af = Z({}, _n, { relatedTarget: 0 }),
  il = Le(af),
  of = Z({}, Mr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = Le(of),
  uf = Z({}, Mr, {
...
var xf = Z({}, _n, {
  ...
  jf = Le(wf),
  Nf = Z({}, Mr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  bf = Le(Nf),
  kf = Z({}, Ls, {
    deltaX: function (e) {
  ...
  Sf = Le(kf),
  Cf = [9, 13, 27, 32],
  Gi = dt && "CompositionEvent" in window,
  Xr = null;
dt && "documentMode" in document && (Xr = document.documentMode);
var Df = dt && "TextEvent" in window && !Xr,
  Tc = dt && (!Gi || (Xr && 8 < Xr && 11 >= Xr)),
  Va = " ",
  Qa = !1;
function zc(e, t) {
  switch (e) {
...
var Ye = typeof Object.is == "function" ? Object.is : Of;
function mn(e, t) {
  if (Ye(e, t)) return !0;
  ...
  for (s = 0; s < r.length; s++) {
    var l = r[s];
    if (!_l.call(t, l) || !Ye(e[l], t[l])) return !1;
  }
  return !0;
}
function Ya(e) {
...
var Ff = dt && "documentMode" in document && 11 >= document.documentMode,
  or = null,
  ql = null,
  Jr = null,
  Gl = !1;
...
Ot(Fc, "onAnimationEnd");
Ot(Ac, "onAnimationIteration");
Ot(Uc, "onAnimationStart");
Ot("dblclick", "onDoubleClick");
Ot("focusin", "onFocus");
Ot("focusout", "onBlur");
Ot(Bc, "onTransitionEnd");
      ...
      C &&
        (Tc &&
          ...
          (ar || C !== "onCompositionStart"
            ...
            : ((kt = d),
              (Qi = "value" in kt ? kt.value : kt.textContent),
              (ar = !0))),
        (E = hs(c, C)),
        0 < E.length &&
...
function so(e, t, r) {
  if (ge.current !== Lt) throw Error(_(168));
  V(ge, t), V(ke, r);
}
function Wc(e, t, r) {
  var s = e.stateNode;
...
function Ft() {
  if (!gl && it !== null) {
    ...
    try {
      ...
      throw (it !== null && (it = it.slice(e + 1)), yc(Ui, Ft), l);
    } finally {
      (B = t), (gl = !1);
    }
  }
...
function Gc(e, t, r) {
  ...
  if (30 < i) {
    ...
    (i = (s & ((1 << a) - 1)).toString(32)),
      (s >>= a),
      (l -= a),
      (at = (1 << (32 - qe(t) + l)) | (r << l) | s),
      (ot = i + e);
  } else (at = (1 << i) | (r << l) | s), (ot = e);
}
function Ki(e) {
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || r.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (ze = e), (Te = Et(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((r = Zt !== null ? { id: at, overflow: ot } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: r,
...
function Qn(e) {
  ...
  if (
    ...
    for (; t; ) Yc(e, t), (t = Et(t.nextSibling));
  }
  if ((ao(e), e.tag === 13)) {
  ...
  } else Te = ze ? Et(e.stateNode.nextSibling) : null;
  return !0;
}
function Kc() {
...
var Xf = xt.ReactCurrentBatchConfig;
function Br(e, t, r) {
  if (
...
function Xc(e) {
  ...
  function l(h, m) {
    return (h = Pt(h, m)), (h.index = 0), (h.sibling = null), h;
  }
  function i(h, m, p) {
    return (
      (h.index = p),
  ...
  function v(h, m, p, w) {
    ...
    if (C === p.length) return r(h, T), q && Ut(h, C), D;
    if (T === null) {
      for (; C < p.length; C++)
        (T = f(h, p[C], w)),
          T !== null &&
  ...
  function x(h, m, p, w) {
    ...
    if (S.done) return r(h, T), q && Ut(h, C), D;
    if (T === null) {
...
function sa(e, t) {
  switch ((V(yn, t), V(xn, e), V(rt, Tn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function yl(e) {
  ...
  if (((e = r.interleaved), e !== null)) {
    l = e;
    do (i = l.lane), (X.lanes |= i), (er |= i), (l = l.next);
    while (l !== e);
...
function nu(e, t) {
  var r = X,
    s = Be(),
    l = t(),
    i = !Ye(s.memoizedState, l);
  if (
    (i && ((s.memoizedState = l), (be = !0)),
    (s = s.queue),
...
function As(e, t, r, s) {
  ...
  (X.flags |= e), (l.memoizedState = jn(1 | t, r, i, s));
}
function mo(e, t) {
...
function hu(e, t, r) {
  return Jt & 21
    ? (Ye(r, t) || ((r = jc()), (X.lanes |= r), (er |= r), (e.baseState = !0)),
      t)
...
function tm(e, t, r) {
  ...
  if (yu(e)) vu(t, l);
    ...
    if (
      ...
      try {
        var a = t.lastRenderedState,
          o = i(a, r);
        if (((l.hasEagerState = !0), (l.eagerState = o), Ye(o, a))) {
          var u = t.interleaved;
          u === null
            ? ((l.next = l), ra(t))
    ...
    (r = Jc(e, t, l, s)),
      r !== null && ((l = xe()), Ge(r, e, s, l), wu(r, t, s));
  }
}
function yu(e) {
  var t = e.alternate;
...
function ju(e, t, r) {
  ...
  return (
    typeof i == "object" && i !== null
      ? (i = Ue(i))
      : ((l = Se(t) ? Xt : ge.current),
        (s = t.contextTypes),
        (i = (s = s != null) ? Cr(e, l) : Lt)),
    (t = new t(r, i)),
...
function li(e, t, r, s) {
  ...
  typeof i == "object" && i !== null
    ? (l.context = Ue(i))
    : ((i = Se(t) ? Xt : ge.current), (l.context = Cr(e, i))),
  ...
  return (
    ...
    e !== null && !be
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        pt(e, t, l))
      : (q && r && Ki(t), (t.flags |= 1), he(e, t, s, l), t.child)
  );
}
...
function ku(e, t, r, s, l) {
  if (e !== null) {
    ...
    if (mn(i, s) && e.ref === t.ref)
      if (((be = !1), (t.pendingProps = s = i), (e.lanes & l) !== 0))
        e.flags & 131072 && (be = !0);
  ...
  return (
    ...
    e !== null && !be
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        pt(e, t, l))
      : (q && s && Ki(t), (t.flags |= 1), he(e, t, r, l), t.child)
  );
}
function jo(e, t, r, s, l) {
  ...
  if ((jr(t, l), t.stateNode === null))
    ...
    (a = t.stateNode),
      eu(e, t),
      (o = t.memoizedProps),
      (c = t.type === t.elementType ? o : Ve(t.type, o)),
      (a.props = c),
      (f = t.pendingProps),
      (g = a.context),
      (u = r.contextType),
...
function oi(e, t, r, s, l, i) {
  Cu(e, t);
  var a = (t.flags & 128) !== 0;
  if (!s && !a) return l && lo(t, r, !1), pt(e, t, i);
...
function _u(e, t, r) {
  ...
  if (i) {
    ...
    return (
      ...
      o !== null ? (i = Pt(o, i)) : ((i = Gt(i, a, r, null)), (i.flags |= 2)),
      (i.return = t),
      (s.return = t),
      (s.sibling = i),
      (t.child = s),
  ...
  return (
    (i = e.child),
    (e = i.sibling),
    (s = Pt(i, { mode: "visible", children: s.children })),
    !(t.mode & 1) && (s.lanes = r),
    (s.return = t),
    (s.sibling = null),
    e !== null &&
  ...
  if (((o = (a & e.childLanes) !== 0), be || o)) {
    if (((s = oe), s !== null)) {
      ...
      (l = l & (s.suspendedLanes | a) ? 0 : l),
        l !== 0 &&
          l !== i.retryLane &&
          ((i.retryLane = l), mt(e, l), Ge(s, e, l, -1));
    }
  ...
  switch ((Xi(t), t.tag)) {
    ...
    case 5:
      ...
      if (((r = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Qt(rt.current)), Qn(t))) {
          (s = t.stateNode), (r = t.type);
          var i = t.memoizedProps;
          switch (((s[et] = t), (s[hn] = i), (e = (t.mode & 1) !== 0), r)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Iu(e, t, e.memoizedProps, s);
        ...
        if (((r = Qt(yn.current)), Qt(rt.current), Qn(t))) {
          if (
            ((s = t.stateNode),
            (r = t.memoizedProps),
            (s[et] = t),
            (i = s.nodeValue !== r) && ((e = ze), e !== null))
          )
            switch (e.tag) {
              case 3:
    ...
    case 13:
      if (
        ...
        if (q && Te !== null && t.mode & 1 && !(t.flags & 128))
          ...
          me(t), (i = !1);
        } else We !== null && (vi(We), (We = null)), (i = !0);
      ...
      return t.flags & 128
        ...
        : ((s = s !== null),
          s !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || G.current & 1 ? ie === 0 && (ie = 3) : ya())),
    ...
    case 17:
      return Se(t.type) && ys(), me(t), null;
    case 19:
      if ((W(G), (i = t.memoizedState), i === null)) return me(t), null;
...
function Pu(e) {
  ...
  t !== null && ((e.alternate = null), Pu(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[et], delete t[hn], delete t[Jl], delete t[Gf], delete t[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Lu(e, t, r) {
  ...
  switch (r.tag) {
    ...
    case 22:
      r.mode & 1
        ? ((pe = (s = pe) || r.memoizedState !== null), vt(e, t, r), (pe = s))
        : vt(e, t, r);
      break;
    default:
      vt(e, t, r);
...
function Ru(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      He(t, e), Ze(e), s & 512 && r !== null && gr(r, r.return);
      break;
    case 5:
      if (
        (He(t, e),
    ...
    case 3:
      if (
        (He(t, e), Ze(e), s & 4 && r !== null && r.memoizedState.isDehydrated)
      )
        try {
          dn(t.containerInfo);
        } catch (x) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((pe = (c = pe) || d), He(t, e), (pe = c)) : He(t, e),
        Ze(e),
        s & 8192)
      ) {
        if (
...
function Ge(e, t, r, s) {
  ...
  Dn(e, r, s),
    (!(U & 2) || e !== oe) &&
      (e === oe && (!(U & 2) && (Hs |= r), ie === 4 && bt(e, ue)),
      Ce(e, s),
      r === 1 && U === 0 && !(t.mode & 1) && ((zr = ne() + 500), Fs && Ft()));
}
function Ce(e, t) {
...
function $u(e, t) {
  ...
  if (s & 30 || s & e.expiredLanes || t) t = zs(e, s);
    ...
    U |= 2;
    var i = Au();
    (oe !== e || ue !== t) && ((lt = null), (zr = ne() + 500), qt(e, t));
    do
      try {
        xm();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((r = Nn), qt(e, 0), bt(e, s), Ce(e, ne()), r);
    if (t === 6) bt(e, s);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = s), t)) {
        ...
        case 3:
          if (
            (bt(e, s), (s & 130023424) === s && ((t = ga + 500 - ne()), 10 < t))
          ) {
            if (ms(e, 0) !== 0) break;
            ...
            e.timeoutHandle = Zl(Bt.bind(null, e, Ne, lt), t);
            break;
          }
          Bt(e, Ne, lt);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Zl(Bt.bind(null, e, Ne, lt), s);
            break;
          }
          Bt(e, Ne, lt);
          break;
  ...
  return Ce(e, ne()), e.callbackNode === r ? $u.bind(null, e) : null;
}
function yi(e, t) {
  var r = rn;
  return (
...
function To(e) {
  ...
  if (r === 1) throw ((r = Nn), qt(e, 0), bt(e, t), Ce(e, ne()), r);
...
function tr(e) {
  ...
  try {
    ...
    (B = s), (Ae.transition = r), (U = t), !(U & 6) && Ft();
  }
}
function xa() {
  (_e = hr.current), W(hr);
  ...
  do {
    ...
    try {
      if ((ea(), (ns.current = Ds), Cs)) {
        for (var s = X.memoizedState; s !== null; ) {
          var l = s.queue;
...
function ya() {
  (ie === 0 || ie === 3 || ie === 2) && (ie = 4),
    oe === null || (!(er & 268435455) && !(Hs & 268435455)) || bt(oe, ue);
}
function zs(e, t) {
  var r = U;
  U |= 2;
  var s = Au();
  (oe !== e || ue !== t) && ((lt = null), qt(e, t));
  do
    try {
      hm();
      break;
...
function Nr() {
  if (St !== null) {
    var e = Nc(Ts),
      ...
      r = B;
    try {
      if (((Ae.transition = null), (B = 16 > e ? 16 : e), St === null))
        var s = !1;
      else {
        if (((e = St), (St = null), (Ts = 0), U & 6)) throw Error(_(331));
        var l = U;
        ...
        if (
          ((U = l), Ft(), tt && typeof tt.onPostCommitFiberRoot == "function")
        )
          try {
...
function Hu(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var r = xe();
  (e = mt(e, t)), e !== null && (Dn(e, t, r), Ce(e, r));
}
function wm(e) {
  var t = e.memoizedState,
    r = 0;
...
Vu = function (e, t, r) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || ke.current) be = !0;
    else {
      if (!(e.lanes & r) && !(t.flags & 128)) return (be = !1), om(e, t, r);
      be = !!(e.flags & 131072);
    }
  else (be = !1), q && t.flags & 1048576 && Gc(t, js, t.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            li(t, s, e, r),
            (t = oi(null, t, s, !0, i, r)))
          : ((t.tag = 0), q && i && Ki(t), he(null, t, l, r), (t = t.child)),
        t
      );
    case 16:
      s = t.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        r !== 0 &&
          (Bi(t, r | 1), Ce(t, ne()), !(U & 6) && ((zr = ne() + 500), Ft()));
      }
      break;
    case 13:
      tr(function () {
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Kn.isDisabled && Kn.supportsFiber)
    try {
      (Ms = Kn.inject(Em)), (tt = Kn);
    } catch {}
}
Me.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = _m;
...
const rd = async () => {
  ...
  Am = async (e) =>
    await te("/api/session/login", { method: "POST", body: { Data: e } }),
  Um = (e) => (
  ...
  Vm = async () =>
    await te("/api/controlpanel/get_by_startendtime_bbs", {
      method: "POST",
      body: {},
    }),
  Qm = (e) =>
  ...
  Wm = async (e) => {
    await te("/api/controlpanel/add", { method: "POST", body: { Data: e } });
  },
  qm = async () =>
    await te("/api/controlpanel/get_bbs", { method: "POST", body: {} }),
  Gm = async (e) => {
    await te("/api/controlpanel/update", { method: "POST", body: { Data: e } });
  },
  Ym = async (e) => {
    await te("/api/controlpanel/delete", {
      method: "POST",
      body: { Data: { GUID: e } },
    });
  },
  ...
  Xm = (e) =>
    e
      ...
      : "medium",
  Xs = async () =>
    await te("/api/med_page/get_med_cloud", { method: "POST", body: {} }),
  Rt = (e) => {
  ...
  Zm = async () => {
    ...
    return await te("/api/drugStotreDistribution/get_by_addedTime", {
      method: "POST",
  ...
  Jm = async () => {
    const e = new Date(),
      ...
      r = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 23, 59, 59);
    return await te("/api/inspection/content_get_by_addTime", {
      method: "POST",
      body: { ValueAry: [Rt(t), Rt(r)] },
    });
  },
  ...
  t0 = async () =>
    await te("/api/controlpanel/get_by_startendtime_MedNotice", {
      method: "POST",
      body: {},
    }),
  r0 = async () =>
    await te("/api/controlpanel/get_MedNotice", { method: "POST", body: {} }),
  n0 = async (e) =>
    await te("/api/controlpanel/add", { method: "POST", body: { Data: e } }),
  s0 = async (e) =>
    await te("/api/controlpanel/update", { method: "POST", body: { Data: e } }),
  ...
  i0 = async () =>
    await te("/api/controlpanel/get_by_startendtime_out_of_stock", {
      method: "POST",
      body: {},
    }),
  a0 = async () =>
    await te("/api/controlpanel/get_out_of_stock", {
      method: "POST",
      body: {},
    }),
  o0 = async (e) =>
  ...
  g0 = async () =>
    await te("/api/medmap/get_stock", { method: "POST", body: {} }),
  h0 = (e) =>
    e.map((t) => {
      const r = t.qty || [],
  ...
  x0 = async () => {
    const e = new Date(),
      t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0),
      r = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 23, 59, 59);
    return await te("/api/materialRequisition/get_by_requestTime", {
      method: "POST",
      body: { ValueAry: [Rt(t), Rt(r)] },
    });
  },
          ...
          if (a && d && v.current) {
            ...
            if (E) {
              const T = E.getBoundingClientRect(),
                ...
                S = Math.round(w / (C + 16)),
                L = Math.round(D / (b + 16)),
                $ = Math.max(0, Math.min(8 - r.col, d.startCol + S)),
                re = Math.max(0, Math.min(6 - r.row, d.startRow + L));
              (re !== r.position.master_row || $ !== r.position.master_col) &&
                s(t, { master_row: re, master_col: $ });
            }
          }
          if (u && g && v.current) {
                ...
                children: [
                  ...
                  n.jsx("button", {
                    ...
                    children: i
                      ? n.jsxs(n.Fragment, {
                          children: [
                            n.jsx(K, { size: "small", className: "mr-2" }),
                            "新增中...",
                          ],
                        })
                      : n.jsxs(n.Fragment, {
          ...
          n.jsx("div", {
            ...
            children: n.jsxs("div", {
              ...
              children: [
                n.jsx(sn, {
                  size: 18,
                  className: `text-blue-600 mr-2 ${Y.large}`,
                }),
                n.jsx("h3", {
            ...
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsx(sn, {
                    size: 22,
                    className: `text-blue-600 mr-3 ${Y.large}`,
                  }),
                  n.jsx("h3", {
              ...
              n.jsxs("div", {
                ...
                children: [
                  n.jsxs("div", {
                    className: "flex items-center",
                    children: [
                      n.jsx(Ks, { size: 14, className: `mr-2 ${Y.small}` }),
                  ...
                  n.jsxs("div", {
                    className: "flex items-center",
                    children: [
                      n.jsx(zn, { size: 14, className: `mr-2 ${Y.small}` }),
    ...
    const [i, a] = N.useState("restock"),
      ...
      d = ({ task: v, taskType: x }) =>
        x === "restock" && "code" in v
          ...
          : null,
      f = [
        { key: "restock", label: "撥補", icon: Pe, tasks: e },
                  ...
                  children: c.map((x) => {
                    ...
                    return n.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          n.jsx(z, { size: 12, className: `mr-1 ${Y.small}` }),
                          x.label,
                          m > 0 &&
                            n.jsx("span", {
          ...
          n.jsx("div", {
            ...
            children: n.jsxs("div", {
              ...
              children: [
                n.jsx(Kt, {
                  size: 18,
                  className: `text-green-600 mr-2 ${Y.large}`,
                }),
                n.jsx("h3", {
                  className: `${P.subTitle} font-semibold text-gray-800`,
                  children: "未到貨監控",
            ...
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsx(Kt, {
                    size: 22,
                    className: `text-green-600 mr-3 ${Y.xlarge}`,
                  }),
                  n.jsx("h3", {
                  ...
                  n.jsxs("div", {
                    ...
                    children: [
                      a(o.expectedArrivalDate) &&
                        n.jsx(Xe, {
                          size: 16,
                          className: `text-red-500 ${Y.medium}`,
                        }),
                      n.jsx("span", {
                        className: `px-3 py-1 rounded-full ${
                          P.smallLabel
                    ...
                    children: [
                      n.jsxs("div", {
                        ...
                        children: [
                          n.jsx(Pe, {
                            size: 20,
                            className: `mr-3 ${Y.medium} text-gray-400`,
                          }),
                          n.jsxs("span", {
                            children: ["數量: ", o.quantityOrdered],
                          }),
                                      ...
                                      "tr",
                                      {
                                        ...
                                        children: [
                                          ...
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: st(k.start_time),
                                          }),
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: st(k.end_time),
                                          }),
                                        ],
                                      },
                                      k.GUID
              ...
              children: [
                n.jsxs("h3", {
                  ...
                  children: [
                    n.jsx(wi, {
                      size: 16,
                      className: `mr-2 text-red-500 ${Y.xlarge}`,
                    }),
                    "缺貨通知",
                  ],
                }),
    ...
    Ee.useEffect(() => {
      if (e) {
        const S = new Date(),
          ...
          $ = new Date(S);
        $.setMonth($.getMonth() + 1);
        const re = $.toISOString().slice(0, 16);
        l({ originalDrug: null, reason: "", start_time: L, end_time: re }),
          d(""),
          u([]),
          g(!1),
          m(null),
    ...
    const b = async () => {
      ...
      L = (j) => {
        const A = (J) => {
          if (!J) return "";
          try {
            const De = J.replace(/\//g, "-");
            return new Date(De).toISOString().slice(0, 16);
          } catch (De) {
            return console.error("Error formatting date for input:", J, De), "";
          }
        };
        d({
          GUID: j.GUID,
      ...
      $ = (j, A) => {
        ...
        const J = h.filter((De) =>
          De.NAME.toLowerCase().includes(j.toLowerCase())
        );
        w(J.slice(0, 10)), E(J.length > 0 ? A : null);
      },
      re = (j, A) => {
        if (c) {
                            ...
                            n.jsxs("div", {
                              ...
                              children: [
                                ...
                                n.jsx("input", {
                                  ...
                                  value: Re(c.content),
                                  onChange: (j) => {
                                    const A = `${j.target.value};${nt(
                                      c.content
                                    )}`;
                                    d({ ...c, content: A }),
                                      $(j.target.value, "original");
                                  },
                                  onFocus: () => {
                            ...
                            n.jsxs("div", {
                              ...
                              children: [
                                ...
                                n.jsx("input", {
                                  ...
                                  value: nt(c.content),
                                  onChange: (j) => {
                                    const A = `${Re(c.content)};${
                                      j.target.value
                                    }`;
                                    d({ ...c, content: A }),
                                      $(j.target.value, "replacement");
                                  },
                                  onFocus: () => {
            ...
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsx(br, {
                    size: 22,
                    className: `text-purple-600 mr-3 ${Y.xlarge}`,
                  }),
                  n.jsx("h3", {
                    className: `${P.subTitle} font-bold text-gray-800`,
                    children: "藥品通知",
                ...
                children: [
                  n.jsxs("div", {
                    ...
                    children: [
                      n.jsx(Yt, {
                        size: 14,
                        className: `mr-2 text-gray-400 ${Y.small}`,
                      }),
          ...
          children: n.jsxs("div", {
            ...
            children: [
              n.jsxs("div", {
                className: "flex items-center",
                children: [
                  n.jsx(Pe, { size: 20, className: "text-indigo-600 mr-2" }),
                  n.jsx("h3", {
                    className: "text-lg font-semibold text-gray-800",
                    children: "即時庫存重點",
                  }),
              ...
              children: [
                n.jsxs("h3", {
                  ...
                  children: [
                    n.jsx(Pe, {
                      size: 16,
                      className: `mr-2 text-indigo-600 ${Y.xlarge}`,
                    }),
                    "即時庫存重點",
                  ],
                }),
            ...
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsx(Yt, {
                    size: 18,
                    className: `text-teal-600 mr-2 ${Y.xlarge}`,
                  }),
                  n.jsx("h3", {
                    className: `${P.subTitle} font-semibold text-gray-800`,
                    children: "內部申請通知",
                  ...
                  children: [
                    n.jsxs("div", {
                      ...
                      children: [
                        n.jsx(ed, {
                          size: 24,
                          className: `text-blue-400 ${Y.xlarge}`,
                        }),
                        n.jsx("h1", {
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    ...
                    n.jsx("button", {
                      ...
                      title: "退出專注模式 (ESC)",
                      children: n.jsx(Ke, { size: 24, className: Y.xlarge }),
                    }),
                  ],
                }),
              ],
                      ...
                      children: [
                        l.bulletins &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.bulletins.position, {
                              row: o.bulletins.row,
                              col: o.bulletins.col,
                            }),
                            children: n.jsx(bi, {
                        ...
                        l.incomingDrugs &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.incomingDrugs.position, {
                        ...
                        l.outOfStock &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.outOfStock.position, {
                        ...
                        l.drugReplacements &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.drugReplacements.position, {
                        ...
                        l.inventory &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.inventory.position, {
                              row: o.inventory.row,
                              col: o.inventory.col,
                            }),
                            children: n.jsx(_i, {
                        ...
                        l.internalRequests &&
                          n.jsx(je, {
                            ...
                            onPositionChange: c,
                            onSizeChange: d,
                            gridArea: we(o.internalRequests.position, {
