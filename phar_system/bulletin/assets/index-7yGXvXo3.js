 ...
 */ (function (e) {
  ...
  function s(E) {
    ...
    if (C !== A) {
      E[0] = C;
      e: for (var $ = 0, S = E.length, V = S >>> 1; $ < V; ) {
        var te = 2 * ($ + 1) - 1,
          ze = E[te],
          xt = te + 1,
          Pn = E[xt];
        if (0 > l(ze, C))
          xt < S && 0 > l(Pn, ze)
            ? ((E[$] = Pn), (E[xt] = C), ($ = xt))
            : ((E[$] = ze), (E[te] = C), ($ = te));
        else if (xt < S && 0 > l(Pn, C)) (E[$] = Pn), (E[xt] = C), ($ = xt);
        else break e;
      }
    }
    return A;
  ...
  function l(E, A) {
    var C = E.sortIndex - A.sortIndex;
    return C !== 0 ? C : E.id - A.id;
  }
  ...
  function p(E) {
    for (var A = r(u); A !== null; ) {
      if (A.callback === null) s(u);
      else if (A.startTime <= E)
        s(u), (A.sortIndex = A.expirationTime), t(c, A);
      else break;
      A = r(u);
    }
  }
  function j(E) {
    if (((v = !1), p(E), !y))
      if (r(c) !== null) (y = !0), _(z);
        ...
        var A = r(u);
        A !== null && L(j, A.startTime - E);
      }
  }
  function z(E, A) {
    (y = !1), v && ((v = !1), g(D), (D = -1)), (x = !0);
    var C = h;
    try {
      for (
        p(A), f = r(c);
        f !== null && (!(f.expirationTime > A) || (E && !O()));

      ) {
        var $ = f.callback;
        if (typeof $ == "function") {
          (f.callback = null), (h = f.priorityLevel);
          var S = $(f.expirationTime <= A);
          (A = e.unstable_now()),
            typeof S == "function" ? (f.callback = S) : f === r(c) && s(c),
            p(A);
        } else s(c);
        f = r(c);
      }
      if (f !== null) var V = !0;
        ...
        var te = r(u);
        te !== null && L(j, te.startTime - A), (V = !1);
      }
      return V;
    } finally {
      (f = null), (h = C), (x = !1);
  ...
  (e.unstable_IdlePriority = 5),
    ...
    (e.unstable_scheduleCallback = function (E, A, C) {
      var $ = e.unstable_now();
      switch (
        ...
        C > $
          ? ((E.sortIndex = C),
            ...
            r(c) === null &&
              E === r(u) &&
              (v ? (g(D), (D = -1)) : (v = !0), L(j, C - $)))
          : ((E.sortIndex = S), t(c, E), y || x || ((y = !0), _(z))),
        E
      );
    }),
...
var gt = Cd.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function tc() {
  if (wr) {
    var e = wr,
      t = jr;
    if (((jr = wr = null), Ei(e), t)) for (e = 0; e < t.length; e++) Ei(t[e]);
  }
}
function rc(e, t) {
  return e(t);
...
function Ad(e, t, r, s, l, a, i, o, c) {
  (Jr = !1), (ds = null), Od.apply(Ld, arguments);
}
function Fd(e, t, r, s, l, a, i, o, c) {
  if ((Ad.apply(this, arguments), Jr)) {
    if (Jr) {
      var u = ds;
      (Jr = !1), (ds = null);
...
function Di(e) {
  if (lr(e) !== e) throw Error(I(188));
}
function $d(e) {
  var t = e.alternate;
  if (!t) {
    if (((t = lr(e)), t === null)) throw Error(I(188));
    return t !== e ? null : e;
  }
  for (var r = e, s = t; ; ) {
    var l = r.return;
...
var oc = Re.unstable_scheduleCallback,
  _i = Re.unstable_cancelCallback,
  Ud = Re.unstable_shouldYield,
  Vd = Re.unstable_requestPaint,
  se = Re.unstable_now,
  Hd = Re.unstable_getCurrentPriorityLevel,
  Pa = Re.unstable_ImmediatePriority,
  cc = Re.unstable_UserBlockingPriority,
  ms = Re.unstable_NormalPriority,
  Bd = Re.unstable_LowPriority,
  uc = Re.unstable_IdlePriority,
  Os = null,
  rt = null;
function qd(e) {
...
function ps(e, t) {
  ...
  if (i !== 0) {
    var o = i & ~l;
    o !== 0 ? (s = Kr(o)) : ((a &= i), a !== 0 && (s = Kr(a)));
  } else (i = r & ~l), i !== 0 ? (s = Kr(i)) : a !== 0 && (s = Kr(a));
  if (s === 0) return 0;
  if (
    t !== 0 &&
    t !== s &&
...
function Vr(e, t) {
  e.blockedOn === t &&
    ...
    Wl ||
      ((Wl = !0),
      Re.unstable_scheduleCallback(Re.unstable_NormalPriority, ef)));
}
function mn(e) {
  function t(l) {
    return Vr(l, e);
...
function Oa(e, t, r, s) {
  if (hs) {
    ...
    else if ((zi(e, s), t & 4 && -1 < Jd.indexOf(e))) {
      for (; l !== null; ) {
        var a = zn(l);
        if (
          (a !== null && mc(a),
...
var Rr = {
  ...
  Pi = Ae(Ls),
  sf = ee({}, Ls, { dataTransfer: 0 }),
  lf = Ae(sf),
  af = ee({}, _n, { relatedTarget: 0 }),
  ol = Ae(af),
  of = ee({}, Rr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = Ae(of),
  uf = ee({}, Rr, {
...
var xf = ee({}, _n, {
  ...
  jf = Ae(wf),
  Nf = ee({}, Rr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  bf = Ae(Nf),
  Sf = ee({}, Ls, {
    deltaX: function (e) {
...
var Ef = ut && "TextEvent" in window && !Zr,
  wc = ut && (!$a || (Zr && 8 < Zr && 11 >= Zr)),
  Oi = " ",
  Li = !1;
function jc(e, t) {
  switch (e) {
...
function _f(e, t) {
  if (cr)
    return e === "compositionend" || (!$a && jc(e, t))
...
for (var fl = 0; fl < Bi.length; fl++) {
  var ml = Bi[fl],
    $f = ml.toLowerCase(),
    Uf = ml[0].toUpperCase() + ml.slice(1);
  Lt($f, "on" + Uf);
}
...
var Yr =
  ...
  Vf = new Set("cancel close invalid load scroll toggle".split(" ").concat(Yr));
function qi(e, t, r) {
  ...
  if (!e[Hn]) {
    (e[Hn] = !0),
      Vo.forEach(function (r) {
        r !== "selectionchange" && (Vf.has(r) || pl(r, !1, e), pl(r, !0, e));
      });
  ...
  sc(function () {
    ...
    e: {
      ...
      if (h !== void 0) {
        ...
        for (var m = u, p; m !== null; ) {
          ...
          if (
            (p.tag === 5 &&
              j !== null &&
              ((p = j),
              g !== null && ((j = un(m, g)), j != null && v.push(xn(m, j, p)))),
            b)
          )
            break;
          m = m.return;
        ...
        0 < v.length &&
          ((h = new x(h, y, null, r, d)), f.push({ event: h, listeners: v }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (b = x == null ? h : fr(x)),
            (p = y == null ? h : fr(y)),
            (h = new v(j, m + "leave", x, r, d)),
            (h.target = b),
            (h.relatedTarget = p),
            (j = null),
            Bt(d) === u &&
              ((v = new v(g, m + "enter", y, r, d)),
              (v.target = p),
              (v.relatedTarget = b),
              (j = v)),
            (b = j),
            ...
            t: {
              for (v = x, g = y, m = 0, p = v; p; p = ar(p)) m++;
              for (p = 0, j = g; j; j = ar(j)) p++;
              for (; 0 < m - p; ) (v = ar(v)), m--;
              for (; 0 < p - m; ) (g = ar(g)), p--;
              for (; m--; ) {
      ...
      switch (((M = u ? fr(u) : window), e)) {
        case "focusin":
          (Ai(M) || M.contentEditable === "true") &&
            ((ur = M), (Kl = u), (tn = null));
          break;
        case "focusout":
          tn = Kl = ur = null;
      ...
      if ($a)
        ...
        cr
          ? jc(e, r) && (D = "onCompositionEnd")
          : e === "keydown" && r.keyCode === 229 && (D = "onCompositionStart");
      D &&
        (wc &&
          r.locale !== "ko" &&
          (cr || D !== "onCompositionStart"
            ? D === "onCompositionEnd" && cr && (T = vc())
            : ((St = d),
              (La = "value" in St ? St.value : St.textContent),
              (cr = !0))),
        (M = xs(u, D)),
        0 < M.length &&
          ((D = new Mi(D, e, null, r, d)),
          f.push({ event: D, listeners: M }),
          T ? (D.data = T) : ((T = Nc(r)), T !== null && (D.data = T)))),
        (T = Ef ? Df(e, r) : _f(e, r)) &&
...
function Bn(e, t, r) {
  if (((t = Wi(t)), Wi(e) !== t && r)) throw Error(I(425));
}
function ys() {}
var Xl = null,
  Jl = null;
...
var ea = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Qf =
    typeof queueMicrotask == "function"
      ...
      : typeof Gi < "u"
      ? function (e) {
          return Gi.resolve(null).then(e).catch(Wf);
        }
      : ea;
function Wf(e) {
  setTimeout(function () {
...
function Yi(e, t, r) {
  if (xe.current !== Rt) throw Error(I(168));
  W(xe, t), W(ke, r);
}
function Oc(e, t, r) {
  var s = e.stateNode;
  if (((t = t.childContextTypes), typeof s.getChildContext != "function"))
    return r;
  s = s.getChildContext();
  for (var l in s) if (!(l in t)) throw Error(I(108, Id(e) || "Unknown", l));
  return ee({}, r, s);
}
function ws(e) {
  return (
...
function Ha(e) {
  for (; e === js; )
    (js = pr[--hr]), (pr[hr] = null), (Ns = pr[--hr]), (pr[hr] = null);
  for (; e === Zt; )
    (Zt = Fe[--$e]),
      (Fe[$e] = null),
      (it = Fe[--$e]),
      ...
      return (
        (t =
          t.nodeType !== 1 || r.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (Me = e), (Pe = _t(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
...
function qn(e) {
  ...
  } else Pe = Me ? _t(e.stateNode.nextSibling) : null;
  return !0;
}
function $c() {
...
function Uc(e) {
  ...
  function l(g, m) {
    return (g = Pt(g, m)), (g.index = 0), (g.sibling = null), g;
  }
  function a(g, m, p) {
    return (
      (g.index = p),
  ...
  function o(g, m, p, j) {
    return m === null || m.tag !== 6
      ? ((m = Sl(p, g.mode, j)), (m.return = g), m)
      : ((m = l(m, p)), (m.return = g), m);
  }
  function c(g, m, p, j) {
    var z = p.type;
    return z === or
      ? d(g, m, p.props.children, j, p.key)
      : m !== null &&
        (m.elementType === z ||
          (typeof z == "object" &&
            z !== null &&
            z.$$typeof === wt &&
            eo(z) === m.type))
      ? ((j = l(m, p.props)), (j.ref = Br(g, m, p)), (j.return = g), j)
      : ((j = cs(p.type, p.key, p.props, null, g.mode, j)),
        (j.ref = Br(g, m, p)),
        (j.return = g),
        j);
  }
  function u(g, m, p, j) {
    return m === null ||
      ...
      ? ((m = kl(p, g.mode, j)), (m.return = g), m)
      : ((m = l(m, p.children || [])), (m.return = g), m);
  }
  function d(g, m, p, j, z) {
    return m === null || m.tag !== 7
      ? ((m = Kt(p, g.mode, j, z)), (m.return = g), m)
      : ((m = l(m, p)), (m.return = g), m);
  }
  function f(g, m, p) {
    if ((typeof m == "string" && m !== "") || typeof m == "number")
      return (m = Sl("" + m, g.mode, p)), (m.return = g), m;
    if (typeof m == "object" && m !== null) {
      switch (m.$$typeof) {
        case Rn:
          return (
            (p = cs(m.type, m.key, m.props, null, g.mode, p)),
            (p.ref = Br(g, null, m)),
            (p.return = g),
            p
          );
        case ir:
          return (m = kl(m, g.mode, p)), (m.return = g), m;
        case wt:
          var j = m._init;
          return f(g, j(m._payload), p);
      }
      if (Gr(m) || Fr(m))
        return (m = Kt(m, g.mode, p, null)), (m.return = g), m;
      Qn(g, m);
    }
    return null;
  }
  function h(g, m, p, j) {
    ...
    if ((typeof p == "string" && p !== "") || typeof p == "number")
      return z !== null ? null : o(g, m, "" + p, j);
    if (typeof p == "object" && p !== null) {
      switch (p.$$typeof) {
        case Rn:
          return p.key === z ? c(g, m, p, j) : null;
        case ir:
          return p.key === z ? u(g, m, p, j) : null;
        case wt:
          return (z = p._init), h(g, m, z(p._payload), j);
      }
      if (Gr(p) || Fr(p)) return z !== null ? null : d(g, m, p, j, null);
      Qn(g, p);
    }
    return null;
  }
  function x(g, m, p, j, z) {
    if ((typeof j == "string" && j !== "") || typeof j == "number")
      return (g = g.get(p) || null), o(m, g, "" + j, z);
    if (typeof j == "object" && j !== null) {
      switch (j.$$typeof) {
        case Rn:
          return (g = g.get(j.key === null ? p : j.key) || null), c(m, g, j, z);
        case ir:
          return (g = g.get(j.key === null ? p : j.key) || null), u(m, g, j, z);
        case wt:
          var M = j._init;
          return x(g, m, p, M(j._payload), z);
      }
      if (Gr(j) || Fr(j)) return (g = g.get(p) || null), d(m, g, j, z, null);
      Qn(m, j);
    }
    return null;
  }
  function y(g, m, p, j) {
    for (
      var z = null, M = null, T = m, D = (m = 0), N = null;
      T !== null && D < p.length;
      D++
    ) {
      T.index > D ? ((N = T), (T = null)) : (N = T.sibling);
      var k = h(g, T, p[D], j);
      if (k === null) {
        T === null && (T = N);
        break;
      }
      e && T && k.alternate === null && t(g, T),
        (m = a(k, m, D)),
        M === null ? (z = k) : (M.sibling = k),
        (M = k),
        (T = N);
    }
    if (D === p.length) return r(g, T), Y && Vt(g, D), z;
    if (T === null) {
      for (; D < p.length; D++)
        (T = f(g, p[D], j)),
          T !== null &&
            ((m = a(T, m, D)), M === null ? (z = T) : (M.sibling = T), (M = T));
      return Y && Vt(g, D), z;
    }
    for (T = s(g, T); D < p.length; D++)
      (N = x(T, g, D, p[D], j)),
        N !== null &&
          (e && N.alternate !== null && T.delete(N.key === null ? D : N.key),
          (m = a(N, m, D)),
          M === null ? (z = N) : (M.sibling = N),
          (M = N));
    return (
      e &&
  ...
  function v(g, m, p, j) {
    ...
    if (((p = z.call(p)), p == null)) throw Error(I(151));
    for (
      var M = (z = null), T = m, D = (m = 0), N = null, k = p.next();
      T !== null && !k.done;
      D++, k = p.next()
    ) {
      T.index > D ? ((N = T), (T = null)) : (N = T.sibling);
      var O = h(g, T, k.value, j);
      if (O === null) {
        T === null && (T = N);
        break;
      }
      e && T && O.alternate === null && t(g, T),
        (m = a(O, m, D)),
        M === null ? (z = O) : (M.sibling = O),
        (M = O),
        (T = N);
    }
    if (k.done) return r(g, T), Y && Vt(g, D), z;
    if (T === null) {
      for (; !k.done; D++, k = p.next())
        (k = f(g, k.value, j)),
          k !== null &&
            ((m = a(k, m, D)), M === null ? (z = k) : (M.sibling = k), (M = k));
      return Y && Vt(g, D), z;
    }
    for (T = s(g, T); !k.done; D++, k = p.next())
      (k = x(T, g, D, k.value, j)),
        k !== null &&
  ...
  function b(g, m, p, j) {
    if (
      ...
      switch (p.$$typeof) {
        case Rn:
          e: {
            for (var z = p.key, M = m; M !== null; ) {
              if (M.key === z) {
                if (((z = p.type), z === or)) {
                  if (M.tag === 7) {
                    r(g, M.sibling),
                      (m = l(M, p.props.children)),
                      (m.return = g),
                      (g = m);
                    break e;
                  }
            ...
            p.type === or
              ? ((m = Kt(p.props.children, g.mode, j, p.key)),
                (m.return = g),
                (g = m))
              : ((j = cs(p.type, p.key, p.props, null, g.mode, j)),
                (j.ref = Br(g, m, p)),
        ...
        case ir:
          e: {
            ...
            (m = kl(p, g.mode, j)), (m.return = g), (g = m);
          }
          return i(g);
        case wt:
          return (M = p._init), b(g, m, M(p._payload), j);
      }
      if (Gr(p)) return y(g, m, p, j);
      if (Fr(p)) return v(g, m, p, j);
      Qn(g, p);
    }
    return (typeof p == "string" && p !== "") || typeof p == "number"
      ? ((p = "" + p),
        m !== null && m.tag === 6
          ? (r(g, m.sibling), (m = l(m, p)), (m.return = g), (g = m))
          : (r(g, m), (m = Sl(p, g.mode, j)), (m.return = g), (g = m)),
        i(g))
      : r(g, m);
  }
  return b;
...
function ks(e, t, r, s) {
  ...
  if (a !== null) {
        ...
        e: {
          ...
          switch (((h = t), (x = r), v.tag)) {
            ...
            case 0:
              if (
                ((y = v.payload),
                (h = typeof y == "function" ? y.call(x, f, h) : y),
                h == null)
              )
                break e;
              f = ee({}, f, h);
    ...
    (tr |= i), (e.lanes = i), (e.memoizedState = f);
  }
}
function ro(e, t, r) {
...
var Tn = {},
  ...
  wn = At(Tn);
function Qt(e) {
  if (e === Tn) throw Error(I(174));
  return e;
}
function Ya(e, t) {
  switch ((W(wn, t), W(vn, e), W(nt, Tn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function ei(e, t, r, s, l, a) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (ss.current = e === null || e.memoizedState === null ? rm : nm),
    (e = r(s, l)),
    rn)
  ) {
    a = 0;
    do {
      if (((rn = !1), (jn = 0), 25 <= a)) throw Error(I(301));
      (a += 1),
        (ce = ie = null),
        (t.updateQueue = null),
        (ss.current = sm),
...
function wl(e) {
  ...
  if (((e = r.interleaved), e !== null)) {
    l = e;
    do (a = l.lane), (Z.lanes |= a), (tr |= a), (l = l.next);
    while (l !== e);
...
function Wc(e, t) {
  ...
  if (
    (a && ((s.memoizedState = l), (Se = !0)),
    (s = s.queue),
    ri(Yc.bind(null, r, s, e), [e]),
    s.getSnapshot !== t || a || (ce !== null && ce.memoizedState.tag & 1))
  ) {
    if (
      ((r.flags |= 2048),
      bn(9, Kc.bind(null, r, s, l, t), void 0, null),
      ue === null)
    )
      throw Error(I(349));
    er & 30 || Gc(r, t, l);
...
function Vs(e, t, r, s) {
  ...
  (Z.flags |= e), (l.memoizedState = bn(1 | t, r, a, s));
}
function so(e, t) {
...
function au(e, t, r) {
  return er & 21
    ? (Je(r, t) || ((r = dc()), (Z.lanes |= r), (tr |= r), (e.baseState = !0)),
      t)
    : (e.baseState && ((e.baseState = !1), (Se = !0)), (e.memoizedState = r));
}
function Zf(e, t) {
  var r = Q;
  (Q = r !== 0 && 4 > r ? r : 4), e(!0);
...
function tm(e, t, r) {
  ...
  if (ou(e)) cu(t, l);
    ...
    (r = Hc(e, t, l, s)),
      r !== null && ((l = we()), Xe(r, e, s, l), uu(r, t, s));
  }
}
function ou(e) {
  var t = e.alternate;
...
var Ds = {
  ...
  rm = {
    ...
    useSyncExternalStore: function (e, t, r) {
      ...
      return (
        (l.queue = a),
        so(Yc.bind(null, s, a, e), [e]),
        (s.flags |= 2048),
        bn(9, Kc.bind(null, s, a, r, t), void 0, null),
        r
      );
    },
    useId: function () {
...
function ia(e, t, r, s) {
  ...
  typeof a == "object" && a !== null
    ? (l.context = He(a))
    : ((a = Ce(t) ? Jt : xe.current), (l.context = Er(e, a))),
  ...
  return (
    ...
    e !== null && !Se
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        mt(e, t, l))
      : (Y && r && Va(t), (t.flags |= 1), ye(e, t, s, l), t.child)
  );
}
...
function pu(e, t, r, s, l) {
  if (e !== null) {
    ...
    if (hn(a, s) && e.ref === t.ref)
      if (((Se = !1), (t.pendingProps = s = a), (e.lanes & l) !== 0))
        e.flags & 131072 && (Se = !0);
  ...
  return (
    ...
    e !== null && !Se
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        mt(e, t, l))
      : (Y && s && Va(t), (t.flags |= 1), ye(e, t, r, l), t.child)
  );
}
...
function po(e, t, r, s, l) {
  return Dr(), Ba(l), (t.flags |= 256), ye(e, t, r, s), t.child;
}
...
function im(e, t, r, s, l, a, i) {
  if (r)
    return t.flags & 256
      ? ((t.flags &= -257), (s = Nl(Error(I(422)))), Wn(e, t, i, s))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (s = o), (a = Error(I(419))), (s = Nl(a, s, void 0)), Wn(e, t, i, s);
  }
  if (((o = (i & e.childLanes) !== 0), Se || o)) {
    if (((s = ue), s !== null)) {
      switch (i & -i) {
        case 4:
          l = 2;
    ...
    return ui(), (s = Nl(Error(I(421)))), Wn(e, t, i, s);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function vu(e, t, r) {
  var s = t.pendingProps,
    l = s.revealOrder,
    a = s.tail;
  if ((ye(e, t, s.children, r), (s = X.current), s & 2))
    (s = (s & 1) | 2), (t.flags |= 128);
  else {
  ...
  if ((W(X, s), !(t.mode & 1))) t.memoizedState = null;
  else
    switch (l) {
      case "forwards":
  ...
  switch ((Ha(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (qn(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Ke !== null && (ja(Ke), (Ke = null)))),
        ma(e, t),
        he(t),
        null
      );
      ...
      if (((r = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Qt(nt.current)), qn(t))) {
          ...
          switch (((s[tt] = t), (s[yn] = a), (e = (t.mode & 1) !== 0), r)) {
            ...
            case "video":
            case "audio":
              for (l = 0; l < Yr.length; l++) G(Yr[l], s);
              break;
            case "source":
              G("error", s);
              break;
    ...
    case 6:
      if (e && t.stateNode != null) Nu(e, t, e.memoizedProps, s);
        ...
        if (((r = Qt(wn.current)), Qt(nt.current), qn(t))) {
          if (
            ((s = t.stateNode),
            (r = t.memoizedProps),
            (s[tt] = t),
    ...
    case 13:
      if (
        ...
        if (Y && Pe !== null && t.mode & 1 && !(t.flags & 128))
          ...
          he(t), (a = !1);
        } else Ke !== null && (ja(Ke), (Ke = null)), (a = !0);
      ...
      return t.flags & 128
        ...
        : ((s = s !== null),
          s !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || X.current & 1 ? oe === 0 && (oe = 3) : ui())),
          t.updateQueue !== null && (t.flags |= 4),
          he(t),
          null);
    case 4:
      return (
        zr(), ma(e, t), e === null && gn(t.stateNode.containerInfo), he(t), null
      );
    case 10:
      return Wa(t.type._context), he(t), null;
    case 17:
      return Ce(t.type) && vs(), he(t), null;
    case 19:
      if ((K(X), (a = t.memoizedState), a === null)) return he(t), null;
...
function fm(e, t) {
  ...
  for (Jl = { focusedElem: e, selectionRange: r }, hs = !1, R = t; R !== null; )
...
function bu(e) {
  ...
  t !== null && ((e.alternate = null), bu(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[tt], delete t[yn], delete t[ta], delete t[Gf], delete t[Kf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function ku(e, t, r) {
  ...
  switch (r.tag) {
    ...
    case 22:
      r.mode & 1
        ? ((ge = (s = ge) || r.memoizedState !== null), yt(e, t, r), (ge = s))
        : yt(e, t, r);
      break;
    default:
      yt(e, t, r);
...
function Eu(e, t, r) {
  for (var s = (e.mode & 1) !== 0; R !== null; ) {
    ...
    if (l.tag === 22 && s) {
      ...
      if (!i) {
        var o = l.alternate,
          c = (o !== null && o.memoizedState !== null) || ge;
        o = Gn;
        var u = ge;
        if (((Gn = i), (ge = c) && !u))
          for (R = l; R !== null; )
            (i = R),
              ...
              i.tag === 22 && i.memoizedState !== null
                ...
                ? ((c.return = i), (R = c))
                : jo(l);
        for (; a !== null; ) (R = a), Eu(a), (a = a.sibling);
        (R = l), (Gn = o), (ge = u);
      }
      vo(e);
    } else
      l.subtreeFlags & 8772 && a !== null ? ((a.return = l), (R = a)) : vo(e);
  }
}
function vo(e) {
  for (; R !== null; ) {
...
function Xe(e, t, r, s) {
  if (50 < ln) throw ((ln = 0), (va = null), Error(I(185)));
  Dn(e, r, s),
    (!(H & 2) || e !== ue) &&
      (e === ue && (!(H & 2) && (qs |= r), oe === 4 && bt(e, fe)),
      Ee(e, s),
      r === 1 && H === 0 && !(t.mode & 1) && ((Ir = se() + 500), Us && Ft()));
}
function Ee(e, t) {
  var r = e.callbackNode;
  Yd(e, t);
  var s = ps(e, e === ue ? fe : 0);
  if (s === 0)
...
function Du(e, t) {
  if (((is = -1), (os = 0), H & 6)) throw Error(I(327));
  var r = e.callbackNode;
  ...
  if (s & 30 || s & e.expiredLanes || t) t = Is(e, s);
    ...
    H |= 2;
    var a = zu();
    (ue !== e || fe !== t) && ((st = null), (Ir = se() + 500), Gt(e, t));
    do
      try {
        xm();
        break;
    ...
    Qa(),
      (_s.current = a),
      (H = l),
      le !== null ? (t = 0) : ((ue = null), (fe = 0), (t = oe));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = Ql(e)), l !== 0 && ((s = l), (t = wa(e, l)))), t === 1)
    )
      throw ((r = Sn), Gt(e, 0), bt(e, s), Ee(e, se()), r);
    if (t === 6) bt(e, s);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = s), t)) {
        ...
        case 3:
          if (
            (bt(e, s), (s & 130023424) === s && ((t = ii + 500 - se()), 10 < t))
          ) {
            if (ps(e, 0) !== 0) break;
            ...
            e.timeoutHandle = ea(Ht.bind(null, e, be, st), t);
            break;
          }
          Ht(e, be, st);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = ea(Ht.bind(null, e, be, st), s);
            break;
          }
          Ht(e, be, st);
          break;
  ...
  return Ee(e, se()), e.callbackNode === r ? Du.bind(null, e) : null;
}
function wa(e, t) {
  var r = sn;
  return (
...
function No(e) {
  ...
  Sr();
  var t = ps(e, 0);
  if (!(t & 1)) return Ee(e, se()), null;
  var r = Is(e, t);
  if (e.tag !== 0 && r === 2) {
    var s = Ql(e);
    s !== 0 && ((t = s), (r = wa(e, s)));
  }
  if (r === 1) throw ((r = Sn), Gt(e, 0), bt(e, t), Ee(e, se()), r);
...
function oi(e, t) {
  ...
  try {
    ...
    (H = r), H === 0 && ((Ir = se() + 500), Us && Ft());
  }
}
function rr(e) {
  kt !== null && kt.tag === 0 && !(H & 6) && Sr();
  var t = H;
  H |= 1;
  var r = Ve.transition,
    s = Q;
  try {
    ...
    (Q = s), (Ve.transition = r), (H = t), !(H & 6) && Ft();
  }
}
function ci() {
  (Te = yr.current), K(yr);
...
function Gt(e, t) {
  ...
  if ((r !== -1 && ((e.timeoutHandle = -1), qf(r)), le !== null))
...
function ui() {
  (oe === 0 || oe === 3 || oe === 2) && (oe = 4),
    ue === null || (!(tr & 268435455) && !(qs & 268435455)) || bt(ue, fe);
}
function Is(e, t) {
  var r = H;
  H |= 2;
  var s = zu();
  (ue !== e || fe !== t) && ((st = null), Gt(e, t));
  do
    try {
      gm();
      break;
  ...
  while (!0);
  if ((Qa(), (H = r), (_s.current = s), le !== null)) throw Error(I(261));
...
function Sr() {
  if (kt !== null) {
    var e = fc(Ts),
      ...
      r = Q;
    try {
      if (((Ve.transition = null), (Q = 16 > e ? 16 : e), kt === null))
        var s = !1;
      else {
        if (((e = kt), (kt = null), (Ts = 0), H & 6)) throw Error(I(331));
        var l = H;
        for (H |= 4, R = e.current; R !== null; ) {
          ...
          if (a.subtreeFlags & 2064 && i !== null) (i.return = a), (R = i);
          else
            e: for (; R !== null; ) {
              if (((a = R), a.flags & 2048))
                switch (a.tag) {
        ...
        if (
          ((H = l), Ft(), rt && typeof rt.onPostCommitFiberRoot == "function")
        )
          try {
...
function vm(e, t, r) {
  ...
  s !== null && s.delete(t),
    ...
    ue === e &&
      (fe & r) === r &&
      (oe === 4 || (oe === 3 && (fe & 130023424) === fe && 500 > se() - ii)
        ? Gt(e, 0)
        : (ai |= r)),
    Ee(e, t);
}
function Pu(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var r = we();
  (e = ft(e, t)), e !== null && (Dn(e, t, r), Ee(e, r));
}
function wm(e) {
  var t = e.memoizedState,
    r = 0;
...
Mu = function (e, t, r) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || ke.current) Se = !0;
      ...
      if (!(e.lanes & r) && !(t.flags & 128)) return (Se = !1), om(e, t, r);
      Se = !!(e.flags & 131072);
    }
  else (Se = !1), Y && t.flags & 1048576 && Ac(t, Ns, t.index);
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            ia(t, s, e, r),
            (t = ua(null, t, s, !0, a, r)))
          : ((t.tag = 0), Y && a && Va(t), ye(null, t, l, r), (t = t.child)),
        t
      );
    case 16:
      s = t.elementType;
    ...
    case 3:
      e: {
        if ((xu(t), e === null)) throw Error(I(387));
        (s = t.pendingProps),
          (a = t.memoizedState),
          (l = a.element),
          Bc(e, t),
        ...
        if (((s = i.element), a.isDehydrated))
          if (
            ...
            (l = Tr(Error(I(423)), t)), (t = po(e, t, s, r, l));
            break e;
          } else if (s !== l) {
            (l = Tr(Error(I(424)), t)), (t = po(e, t, s, r, l));
            break e;
          } else
            for (
    ...
    case 4:
      return (
        Ya(t, t.stateNode.containerInfo),
        (s = t.pendingProps),
        e === null ? (t.child = _r(t, null, s, r)) : ye(e, t, s, r),
        t.child
      );
    case 11:
      return (
          ...
          if (Je(a.value, i)) {
            ...
            for (a = t.child, a !== null && (a.return = t); a !== null; ) {
              ...
              if (o !== null) {
                ...
                if (((i = a.return), i === null)) throw Error(I(341));
                (i.lanes |= r),
                  (o = i.alternate),
                  o !== null && (o.lanes |= r),
                  la(i, r, t),
...
function Ou(e) {
  ...
  e = e._reactInternals;
  e: {
    if (lr(e) !== e || e.tag !== 1) throw Error(I(170));
    var t = e;
    do {
      switch (t.tag) {
        case 3:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        r !== 0 &&
          (Ma(t, r | 1), Ee(t, se()), !(H & 6) && ((Ir = se() + 500), Ft()));
      }
      break;
    case 13:
      rr(function () {
...
rc = oi;
nc = rr;
var Dm = { usingClientEntryPoint: !1, Events: [zn, fr, $s, ec, tc, oi] },
  Qr = {
  ...
  _m = {
    ...
    findFiberByHostInstance: Qr.findFiberByHostInstance || Cm,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Yn.isDisabled && Yn.supportsFiber)
    try {
      (Os = Yn.inject(_m)), (rt = Yn);
    } catch {}
}
Le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Dm;
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Xn = B("Check", [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const kn = B("ChevronDown", [
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */ const Am = B("SplitSquareHorizontal", [
...
const Gu = async () => {
      ...
      t.forEach((s, l) => {
        ...
        s.forEach((h) => {
          const x = h.serverName || "未知伺服器",
            ...
            v = h.lot || [],
            b = h.expiry_date || [];
          i.push(...v), o.push(...b), c.push(...y);
          const g = y.reduce((p, j) => p + (Number(j) || 0), 0),
            m = u.get(x) || 0;
          u.set(x, m + g);
        });
        const d = c.reduce((h, x) => h + (Number(x) || 0), 0),
          f = Array.from(u.entries()).map(([h, x]) => ({
            serverName: h,
            qty: x,
          }));
        r.push({
      ...
      b = w.useCallback(
        (p) => {
          p.preventDefault(),
            p.stopPropagation(),
            u(!0),
            x({ x: p.clientX, y: p.clientY, startRow: r.row, startCol: r.col });
        },
        [r.row, r.col]
      ),
      g = w.useCallback(
        (p) => {
          if (i && d && y.current) {
            const j = p.clientX - d.x,
              z = p.clientY - d.y,
              M = y.current.parentElement;
            if (M) {
              const T = M.getBoundingClientRect(),
                ...
                k = Math.round(j / (D + 16)),
                O = Math.round(z / (N + 16)),
                F = Math.max(0, Math.min(8 - r.col, d.startCol + k)),
                q = Math.max(0, Math.min(6 - r.row, d.startRow + O));
              (q !== r.position.master_row || F !== r.position.master_col) &&
                s(t, { master_row: q, master_col: F });
            }
          }
          if (c && h && y.current) {
            const j = p.clientX - h.x,
              z = p.clientY - h.y,
              M = y.current.parentElement;
            if (M) {
              const T = M.getBoundingClientRect(),
                ...
                F = Math.max(
                  1,
                  Math.min(8 - r.position.master_col, h.startCol + k)
                ),
                q = Math.max(
                  1,
                  Math.min(6 - r.position.master_row, h.startRow + O)
                );
              (q !== r.row || F !== r.col) && l(t, { row: q, col: F });
            }
          }
        },
        [i, c, d, h, r, s, l, t]
  ...
  P0 = ({ isOpen: e, onClose: t, onSuccess: r }) => {
    ...
    Ie.useEffect(() => {
      if (e) {
        ...
        const b = v.toISOString().slice(0, 16);
        l({
          title: "",
          content: "",
          priority: "Normal",
        ...
        try {
          const v = (g) => g.replace("T", " ") + ":00",
            b = {
              ...
              creator_name: y.Name || "",
              start_time: v(s.start_time),
              end_time: v(s.end_time),
            };
          await Km(b), r(), t();
        } catch (v) {
          c(v instanceof Error ? v.message : "新增公告失敗，請稍後再試");
        } finally {
          i(!1);
        }
      },
                ...
                children: [
                  ...
                  n.jsx("button", {
                    ...
                    children: a
                      ? n.jsxs(n.Fragment, {
                          children: [
                            n.jsx(J, { size: "small", className: "mr-2" }),
                            "新增中...",
                          ],
                        })
                      : n.jsxs(n.Fragment, {
  ...
  M0 = ({ isOpen: e, onClose: t, onSuccess: r }) => {
    ...
    const g = async () => {
        ...
        try {
          const N = await Ym();
          if (N.Code === 200) l(N.Data || []);
          else throw new Error(N.Result || "載入歷史公告失敗");
        } catch (N) {
          c(N instanceof Error ? N.message : "載入歷史公告時發生錯誤");
        } finally {
          i(!1);
        }
      },
      m = (N) => {
        const k = (O) => {
          ...
          try {
            ...
            return console.error("Error formatting date for input:", O, F), "";
          }
        };
        d({
          GUID: N.GUID,
          ...
          creator_dept: N.creator_dept || "",
          creator_name: N.creator_name || "",
          start_time: k(N.start_time),
          end_time: k(N.end_time),
          ...
          try {
            const N = (O) =>
              ...
              k = {
                ...
                start_time: N(u.start_time),
                end_time: N(u.end_time),
              };
            await Xm(k), await g(), d(null), r && r();
          } catch (N) {
            c(N instanceof Error ? N.message : "更新公告失敗，請稍後再試");
          } finally {
            h(!1);
          }
        }
      ...
      j = async () => {
        if (u) {
          ...
          try {
            ...
            c(N instanceof Error ? N.message : "刪除公告失敗，請稍後再試");
          } finally {
            b(!1);
          }
        }
      ...
      z = (N) => {
        ...
        try {
          const k = N.replace(/\//g, "-");
          return new Date(k).toLocaleString("zh-TW", {
            year: "numeric",
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
                                      ...
                                      "tr",
                                      {
                                        ...
                                        children: [
                                          ...
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: z(N.start_time),
                                          }),
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: z(N.end_time),
                                          }),
                                        ],
                                      },
                                      N.GUID
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("button", {
                          onClick: p,
                          disabled:
                            f || v || !u.title.trim() || !u.content.trim(),
                          className:
  ...
  R0 = ({
    ...
    return n.jsxs(n.Fragment, {
      children: [
        ...
        n.jsx(P0, { isOpen: l, onClose: () => a(!1), onSuccess: f }),
        n.jsx(M0, { isOpen: i, onClose: () => o(!1), onSuccess: h }),
      ],
    });
  },
  O0 = ({ bulletins: e }) => {
    ...
    a != null && a.hasError
      ? t
        ? n.jsx("div", {
            ...
            children: n.jsx(_e, { message: a.message || "資料載入失敗" }),
          })
        : n.jsx(_e, { message: a.message || "資料載入失敗" })
      : t
    ...
    const [a, i] = w.useState("restock"),
      ...
      d = ({ task: y, taskType: v }) =>
        v === "restock" && "code" in y
          ...
          : (v === "receiving" || v === "putaway") && "code" in y
          ? n.jsx("div", {
              className:
          ...
          : null,
      f = [
        { key: "restock", label: "撥補", icon: De, tasks: e },
        { key: "receiving", label: "驗收", icon: Xt, tasks: t },
        { key: "putaway", label: "歸貨", icon: Uu, tasks: r },
      ],
      h = ((x = f.find((y) => y.key === a)) == null ? void 0 : x.tasks) || [];
    return (
      h.filter((y) =>
                ...
                children: f.map((y) => {
                  ...
                  return n.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        n.jsx(v, { size: 16, className: "mr-2" }),
                        y.label,
                        g > 0 &&
                          n.jsx("span", {
            ...
            children: n.jsx("div", {
              ...
              children:
                h.length === 0
                  ...
                  : h.map((y) => n.jsx(d, { task: y, taskType: a }, y.id)),
            }),
          }),
          n.jsx(gi, {
            isOpen: o,
  ...
  A0 = ({ restockTasks: e, receivingTasks: t, putAwayTasks: r }) => {
    ...
    const [s, l] = w.useState("restock"),
      [a, i] = w.useState(0),
      c = (() => {
        const b = localStorage.getItem("focusTable_tasks_itemsPerPage");
        return b ? parseInt(b, 10) : 5;
      })(),
      u = e.filter((b) => b.state === "等待過帳"),
      d = [
        { key: "restock", label: "撥補", icon: De, tasks: u },
        { key: "receiving", label: "驗收", icon: Xt, tasks: t },
        { key: "putaway", label: "歸貨", icon: Uu, tasks: r },
      ],
      f = ((v = d.find((b) => b.key === s)) == null ? void 0 : v.tasks) || [];
    w.useEffect(() => {
      const b = setInterval(() => {
        l((g) => {
          const p = (d.findIndex((j) => j.key === g) + 1) % d.length;
          return d[p].key;
        }),
          i(0);
      }, 12e3);
      ...
      f.filter((b) =>
        "state" in b
          ? b.state === "等待過帳"
          : "quantity" in b && b.quantity > 0
      ).length,
      f.filter((b) => ("state" in b ? b.state === "已簽收" : !1)).length;
    const h = f.slice(a, a + c),
      x = Math.ceil(f.length / c),
      y = Math.floor(a / c) + 1;
    return n.jsxs("div", {
      className:
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("div", {
                    ...
                    children: Array.from({ length: x }, (b, g) =>
                      n.jsx(
                        "div",
                        {
              ...
              : n.jsx("div", {
                  ...
                  children: n.jsxs("table", {
                    ...
                    children: [
                      ...
                      n.jsx("tbody", {
                        children: h.map((b, g) => {
                          if (s === "restock" && "code" in b && "state" in b) {
                            const m = (j) => {
                                switch (j) {
                                  case "等待過帳":
                              ...
                              p =
                                (b.state === "已過帳" ||
                                  b.state === "已簽收") &&
                                b.actualIssuedQuantity
                                  ? b.actualIssuedQuantity
                                  : b.issuedQuantity;
                            return n.jsxs(
                              "tr",
                              {
                                className: `border-b border-gray-200 transition-colors ${m(
                                  b.state
                                )}`,
                                children: [
                                  n.jsx("td", {
  ...
  Yu = ({
    ...
    i != null && i.hasError
      ? s
        ? n.jsx("div", {
            className: "bg-gray-800 rounded-lg p-6 h-full",
            children: n.jsx(_e, { message: i.message || "資料載入失敗" }),
          })
        : n.jsx(_e, { message: i.message || "資料載入失敗" })
      : s
  ...
  Xu = ({
    ...
    l != null && l.hasError
      ? t
        ? n.jsx("div", {
            className: "bg-gray-800 rounded-lg p-6 h-full",
            children: n.jsx(_e, { message: l.message || "資料載入失敗" }),
          })
        : n.jsx(_e, { message: l.message || "資料載入失敗" })
      : t
  ...
  U0 = ({ isOpen: e, onClose: t, onSuccess: r }) => {
    ...
    Ie.useEffect(() => {
      if (e) {
        const D = new Date(),
          N = D.toISOString().slice(0, 16),
          k = new Date(D);
        k.setMonth(k.getMonth() + 1);
        const O = k.toISOString().slice(0, 16);
        l({ drugName: "", start_time: N, end_time: O }),
          c([]),
          d(!1),
          b(null),
          g();
    ...
    const g = async () => {
      ...
      p = (D) => {
        ...
        const N = a.filter((k) =>
          k.NAME.toLowerCase().includes(D.toLowerCase())
        );
        c(N.slice(0, 10)), d(N.length > 0);
      },
      j = (D) => {
        l((N) => ({ ...N, drugName: D })), d(!1), c([]);
      },
      z = () => {
      ...
      M = async () => {
        ...
        y(!0);
        try {
          const k = (F) => F.replace("T", " ") + ":00",
            O = {
              title: "缺貨通知",
              content: s.drugName.trim(),
              priority: "Critical",
              creator_dept: N.Employer || "",
              creator_name: N.Name || "",
              start_time: k(s.start_time),
              end_time: k(s.end_time),
            };
          await d0(O), r(), t();
        } catch (k) {
          b(k instanceof Error ? k.message : "新增缺貨項目失敗，請稍後再試");
        } finally {
          y(!1);
        }
      },
                      ...
                      n.jsxs("div", {
                        ...
                        children: [
                          ...
                          n.jsx("input", {
                            type: "text",
                            value: s.drugName,
                            onChange: (D) => m("drugName", D.target.value),
                            onFocus: () => {
                              o.length > 0 && d(!0);
                            },
                            disabled: x || f,
                      ...
                      n.jsxs("div", {
                        children: [
                          ...
                          n.jsx("input", {
                            type: "datetime-local",
                            value: s.start_time,
                            onChange: (D) => m("start_time", D.target.value),
                            disabled: x,
                            className:
                              "w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                          }),
                      ...
                      n.jsxs("div", {
                        children: [
                          ...
                          n.jsx("input", {
                            type: "datetime-local",
                            value: s.end_time,
                            onChange: (D) => m("end_time", D.target.value),
                            disabled: x,
                            className:
                              "w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                          }),
  ...
  V0 = ({ isOpen: e, onClose: t, onSuccess: r }) => {
    ...
    const N = async () => {
      ...
      O = (C) => {
        const $ = (S) => {
          ...
          try {
            ...
            return console.error("Error formatting date for input:", S, V), "";
          }
        };
        d({
          GUID: C.GUID,
      ...
      F = (C) => {
        ...
        j($.slice(0, 10)), M($.length > 0);
      },
      q = (C) => {
        u && d({ ...u, content: C }), M(!1), j([]);
      },
      ae = async () => {
        if (u) {
          h(!0), c(null);
      ...
      P = async () => {
        if (u) {
          b(!0), c(null), y(!1);
          try {
            await m0(u.GUID), await N(), d(null), r && r();
          } catch (C) {
                                      ...
                                      "tr",
                                      {
                                        ...
                                        children: [
                                          ...
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: _(C.start_time),
                                          }),
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: _(C.end_time),
                                          }),
                                        ],
                                      },
                                      C.GUID
  ...
  H0 = ({
    ...
    const [l, a] = Ie.useState(!1),
      ...
      x = (g) => {
        ...
        const p = new Date(),
          j = new Date(m.getFullYear(), m.getMonth(), m.getDate()),
          z = new Date(p.getFullYear(), p.getMonth(), p.getDate()),
          M = z.getTime() - j.getTime(),
          T = Math.floor(M / (1e3 * 60 * 60 * 24));
        return (
    ...
    return n.jsxs(n.Fragment, {
      children: [
              ...
              children: n.jsx("div", {
                ...
                children:
                  e.length === 0
                    ...
                    : e.map((g) => {
                        const m = x(g.lastStockDate),
                          p = m > 3 || g.status === "urgent_order";
                        return n.jsxs(
                          "div",
                          {
                            className: `p-3 border rounded-lg transition-colors ${
        ...
        n.jsx(V0, { isOpen: i, onClose: () => o(!1), onSuccess: b }),
        n.jsx(gi, {
          isOpen: d,
          onClose: () => f(!1),
              ...
              : n.jsx("div", {
                  ...
                  children: n.jsxs("table", {
                    ...
                    children: [
                      ...
                      n.jsx("tbody", {
                        children: i.map((u, d) => {
                          const f = a(u.lastStockDate),
                            h = f > 3 || u.status === "urgent_order";
                          return n.jsxs(
                            "tr",
                            {
  ...
  q0 = ({ isOpen: e, onClose: t, onSuccess: r }) => {
    ...
    Ie.useEffect(() => {
      if (e) {
        const k = new Date(),
          O = k.toISOString().slice(0, 16),
          F = new Date(k);
        F.setMonth(F.getMonth() + 1);
        const q = F.toISOString().slice(0, 16);
        l({ originalDrug: null, reason: "", start_time: O, end_time: q }),
          d(""),
          c([]),
          h(!1),
          m(null),
        ...
        const O = k.toLowerCase(),
          F = a.filter((q) => {
            const ae = (q.NAME || "").toLowerCase(),
              P = (q.CODE || "").toLowerCase(),
              _ = (q.SKDIACODE || "").toLowerCase(),
              L = (q.CHT_NAME || "").toLowerCase();
            return (
              ae.includes(O) || P.includes(O) || _.includes(O) || L.includes(O)
            );
          });
        c(F.slice(0, 10)), h(F.length > 0);
      },
      M = (k) => {
        l((O) => ({ ...O, originalDrug: k })), d(k.NAME), h(!1), c([]);
      },
      T = () => {
        ...
        if (!s.start_time) return "請選擇開始時間";
        if (!s.end_time) return "請選擇結束時間";
        const k = new Date(s.start_time);
        return new Date(s.end_time) <= k ? "結束時間必須晚於開始時間" : null;
      },
      D = async () => {
        m(null);
        const k = T();
        ...
        try {
          ...
          m(
            F instanceof Error ? F.message : "新增藥品通知項目失敗，請稍後再試"
          );
        } finally {
          b(!1);
        }
            ...
            children: [
                ...
                children: [
                                ...
                                children: [
                                  ...
                                  n.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      k.SKDIACODE &&
                                        n.jsxs("div", {
                                          children: ["料號: ", k.SKDIACODE],
                                        }),
                                      k.CHT_NAME &&
                                        n.jsxs("div", {
                                          children: ["中文名: ", k.CHT_NAME],
                                        }),
                                    ],
                                  }),
                                ],
                  ...
                  n.jsxs("div", {
                    children: [
                      ...
                      n.jsx("textarea", {
                        value: s.reason,
                        onChange: (k) => j("reason", k.target.value),
                        disabled: v,
                        rows: 4,
                        className:
                          "w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-vertical disabled:opacity-50 disabled:bg-gray-100",
                      ...
                      n.jsxs("div", {
                        children: [
                          ...
                          n.jsx("input", {
                            type: "datetime-local",
                            value: s.start_time,
                            onChange: (k) => j("start_time", k.target.value),
                            disabled: v,
                            className:
                              "w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                          }),
                      ...
                      n.jsxs("div", {
                        children: [
                          ...
                          n.jsx("input", {
                            type: "datetime-local",
                            value: s.end_time,
                            onChange: (k) => j("end_time", k.target.value),
                            disabled: v,
                            className:
                              "w-full px-3 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                          }),
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("button", {
                    onClick: D,
                    disabled: v || !s.originalDrug || !s.reason.trim(),
                    className:
                      "flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
                    children: v
                      ? n.jsxs(n.Fragment, {
    ...
    const N = async () => {
      ...
      O = (S) => {
        const V = (te) => {
          if (!te) return "";
          try {
            const ze = te.replace(/\//g, "-");
            return new Date(ze).toISOString().slice(0, 16);
          } catch (ze) {
            return (
              console.error("Error formatting date for input:", te, ze), ""
            );
          }
        };
        d({
      ...
      F = (S, V) => {
        ...
        const te = g.filter((ze) =>
          ze.NAME.toLowerCase().includes(S.toLowerCase())
        );
        j(te.slice(0, 10)), M(te.length > 0 ? V : null);
      },
      q = (S, V) => {
        if (u) {
          const te = u.content.split(";");
          let ze = "";
          V === "original"
            ? (ze = `${S};${te[1] || ""}`)
            : (ze = `${te[0] || ""};${S}`),
      ...
      ae = (S) => {
        var V;
        return ((V = S.split(";")[0]) == null ? void 0 : V.trim()) || "";
      },
      P = (S) => {
        var V;
        return ((V = S.split(";")[1]) == null ? void 0 : V.trim()) || "";
      },
      _ = async () => {
        if (u) {
          h(!0), c(null);
      ...
      L = async () => {
        if (u) {
          b(!0), c(null), y(!1);
          try {
            await o0(u.GUID), await N(), d(null), r && r();
          } catch (S) {
            c(
              S instanceof Error
                ? S.message
                                      ...
                                      "tr",
                                      {
                                        ...
                                        children: [
                                          ...
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: E(S.start_time),
                                          }),
                                          n.jsx("td", {
                                            className:
                                              "px-6 py-4 whitespace-nowrap text-sm text-gray-900",
                                            children: E(S.end_time),
                                          }),
                                        ],
                                      },
                                      S.GUID
                            ...
                            n.jsxs("div", {
                              ...
                              children: [
                                ...
                                n.jsx("input", {
                                  ...
                                  value: ae(u.content),
                                  onChange: (S) => {
                                    const V = `${S.target.value};${P(
                                      u.content
                                    )}`;
                                    d({ ...u, content: V }),
                                      F(S.target.value, "original");
                                  },
                                  onFocus: () => {
                                    p.length > 0 && M("original");
                                  },
                                  disabled: f || T,
                                  className:
                                    "w-full pl-10 pr-10 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                            ...
                            n.jsxs("div", {
                              ...
                              children: [
                                ...
                                n.jsx("input", {
                                  ...
                                  value: P(u.content),
                                  onChange: (S) => {
                                    const V = `${ae(u.content)};${
                                      S.target.value
                                    }`;
                                    d({ ...u, content: V }),
                                      F(S.target.value, "replacement");
                                  },
                                  onFocus: () => {
                                    p.length > 0 && M("replacement");
                                  },
                                  disabled: f || T,
                                  className:
                                    "w-full pl-10 pr-10 py-2 border rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors disabled:opacity-50 disabled:bg-gray-100",
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("button", {
                          onClick: _,
                          disabled:
                            f || v || !u.content.trim() || !u.note.trim(),
                          className:
                            "flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
                          children:
                            f || v
  ...
  W0 = ({
    ...
    return n.jsxs(n.Fragment, {
      children: [
        ...
        n.jsx(q0, { isOpen: l, onClose: () => a(!1), onSuccess: d }),
          ...
          children: n.jsxs("div", {
            ...
            children: [
              n.jsxs("div", {
                className: "flex items-center",
                children: [
                  n.jsx(De, { size: 20, className: "text-blue-600 mr-2" }),
                  n.jsx("h3", {
                    className: "text-lg font-semibold text-gray-800",
                    children: "即時庫存重點",
                  }),
  ...
  Y0 = ({ inventoryHighlights: e }) => {
    ...
    const a = e.slice(t, t + l),
      ...
      o = Math.floor(t / l) + 1,
      c = Array.from(
        new Set(e.flatMap((f) => (f.serverData || []).map((h) => h.serverName)))
      ).sort(),
      u = 40,
              ...
              children: [
                n.jsxs("h3", {
                  className:
                    "text-xl font-semibold text-gray-800 flex items-center",
                  children: [
                    n.jsx(De, { size: 20, className: "mr-2 text-blue-600" }),
                    "即時庫存重點",
                  ],
                }),
                n.jsxs("div", {
...
const ve = new X0(),
  J0 = ({ isOpen: e, onClose: t }) => {
    const [r, s] = w.useState(ve.getSelectedSound()),
      [l, a] = w.useState(ve.getRepeatCount()),
      [i, o] = w.useState(ve.getRepeatInterval()),
      [c, u] = w.useState(ve.getVolume()),
      [d, f] = w.useState(() => {
        const p = localStorage.getItem("internalRequests_displayMode");
        return p || "all";
      }),
      h = [
      ...
      y = (p) => {
        s(p), ve.setSelectedSound(p);
      },
      v = (p) => {
        a(p), ve.setRepeatCount(p);
      },
      b = (p) => {
        o(p), ve.setRepeatInterval(p);
      },
      g = (p) => {
        u(p), ve.setVolume(p);
      },
      m = (p) => {
        f(p),
          localStorage.setItem("internalRequests_displayMode", p),
          window.dispatchEvent(
            new CustomEvent("internalRequestsSettingChanged", {
              detail: { displayMode: p },
            })
          );
      };
    return e
                          ...
                          n.jsxs("div", {
                            children: [
                              ...
                              n.jsx("input", {
                                ...
                                step: "0.01",
                                value: c,
                                onChange: (p) => g(parseFloat(p.target.value)),
                                className:
                          ...
                          n.jsxs("div", {
                            children: [
                              ...
                              n.jsx("input", {
                                ...
                                step: "1",
                                value: l,
                                onChange: (p) => v(parseInt(p.target.value)),
                                className:
                                  "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-teal-600",
                              }),
                              n.jsxs("div", {
  ...
  Z0 = ({ internalRequests: e, showInFocus: t = !0, onFocusToggle: r }) => {
    const [s, l] = w.useState(ve.getStatus()),
      [a, i] = w.useState(!1),
      o = w.useRef(new Set()),
      c = w.useRef(!0);
    w.useEffect(() => {
      const x = new Set();
      e.forEach((v) => {
        v.state === "等待過帳" && v.actionType === "緊急申領" && x.add(v.id);
      }),
        Array.from(x).some((v) => !o.current.has(v)) &&
          !c.current &&
          (console.log("======= 檢測到新的緊急申領，準備播放音效 ======="),
          console.log("當前緊急申領 IDs:", Array.from(x)),
          console.log("之前緊急申領 IDs:", Array.from(o.current)),
          (async () => {
            try {
              await ve.playNotification(),
                console.log("======= 音效播放完成 =======");
            } catch (v) {
              console.error("======= 音效播放失敗 =======", v);
            }
          })()),
        c.current &&
          e.length > 0 &&
          (console.log("======= 初始載入完成，開始監控緊急申領 ======="),
          (c.current = !1)),
        (o.current = x);
    }, [e]);
    const u = () => {
      ...
      f = (x) => {
        try {
          return new Date(x.replace(/\//g, "-")).toLocaleString("zh-TW", {
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
            minute: "2-digit",
      ...
      h = [...e].sort((x, y) => {
        ...
        if (b !== g) return b - g;
        try {
          const m = new Date(x.requestTime.replace(/\//g, "-")).getTime();
          return new Date(y.requestTime.replace(/\//g, "-")).getTime() - m;
        } catch {
          return 0;
        }
      });
          ...
          children: n.jsxs("div", {
            ...
            children: [
              ...
              n.jsxs("span", {
                className: "text-sm text-gray-500",
                children: [
                  e.filter((x) => x.state === "等待過帳").length,
                  " 項待處理",
                ],
              }),
            ],
          ...
          children: n.jsx("div", {
            ...
            children:
              h.length === 0
                ...
                : h.map(
                    (x) => (
                      x.state === "等待過帳" && x.actionType,
                      n.jsxs(
                        "div",
                        {
                          className: `p-3 border-2 rounded-lg transition-colors ${d(
                            x.state,
                            x.actionType
                          )}`,
                          children: [
  ...
  ep = ({ internalRequests: e, gridHeight: t = 2 }) => {
    ...
    w.useEffect(() => {
      try {
        ...
        const _ = Array.from(P).filter((E) => !x.current.has(E)),
          L = _.length > 0;
        if (
          (console.log(
          ...
          console.log("[InternalRequestsCarousel] Has new urgent request:", L),
          console.log("[InternalRequestsCarousel] Is initial load:", y.current),
          L && !y.current)
        ) {
          console.log(
            ...
            console.log(
              ...
              Array.from(x.current)
            ),
            console.log("[InternalRequestsCarousel] 新增的緊急申領 IDs:", _),
            console.log("[InternalRequestsCarousel] 當前顯示模式:", f),
            f === "all"
              ? (console.log(
              ...
              : f === "urgentOnly" &&
                ...
                a(0));
          const E = Date.now();
          console.log("[InternalRequestsCarousel] 重置輪播計時器，時間戳:", E),
            b(E),
            (async () => {
              try {
                await ve.playNotification(),
          ...
          y.current
            ? console.log("[InternalRequestsCarousel] 初始載入中，跳過音效通知")
            : L ||
              console.log(
                "[InternalRequestsCarousel] 無新的緊急申領，跳過音效通知"
              );
        y.current &&
          e.length > 0 &&
          (console.log(
            "======= [InternalRequestsCarousel] 初始載入完成，開始監控緊急申領 ======="
          ),
          (y.current = !1)),
          (x.current = new Set(P));
      } catch (P) {
      ...
      w.useEffect(() => {
        const P = (_) => {
          var E;
          const L = _;
          ((E = L.detail) == null ? void 0 : E.displayMode) !== void 0 &&
            h(L.detail.displayMode);
        };
        return (
          window.addEventListener("internalRequestsSettingChanged", P),
          () => window.removeEventListener("internalRequestsSettingChanged", P)
        );
      }, []);
    const g = e.filter((P) => P.actionType === "緊急申領").length,
      m = e.filter((P) => P.actionType !== "緊急申領").length,
      p = e.length;
    w.useEffect(() => {
      if (f === "separate") {
        const P = [];
        ...
        return () => P.forEach((_) => clearInterval(_));
      } else {
        const P = f === "urgentOnly" ? g : p;
        if (P > c) {
          const _ = setInterval(() => {
            s((L) => {
              const E = L + c;
    ...
    const j = () => {
      ...
      M = (P, _) => {
        if (P === "等待過帳" && _ === "緊急申領") return "text-gray-800";
        switch (P) {
          case "等待過帳":
      ...
      T = (P) => {
        try {
          return new Date(P.replace(/\//g, "-")).toLocaleString("zh-TW", {
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
            minute: "2-digit",
      ...
      D = (P, _) => {
        const L = P.state === "等待過帳" && P.actionType === "緊急申領";
        return n.jsx("div", {
          className: "h-full flex flex-col",
          children: n.jsxs("div", {
            className: `flex-1 p-3 border-2 rounded-lg transition-all flex flex-col ${z(
              P.state,
              P.actionType
            )}`,
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsxs("div", {
                    ...
                    children: [
                      n.jsx("h4", {
                        className: `font-semibold text-lg ${M(
                          P.state,
                          P.actionType
                      ...
                      n.jsx("div", {
                        className: `text-sm ${M(P.state, P.actionType)}`,
                        children: P.code,
                      }),
                    ],
                  }),
              ...
              n.jsxs("div", {
                className: `grid grid-cols-2 gap-1 text-base ${M(
                  P.state,
                  P.actionType
                )} flex-1 min-h-0`,
                children: [
      ...
      N = e.filter((P) => P.actionType === "緊急申領"),
      k = e.filter((P) => P.actionType !== "緊急申領");
    if (f === "urgentOnly" ? N.length === 0 : e.length === 0)
      return n.jsxs("div", {
        className:
          "bg-white rounded-lg shadow-sm border border-gray-200 h-full flex flex-col",
        children: [
    ...
    const F = [...e].sort((P, _) => {
      if (P.state === "等待過帳" && P.actionType === "緊急申領") return -1;
      if (_.state === "等待過帳" && _.actionType === "緊急申領") return 1;
      const L = { 等待過帳: 0, 已過帳: 1, 已簽收: 2 },
        E = L[P.state],
        A = L[_.state];
      if (E !== A) return E - A;
      try {
        const C = new Date(P.requestTime.replace(/\//g, "-")).getTime();
        return new Date(_.requestTime.replace(/\//g, "-")).getTime() - C;
      } catch {
        return 0;
      }
    });
    if (f === "separate") {
      const P = N.slice(l, l + c),
        _ = k.slice(i, i + c);
      return n.jsxs("div", {
        className:
              ...
              children: [
                ...
                n.jsx("div", {
                  ...
                  children: n.jsxs("span", {
                    className: "text-sm text-gray-500 font-medium",
                    children: [
                      e.filter((L) => L.state === "等待過帳").length,
                      " 項待處理",
                    ],
                  }),
                }),
                    ...
                    children:
                      N.length === 0
                        ...
                        : P.map((L, E) =>
                            n.jsx(
                              "div",
                              { className: "flex-1 min-h-0", children: D(L) },
                              L.id
                            )
                          ),
                  }),
    ...
    const q =
        f === "urgentOnly" ? F.filter((P) => P.actionType === "緊急申領") : F,
      ae = q.slice(r, r + c);
    return n.jsxs("div", {
      className:
        "bg-white rounded-lg shadow-sm border border-gray-200 h-full flex flex-col min-h-0 max-h-full",
      children: [
        ...
        n.jsx("div", {
          ...
          children: ae.map((P) =>
            n.jsx("div", { className: "flex-1 min-h-0", children: D(P) }, P.id)
          ),
        }),
      ],
    });
          ...
          children: [
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    ...
                    n.jsx("button", {
                      ...
                      title: "退出專注模式 (ESC)",
                      children: n.jsx(Oe, { size: 24, className: Eo.xlarge }),
                    }),
                  ],
                }),
              ],
            ...
            n.jsx("div", {
              ...
              children: n.jsx("div", {
                ...
                children: Object.entries(l).some(([f, h]) => h)
                  ? n.jsxs(n.Fragment, {
                      children: [
                        l.bulletins &&
                          n.jsx(Ut, {
  ...
  lp = () => {
    ...
    const t = rd(),
      ...
      [h, x] = w.useState(!1),
      [y, v] = w.useState(() => {
        const _ = localStorage.getItem("dashboard_refresh_interval");
        return _ ? parseInt(_, 10) : 20;
      }),
      [b, g] = w.useState({
        bulletins: !0,
        tasks: !0,
      ...
      m = In(),
      p = m ? `${m.Name} - ${m.Employer}` : "鴻森智能科技 - 臨床藥事科",
        ...
        try {
          ...
          Array.isArray(_.bulletins) ||
            ...
            console.log("[PrescriptionQueryPage] Dashboard data loaded:", {
              bulletins: _.bulletins.length,
              internalRequests: _.internalRequests.length,
              urgentRequests: _.internalRequests.filter(
                (L) => L.state === "等待過帳" && L.actionType === "緊急申領"
              ).length,
            }),
            s(_),
            u(new Date());
        } catch (_) {
          const L = _ instanceof Error ? _.message : "載入資料失敗，請稍後再試";
          throw (
            (o(L),
            console.error(
    ...
    rp({ intervalMs: y * 1e3, onPoll: j, enabled: !0 }),
      w.useEffect(() => {
        console.log(
      ...
      w.useEffect(() => {
        (async () => {
          try {
            const L = D0();
            g(L), await Gu(), await j();
          } catch (L) {
            console.error("Failed to initialize:", L),
              o("初始化失敗，請重新整理頁面");
          }
        })();
      }, [j]);
    const z = () => {
      ...
      D = (_) => {
        v(_),
          localStorage.setItem("dashboard_refresh_interval", _.toString()),
          console.log(
                    ...
                    children: [
                      n.jsx("div", {
                        ...
                        children: n.jsx(Ku, {
                          bulletins: r.bulletins,
                          onBulletinAdded: M,
                          showInFocus: b.bulletins,
                          onFocusToggle: (_) => T("bulletins", _),
                          error: (N = r.errors) == null ? void 0 : N.bulletins,
                        }),
                      }),
                      n.jsx("div", {
                        ...
                        children: n.jsx(Yu, {
                          ...
                          putAwayTasks: r.putAwayTasks,
                          showInFocus: b.tasks,
                          onFocusToggle: (_) => T("tasks", _),
                          error: (k = r.errors) == null ? void 0 : k.tasks,
                        }),
                      }),
                      n.jsx("div", {
                        children: n.jsx(Xu, {
                          incomingDrugs: r.incomingDrugs,
                          showInFocus: b.incomingDrugs,
                          onFocusToggle: (_) => T("incomingDrugs", _),
                          error:
                            (O = r.errors) == null ? void 0 : O.incomingDrugs,
                        }),
                      }),
                      n.jsx("div", {
                        children: n.jsx(Ju, {
                          outOfStockItems: r.outOfStockItems,
                          onItemAdded: M,
                          showInFocus: b.outOfStock,
                          onFocusToggle: (_) => T("outOfStock", _),
                          error: (F = r.errors) == null ? void 0 : F.outOfStock,
                        }),
                      }),
                      n.jsx("div", {
                        children: n.jsx(Zu, {
                          drugReplacements: r.drugReplacements,
                          showInFocus: b.drugReplacements,
                          onFocusToggle: (_) => T("drugReplacements", _),
                          error:
                            (q = r.errors) == null
                              ? void 0
                              : q.drugReplacements,
                      ...
                      n.jsx("div", {
                        children: n.jsx(ed, {
                          inventoryHighlights: r.inventoryHighlights,
                          showInFocus: b.inventory,
                          onFocusToggle: (_) => T("inventory", _),
                          error:
                            (ae = r.errors) == null ? void 0 : ae.inventory,
                        }),
                      }),
                      n.jsx("div", {
                        ...
                        children: n.jsx(td, {
                          internalRequests: r.internalRequests,
                          showInFocus: b.internalRequests,
                          onFocusToggle: (_) => T("internalRequests", _),
                          error:
                            (P = r.errors) == null
                              ? void 0
                              : P.internalRequests,
  ...
  ap = ({ onLogin: e }) => {
    const { t } = Ar(),
      ...
      [c, u] = w.useState(!1),
      d = async (f) => {
        f.preventDefault(), o(null), u(!0);
        try {
          const h = await Hm({ ID: r, Password: l });
          h.Code === 200
            ? (Bm(h.Data), e())
            : h.Code === -1 || h.Code === -2
            ? o(h.Result)
...
function ip() {
  ...
  return !e || l
    ...
    : n.jsx(Um, { children: r ? n.jsx(lp, {}) : n.jsx(ap, { onLogin: i }) });
}
$u(document.getElementById("root")).render(
  n.jsx(w.StrictMode, { children: n.jsx(ip, {}) })
);
