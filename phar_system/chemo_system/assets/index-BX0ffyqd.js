 ...
 */ (function (e) {
      ...
      e: for (var H = 0, G = E.length, qt = G >>> 1; H < qt; ) {
        ...
        if (0 > l(yl, L))
          yn < G && 0 > l(bt, yl)
            ? ((E[H] = bt), (E[yn] = L), (H = yn))
            : ((E[H] = yl), (E[vn] = L), (H = vn));
        else if (yn < G && 0 > l(bt, L)) ((E[H] = bt), (E[yn] = L), (H = yn));
        else break e;
      }
    }
    return z;
  ...
  function v(E) {
    if (((k = !1), d(E), !w))
      if (t(s) !== null) ((w = !0), ml(x));
      else {
        var z = t(c);
        z !== null && vl(v, z.startTime - E);
      }
  }
  function x(E, z) {
      ...
      return (
        ...
        L > H
          ? ((E.sortIndex = L),
            ...
            t(s) === null &&
              E === t(c) &&
              (k ? (f(N), (N = -1)) : (k = !0), vl(v, L - H)))
          : ((E.sortIndex = G), n(s, E), w || g || ((w = !0), ml(x))),
        E
      );
    }),
...
function Fc(e, n, t, r, l, o, i, u, s) {
  ((xt = !1), (Tr = null), Dc.apply(Ic, arguments));
}
...
function $c(e) {
  ...
  for (var t = e, r = n; ; ) {
    ...
    if (l.child === o.child) {
      for (o = l.child; o; ) {
        if (o === t) return (Hi(l), e);
        if (o === r) return (Hi(l), n);
        o = o.sibling;
      }
      throw Error(y(188));
    }
...
function qo(e, n, t, r) {
  if (Or) {
    var l = so(e, n, t, r);
    if (l === null) (Rl(e, n, r, Dr, t), Ki(e, r));
...
function As(e) {
  if (e.propertyName === "value" && tl(It)) {
    var n = [];
    (Us(n, It, e, Xo(e)), ws(Tf, n));
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (tu(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", As))
    : e === "focusout" && tu();
}
function Rf(e) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Mt(a, f)), v != null && k.push($t(a, v, d)))),
            F)
          )
            break;
          a = a.return;
...
function mn() {
  if (!Dl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Es(Go, mn), l);
    } finally {
      ((R = n), (Dl = !1));
    }
  }
...
function ta(e) {
  ...
  function p(f, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (gt(d) || at(d)) return x !== null ? null : m(f, a, d, v, null);
      dr(f, d);
    }
    return null;
  }
  function g(f, a, d, v, x) {
    ...
    if (typeof v == "object" && v !== null) {
      ...
      if (gt(v) || at(v)) return ((f = f.get(d) || null), m(a, f, v, x, null));
      dr(a, v);
    }
    return null;
  }
...
function di(e, n) {
  switch ((O(Bt, n), O(Vt, e), O(Ue, Jt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Sa(e, n, t) {
  return Pn & 21
    ? (Re(t, n) || ((t = Ns()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function fd(e, n) {
  ...
  for (po = { focusedElem: e, selectionRange: t }, Or = !1, S = n; S !== null; )
...
function Ua(e) {
  ...
  (n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[vo], delete n[Yf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Me(e, n, t, r) {
  ...
  (Xt(e, t, r),
    (!(M & 2) || e !== J) &&
      (e === J && (!(M & 2) && (al |= t), X === 4 && be(e, b)),
      pe(e, r),
      t === 1 && M === 0 && !(n.mode & 1) && ((rt = Q() + 500), ol && mn())));
}
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qi(t), n === 1))
      (e.tag === 0 ? Gf(Fu.bind(null, e)) : qs(Fu.bind(null, e)),
        Qf(function () {
          !(M & 6) && mn();
        }),
        (t = null));
...
function Wa(e, n) {
  if (((Nr = -1), (Pr = 0), M & 6)) throw Error(y(327));
  var t = e.callbackNode;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = mo(wn.bind(null, e, ae, $e), n);
            break;
          }
          wn(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = mo(wn.bind(null, e, ae, $e), r);
            break;
          }
          wn(e, ae, $e);
          break;
...
function Ln(e) {
  ...
  try {
    ...
    ((R = r), (Ee.transition = t), (M = n), !(M & 6) && mn());
  }
}
function _i() {
  ((he = Hn.current), I(Hn));
...
function Jr(e, n) {
  ...
  while (!0);
  if ((si(), (M = t), (Xr.current = r), K !== null)) throw Error(y(261));
  return ((J = null), (b = 0), X);
}
function md() {
  for (; K !== null; ) Ka(K);
...
function wn(e, n, t) {
  var r = R,
    l = Ee.transition;
  try {
    ((Ee.transition = null), (R = 1), yd(e, n, t, r));
  } finally {
    ((Ee.transition = l), (R = r));
  }
  return null;
...
function yd(e, n, t, r) {
  ...
  if (Gr) throw ((Gr = !1), (e = Ro), (Ro = null), e);
  return (
    Zr & 1 && e.tag !== 0 && Zn(),
    (o = e.pendingLanes),
...
function Zn() {
  if (nn !== null) {
    var e = Ps(Zr),
      ...
      t = R;
    try {
      if (((Ee.transition = null), (R = 16 > e ? 16 : e), nn === null))
        var r = !1;
      else {
        ...
        if (
          ((M = l), mn(), Fe && typeof Fe.onPostCommitFiberRoot == "function")
        )
          try {
...
function zr(e, n, t, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Pi(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Kl:
        return ((e = xe(13, t, n, l)), (e.elementType = Kl), (e.lanes = o), e);
      case Yl:
        return ((e = xe(19, t, n, l)), (e.elementType = Yl), (e.lanes = o), e);
      case is:
        return cl(t, l, o, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zo(n, t | 1), pe(n, Q()), !(M & 6) && ((rt = Q() + 500), mn()));
      }
      break;
    case 13:
      (Ln(function () {
...
ys = Ci;
gs = Ln;
var Pd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, vs, Ci] },
  vt = {
...
const Bu = [
  {
    label: "化療調劑",
    sublabel: "Chemo Dispensing",
    href: "../chemo_dispensing",
    icon: P.jsxs("svg", {
  ...
  {
    label: "化療勤務",
    sublabel: "Chemo Transport",
    href: "../chemo_transport",
    icon: P.jsxs("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      fill: "none",
      ...
      className: "w-10 h-10",
      children: [
        P.jsx("rect", { x: "1", y: "3", width: "15", height: "13", rx: "2" }),
        P.jsx("path", { d: "M16 8h4l3 3v5h-7V8z" }),
        P.jsx("circle", { cx: "5.5", cy: "18.5", r: "2.5" }),
        P.jsx("circle", { cx: "18.5", cy: "18.5", r: "2.5" }),
      ],
    }),
  ...
  {
    label: "化療個管",
    sublabel: "Chemo Case Manager",
    href: "../chemo_personal_manager",
    icon: P.jsxs("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      fill: "none",
      ...
      className: "w-10 h-10",
      children: [
        P.jsx("path", { d: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" }),
        P.jsx("circle", { cx: "9", cy: "7", r: "4" }),
        P.jsx("path", { d: "M23 21v-2a4 4 0 0 0-3-3.87" }),
        P.jsx("path", { d: "M16 3.13a4 4 0 0 1 0 7.75" }),
      ],
    }),
  ...
  },
  {
    ...
    icon: P.jsxs("svg", {
      ...
      className: "w-10 h-10",
      children: [
        P.jsx("path", { d: "M12 2a10 10 0 1 0 10 10" }),
        P.jsx("path", { d: "M12 6v6l4 2" }),
        P.jsx("path", { d: "M18 2v4h4" }),
        P.jsx("path", { d: "M22 2l-4 4" }),
      ],
    }),
...
function Td() {
  return P.jsxs("div", {
    className:
      "min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 flex flex-col items-center justify-center p-6",
    children: [
      P.jsxs("div", {
        ...
        children: [
          P.jsx("div", {
            className:
              "inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-md mb-5",
            children: P.jsxs("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              viewBox: "0 0 24 24",
              fill: "none",
              ...
              children: [
                ...
                P.jsx("path", { d: "M3 10h18" }),
                P.jsx("path", { d: "M12 14v4" }),
                P.jsx("path", { d: "M10 16h4" }),
              ],
            }),
          }),
          P.jsx("h1", {
          ...
          P.jsx("p", {
            className: "mt-2 text-slate-500 text-sm tracking-wide",
            children: "Chemotherapy Management System",
          }),
        ],
      }),
      P.jsxs("div", {
        ...
        children: [
          Bu.slice(0, 4).map((e) =>
            P.jsxs(
              ...
              {
                href: e.href,
                className: `group relative flex flex-col items-center gap-4 p-8 rounded-2xl border ${e.border} ${e.bg} shadow-sm ${e.shadow} hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer no-underline`,
                children: [
                  P.jsx("div", {
                    className: `flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${e.color} text-white shadow-md group-hover:scale-105 transition-transform duration-200`,
                    children: e.icon,
                  }),
                  P.jsxs("div", {
                    ...
                    children: [
                      P.jsx("div", {
                        className: `text-xl font-bold ${e.text}`,
                        children: e.label,
                      }),
                      P.jsx("div", {
                        className:
                          "text-xs text-slate-400 mt-0.5 tracking-wide",
                        children: e.sublabel,
                      }),
                    ],
                  }),
                  P.jsx("div", {
                    className: `absolute bottom-4 right-5 opacity-0 group-hover:opacity-100 transition-opacity duration-200 ${e.text}`,
                    children: P.jsx("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      viewBox: "0 0 24 24",
                      fill: "none",
                      ...
                      strokeLinejoin: "round",
                      className: "w-4 h-4",
                      children: P.jsx("path", { d: "M5 12h14M12 5l7 7-7 7" }),
                    }),
                  }),
                ],
              },
          ...
          Bu.slice(4).map((e) =>
            P.jsxs(
              ...
              {
                href: e.href,
                className: `group relative sm:col-span-2 flex flex-col items-center gap-4 p-8 rounded-2xl border ${e.border} ${e.bg} shadow-sm ${e.shadow} hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer no-underline`,
                children: [
                  P.jsx("div", {
                    className: `flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${e.color} text-white shadow-md group-hover:scale-105 transition-transform duration-200`,
                    children: e.icon,
...
nc(document.getElementById("root")).render(
  P.jsx(Vo.StrictMode, { children: P.jsx(Td, {}) }),
);
